...
export type GrpcSpotMarketOrder = InjectiveExchangeV1Beta1Exchange.SpotMarketOrder;
...
export type GrpcFeeDiscountTierInfo = InjectiveExchangeV1Beta1Exchange.FeeDiscountTierInfo;
export type GrpcFeeDiscountTierTTL = InjectiveExchangeV1Beta1Exchange.FeeDiscountTierTTL;
export type GrpcFeeDiscountSchedule = InjectiveExchangeV1Beta1Exchange.FeeDiscountSchedule;
export type GrpcPointsMultiplier = InjectiveExchangeV1Beta1Exchange.PointsMultiplier;
export type GrpcTradingRewardCampaignBoostInfo = InjectiveExchangeV1Beta1Exchange.TradingRewardCampaignBoostInfo;
export type GrpcTradingRewardCampaignInfo = InjectiveExchangeV1Beta1Exchange.TradingRewardCampaignInfo;
export type GrpcCampaignRewardPool = InjectiveExchangeV1Beta1Exchange.CampaignRewardPool;
export type GrpcChainPosition = InjectiveExchangeV1Beta1Exchange.Position;
export type GrpcChainDerivativePosition = InjectiveExchangeV1Beta1Genesis.DerivativePosition;
export type GrpcFeeDiscountAccountInfo = InjectiveExchangeV1Beta1Query.QueryFeeDiscountAccountInfoResponse;
export type GrpcTradeRewardCampaign = InjectiveExchangeV1Beta1Query.QueryTradeRewardCampaignResponse;
export type GrpcDenomDecimals = InjectiveExchangeV1Beta1Exchange.DenomDecimals;
export type GrpcDenomMinNotional = InjectiveExchangeV1Beta1Exchange.DenomMinNotional;
export type GrpcChainFullDerivativeMarket = InjectiveExchangeV1Beta1Query.FullDerivativeMarket;
export type GrpcChainFullSpotMarket = InjectiveExchangeV1Beta1Query.FullSpotMarket;
