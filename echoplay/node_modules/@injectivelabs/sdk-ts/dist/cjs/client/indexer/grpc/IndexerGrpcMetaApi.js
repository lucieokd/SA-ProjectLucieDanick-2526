 ...
 */
class IndexerGrpcMetaApi extends BaseIndexerGrpcConsumer_js_1.default {
    module = index_js_1.IndexerModule.Meta;
    client;
    ...
    async fetchPing() {
        ...
        try {
            const response = await this.retry(() => this.client.Ping(request, this.metadata));
            return response;
        }
        catch (e) {
    ...
    async fetchVersion() {
        ...
        try {
            const response = await this.retry(() => this.client.Version(request, this.metadata));
            return response;
        }
        catch (e) {
            if (e instanceof indexer_proto_ts_1.InjectiveMetaRpc.GrpcWebError) {
    ...
    async fetchInfo() {
        ...
        try {
            const response = await this.retry(() => this.client.Info(request, this.metadata));
            return response;
        }
        catch (e) {
            if (e instanceof indexer_proto_ts_1.InjectiveMetaRpc.GrpcWebError) {
