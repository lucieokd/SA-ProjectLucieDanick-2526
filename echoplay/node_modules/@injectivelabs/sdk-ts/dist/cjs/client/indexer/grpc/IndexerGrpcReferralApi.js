...
class IndexerGrpcReferralApi extends BaseIndexerGrpcConsumer_js_1.default {
    module = index_js_1.IndexerModule.Referral;
    client;
    ...
    async fetchReferrerDetails(address) {
        ...
        try {
            ...
            return index_js_2.IndexerGrpcReferralTransformer.referrerDetailsResponseToReferrerDetails(address, response);
        }
        catch (e) {
    ...
    async fetchInviteeDetails(address) {
        ...
        try {
            ...
            return index_js_2.IndexerGrpcReferralTransformer.inviteeDetailsResponseToInviteeDetails(response);
        }
        catch (e) {
            if (e instanceof indexer_proto_ts_1.InjectiveReferralRpc.GrpcWebError) {
                throw new exceptions_1.GrpcUnaryRequestException(new Error(e.toString()), {
    ...
    async fetchReferrerByCode(code) {
        ...
        try {
            ...
            return index_js_2.IndexerGrpcReferralTransformer.referrerByCodeResponseToReferrerByCode(response);
        }
        catch (e) {
            if (e instanceof indexer_proto_ts_1.InjectiveReferralRpc.GrpcWebError) {
                throw new exceptions_1.GrpcUnaryRequestException(new Error(e.toString()), {
