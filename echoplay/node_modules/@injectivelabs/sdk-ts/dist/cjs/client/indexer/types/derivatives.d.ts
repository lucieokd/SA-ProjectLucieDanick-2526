...
import type { OrderState, OrderSide, TradeDirection, TradeExecutionType, TradeExecutionSide } from '@injectivelabs/ts-types';
...
export interface PositionV2 extends Omit<Position, 'aggregateReduceOnlyQuantity'> {
    denom: string;
}
...
export interface BinaryOptionsMarket extends Omit<BaseDerivativeMarket, 'minPriceTickSize' | 'minQuantityTickSize'> {
    oracleSymbol: string;
...
export type DerivativeMarket = PerpetualMarket | ExpiryFuturesMarket | BinaryOptionsMarket;
export type DerivativeMarketWithoutBinaryOptions = PerpetualMarket | ExpiryFuturesMarket;
...
export type GrpcDerivativePosition = InjectiveDerivativeExchangeRpc.DerivativePosition;
export type GrpcDerivativePositionV2 = InjectiveDerivativeExchangeRpc.DerivativePositionV2;
export type GrpcPerpetualMarketInfo = InjectiveDerivativeExchangeRpc.PerpetualMarketInfo;
export type GrpcDerivativeMarketInfo = InjectiveDerivativeExchangeRpc.DerivativeMarketInfo;
export type GrpcDerivativeLimitOrder = InjectiveDerivativeExchangeRpc.DerivativeLimitOrder;
export type GrpcPerpetualMarketFunding = InjectiveDerivativeExchangeRpc.PerpetualMarketFunding;
export type GrpcExpiryFuturesMarketInfo = InjectiveDerivativeExchangeRpc.ExpiryFuturesMarketInfo;
export type GrpcBinaryOptionsMarketInfo = InjectiveDerivativeExchangeRpc.BinaryOptionsMarketInfo;
export type GrpcDerivativeOrderHistory = InjectiveDerivativeExchangeRpc.DerivativeOrderHistory;
