...
class IndexerGrpcCampaignApi extends BaseIndexerGrpcConsumer_js_1.default {
    module = index_js_1.IndexerModule.Campaign;
    client;
    ...
    async fetchCampaign({ skip, limit, marketId, campaignId, accountAddress, contractAddress, }) {
        ...
        try {
            ...
            return index_js_2.IndexerCampaignTransformer.CampaignResponseToCampaign(response);
        }
        catch (e) {
    ...
    async fetchCampaigns({ type, active, limit, cursor, status, }) {
        ...
        try {
            ...
            return index_js_2.IndexerCampaignTransformer.CampaignsV2ResponseToCampaigns(response);
        }
        catch (e) {
            if (e instanceof indexer_proto_ts_1.InjectiveMetaRpc.GrpcWebError) {
                throw new exceptions_1.GrpcUnaryRequestException(new Error(e.toString()), {
    ...
    async fetchRound({ roundId, toRoundId, accountAddress, contractAddress, }) {
        ...
        try {
            ...
            return index_js_2.IndexerCampaignTransformer.RoundsResponseToRounds(response);
        }
        catch (e) {
    ...
    async fetchGuilds({ skip, limit, sortBy, campaignContract, }) {
        ...
        try {
            ...
            return index_js_2.IndexerCampaignTransformer.GuildsResponseToGuilds(response);
        }
        catch (e) {
            if (e instanceof indexer_proto_ts_1.InjectiveMetaRpc.GrpcWebError) {
                throw new exceptions_1.GrpcUnaryRequestException(new Error(e.toString()), {
    ...
    async fetchGuildMember({ address, campaignContract, }) {
        ...
        try {
            ...
            return index_js_2.IndexerCampaignTransformer.GuildMemberResponseToGuildMember(response);
        }
        catch (e) {
            if (e instanceof indexer_proto_ts_1.InjectiveMetaRpc.GrpcWebError) {
                throw new exceptions_1.GrpcUnaryRequestException(new Error(e.toString()), {
    ...
    async fetchGuildMembers({ skip, limit, sortBy, guildId, campaignContract, includeGuildInfo, }) {
        ...
        try {
            ...
            return index_js_2.IndexerCampaignTransformer.GuildMembersResponseToGuildMembers(response);
        }
        catch (e) {
            if (e instanceof indexer_proto_ts_1.InjectiveMetaRpc.GrpcWebError) {
                throw new exceptions_1.GrpcUnaryRequestException(new Error(e.toString()), {
