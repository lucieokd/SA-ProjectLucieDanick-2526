...
class NeptuneService {
    ...
    constructor(network = networks_1.Network.MainnetSentry, endpoints) {
        ...
        this.client = new index_js_2.ChainGrpcWasmApi(networkEndpoints.grpc);
        this.priceOracleContract = index_js_1.NEPTUNE_PRICE_CONTRACT;
    }
    /**
    ...
    async fetchPrices(assets) {
        const queryGetPricesPayload = new index_js_3.QueryGetPrices({ assets }).toPayload();
        try {
    ...
    async getLendingRates({ limit, startAfter, contractAddress = NEPTUNE_INTEREST_CONTRACT, }) {
        const query = new index_js_3.QueryGetAllLendingRates({ limit, startAfter });
