...
class ChainGrpcMintApi extends BaseGrpcConsumer_js_1.default {
    module = index_js_1.ChainModule.Mint;
    client;
    ...
    async fetchInflation() {
        ...
        try {
            ...
            return {
                inflation: (0, utils_1.toHumanReadable)((0, index_js_2.uint8ArrayToString)(response.inflation)),
            };
        }
        catch (e) {
            if (e instanceof core_proto_ts_1.CosmosMintV1Beta1Query.GrpcWebError) {
    ...
    async fetchAnnualProvisions() {
        ...
        try {
            ...
            return {
                annualProvisions: (0, utils_1.toHumanReadable)((0, index_js_2.uint8ArrayToString)(response.annualProvisions)).toFixed(),
            };
        }
        catch (e) {
            if (e instanceof core_proto_ts_1.CosmosMintV1Beta1Query.GrpcWebError) {
