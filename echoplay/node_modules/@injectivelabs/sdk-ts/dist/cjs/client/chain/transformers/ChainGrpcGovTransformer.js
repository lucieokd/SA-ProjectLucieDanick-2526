    ...
    static moduleParamsResponseToModuleParams(response) {
        ...
        return {
            ...
            votingParams: {
                ...
                expeditedVotingPeriod: parseInt(params?.expeditedVotingPeriod?.seconds || '0'),
            },
            tallyParams: {
                quorum: (0, index_js_1.uint8ArrayToString)(params?.quorum || '0'),
                threshold: (0, index_js_1.uint8ArrayToString)(params?.threshold || '0'),
                vetoThreshold: (0, index_js_1.uint8ArrayToString)(params?.vetoThreshold || '0'),
                expeditedThreshold: (0, index_js_1.uint8ArrayToString)(params?.expeditedThreshold || '0'),
            },
        };
    }
    static moduleParamsResponseToModuleParamsByType({ depositParams, votingParams, tallyParams, }) {
        return {
            ...
            votingParams: {
                ...
                expeditedVotingPeriod: parseInt(votingParams.expeditedVotingPeriod?.seconds || '0'),
            },
            tallyParams: {
                quorum: (0, index_js_1.uint8ArrayToString)(tallyParams.quorum),
                threshold: (0, index_js_1.uint8ArrayToString)(tallyParams.threshold),
                vetoThreshold: (0, index_js_1.uint8ArrayToString)(tallyParams.vetoThreshold),
                expeditedThreshold: (0, index_js_1.uint8ArrayToString)(tallyParams.expeditedThreshold),
            },
        };
    }
