...
const index_js_1 = require("../tx/eip712/index.js");
...
class PrivateKey {
     ...
     */
    static fromMnemonic(words, path = index_js_2.DEFAULT_DERIVATION_PATH) {
    ...
    sign(messageBytes) {
        const { wallet } = this;
        const msgHash = (0, viem_1.keccak256)(messageBytes);
    ...
    signEcda(messageBytes) {
        ...
        const { signature } = secp256k1_1.default.ecdsaSign((0, viem_1.toBytes)(msgHash), privateKey);
        return signature;
    }
    /**
     * Sign the given message using the wallet's _signingKey function.
    ...
    async signTypedData(eip712Data) {
        ...
        const sanitizedData = (0, index_js_2.TypedDataUtilsSanitizeData)(eip712Data);
        const msgHashBytes = (0, viem_1.hashTypedData)(sanitizedData);
        const privateKey = Uint8Array.from(Buffer.from(privateKeyHex, 'hex'));
        const { signature, recid } = secp256k1_1.default.ecdsaSign((0, viem_1.toBytes)(msgHashBytes), privateKey);
    ...
    static async verifySignature({ signature, eip712, publicKey, }) {
        const publicKeyInHex = publicKey.startsWith('0x')
            ? publicKey
            : `0x${publicKey}`;
        const recoveredPubKey = await (0, index_js_2.recoverTypedSignaturePubKey)(eip712, signature);
    ...
    static async verifyCosmosSignature({ txRaw, signer, }) {
        ...
        const decodedMsg = index_js_1.MsgDecoder.decode(msg);
        const eip712TypedData = (0, index_js_1.getEip712TypedData)({
            msgs: [decodedMsg],
            fee: authInfo.fee,
            tx: {
                memo: body.memo,
    ...
    static verifyArbitrarySignature({ signature, signDoc, publicKey, }) {
        ...
        return secp256k1_1.default.ecdsaVerify((0, viem_1.toBytes)(sigHex), (0, viem_1.toBytes)((0, viem_1.keccak256)(signDoc)), (0, viem_1.toBytes)(pubHex));
    }
}
