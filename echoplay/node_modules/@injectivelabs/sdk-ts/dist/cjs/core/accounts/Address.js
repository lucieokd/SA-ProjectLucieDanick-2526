...
class Address {
    ...
    static fromBech32(bech, prefix = constants_js_1.BECH32_ADDR_ACC_PREFIX) {
        try {
            ...
            const addressBuffer = (0, viem_1.toBytes)(addressInHex.toString());
    ...
    static fromHex(hex, prefix = constants_js_1.BECH32_ADDR_ACC_PREFIX) {
        ...
        const addressBuffer = (0, viem_1.toBytes)(addressHex.toString());
        const bech32Address = base_1.bech32.encode(prefix, base_1.bech32.toWords(addressBuffer));
        return new Address(bech32Address);
    }
    /**
     ...
     * @returns {string}
     */
    toBech32(prefix = constants_js_1.BECH32_ADDR_ACC_PREFIX) {
        const address = this.toHex();
        const addressHex = address.startsWith('0x') ? address : `0x${address}`;
        const addressBuffer = (0, viem_1.toBytes)(addressHex);
     ...
     * */
    toAccountAddress() {
        return this.toBech32(constants_js_1.BECH32_ADDR_ACC_PREFIX);
    }
    /**
     ...
     * */
    toValidatorAddress() {
        return this.toBech32(constants_js_1.BECH32_ADDR_VAL_PREFIX);
    }
    /**
     ...
     * */
    toConsensusAddress() {
        return this.toBech32(constants_js_1.BECH32_ADDR_CONS_PREFIX);
    }
    /**
