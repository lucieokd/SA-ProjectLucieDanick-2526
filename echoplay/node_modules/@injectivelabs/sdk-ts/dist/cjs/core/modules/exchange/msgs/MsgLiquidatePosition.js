    ...
    toProto() {
        ...
        const params = {
            ...
            order: initialParams.order
                ? {
                    ...initialParams.order,
                    price: (0, utils_1.toChainFormat)(initialParams.order.price).toFixed(),
                    margin: (0, utils_1.toChainFormat)(initialParams.order.margin).toFixed(),
                    triggerPrice: (0, utils_1.toChainFormat)(initialParams.order.triggerPrice || 0).toFixed(),
                    quantity: (0, utils_1.toChainFormat)(initialParams.order.quantity).toFixed(),
                }
                : undefined,
        };
        ...
        const messageAdjusted = {
            ...
            order: params.order
                ? {
                    ...
                    order_info: {
                        ...order?.order_info,
                        price: (0, utils_1.toChainFormat)(order.order_info.price).toFixed(),
                        quantity: (0, utils_1.toChainFormat)(order.order_info.quantity).toFixed(),
                    },
                    margin: (0, utils_1.toChainFormat)(order.margin).toFixed(),
                    trigger_price: (0, utils_1.toChainFormat)(order.trigger_price || '0').toFixed(),
                }
                : undefined,
        };
        return {
