    ...
    toProto() {
        ...
        const params = {
            ...
            market: {
                ...
                initialMarginRatio: (0, utils_1.toChainFormat)(initialParams.market.initialMarginRatio).toFixed(),
                maintenanceMarginRatio: (0, utils_1.toChainFormat)(initialParams.market.maintenanceMarginRatio).toFixed(),
                ...
                reduceMarginRatio: (0, utils_1.toChainFormat)(initialParams.market.reduceMarginRatio).toFixed(),
            },
        };
    ...
    toEip712() {
        ...
        const messageAdjusted = {
            ...
            content: {
                ...
                value: {
                    ...value.content.value,
                    initial_margin_ratio: (0, utils_1.toChainFormat)(params.market.initialMarginRatio).toFixed(),
                    maintenance_margin_ratio: (0, utils_1.toChainFormat)(params.market.maintenanceMarginRatio).toFixed(),
                    ...
                    reduce_margin_ratio: (0, utils_1.toChainFormat)(params.market.reduceMarginRatio).toFixed(),
                },
            },
        };
        return {
