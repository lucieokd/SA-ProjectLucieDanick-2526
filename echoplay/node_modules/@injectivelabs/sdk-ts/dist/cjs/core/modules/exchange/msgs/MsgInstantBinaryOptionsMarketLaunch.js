...
class MsgInstantBinaryOptionsMarketLaunch extends MsgBase_js_1.MsgBase {
    ...
    toEip712() {
        ...
        const messageAdjusted = {
            ...value,
            min_price_tick_size: (0, utils_1.toChainFormat)(value.min_price_tick_size).toFixed(),
            min_quantity_tick_size: (0, utils_1.toChainFormat)(value.min_quantity_tick_size).toFixed(),
            min_notional: (0, utils_1.toChainFormat)(value.min_notional).toFixed(),
            taker_fee_rate: (0, utils_1.toChainFormat)(value.taker_fee_rate).toFixed(),
            maker_fee_rate: (0, utils_1.toChainFormat)(value.maker_fee_rate).toFixed(),
        };
        return {
            type,
