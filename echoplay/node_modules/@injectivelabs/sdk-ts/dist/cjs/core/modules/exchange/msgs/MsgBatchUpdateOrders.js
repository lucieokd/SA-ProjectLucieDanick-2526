 ...
 * @category Messages
 */
class MsgBatchUpdateOrders extends MsgBase_js_1.MsgBase {
    ...
    toProto() {
        ...
        if (params.spotOrdersToCreate && params.spotOrdersToCreate.length > 0) {
            const orderData = params.spotOrdersToCreate.map((args) => {
                const paramsFromArgs = {
                    ...args,
                    price: (0, utils_1.toChainFormat)(args.price).toFixed(),
                    triggerPrice: (0, utils_1.toChainFormat)(args.triggerPrice || 0).toFixed(),
                    quantity: (0, utils_1.toChainFormat)(args.quantity).toFixed(),
                };
        ...
        if (params.derivativeOrdersToCreate &&
            ...
            const orderData = params.derivativeOrdersToCreate.map((args) => {
                const paramsFromArgs = {
                    ...args,
                    price: (0, utils_1.toChainFormat)(args.price).toFixed(),
                    margin: (0, utils_1.toChainFormat)(args.margin).toFixed(),
                    triggerPrice: (0, utils_1.toChainFormat)(args.triggerPrice || 0).toFixed(),
                    quantity: (0, utils_1.toChainFormat)(args.quantity).toFixed(),
                };
    ...
    toAmino() {
        ...
        const msg = {
            ...(0, snakecase_keys_1.default)(core_proto_ts_1.InjectiveExchangeV1Beta1Tx.MsgBatchUpdateOrders.fromPartial(message)),
        };
        return {
