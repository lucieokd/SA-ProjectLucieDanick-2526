...
const createMarketOrder = (params) => {
    ...
    const message = core_proto_ts_1.InjectiveExchangeV1Beta1Tx.MsgCreateDerivativeMarketOrder.create();
    message.sender = params.injectiveAddress;
    message.order = derivativeOrder;
    return core_proto_ts_1.InjectiveExchangeV1Beta1Tx.MsgCreateDerivativeMarketOrder.fromPartial(message);
};
/**
 * @category Messages
 */
class MsgCreateDerivativeMarketOrder extends MsgBase_js_1.MsgBase {
    ...
    toBinary() {
        return core_proto_ts_1.InjectiveExchangeV1Beta1Tx.MsgCreateDerivativeMarketOrder.encode(this.toProto()).finish();
    }
}
exports.default = MsgCreateDerivativeMarketOrder;
