...
const tx_js_3 = require("cosmjs-types/cosmos/distribution/v1beta1/tx.js");
const tx_js_4 = require("cosmjs-types/cosmos/staking/v1beta1/tx.js");
const proto_signing_1 = require("@cosmjs/proto-signing");
const stargate_4 = require("@cosmjs/stargate");
const index_js_1 = require("../tx/index.js");
const StargateClient_js_1 = require("./StargateClient.js");
function createDefaultAminoConverters() {
    return {
        ...(0, stargate_4.createAuthzAminoConverters)(),
        ...(0, stargate_4.createBankAminoConverters)(),
        ...(0, stargate_4.createDistributionAminoConverters)(),
        ...(0, stargate_4.createGovAminoConverters)(),
        ...(0, stargate_4.createStakingAminoConverters)(),
        ...(0, stargate_4.createIbcAminoConverters)(),
        ...(0, stargate_4.createFeegrantAminoConverters)(),
        ...(0, stargate_4.createVestingAminoConverters)(),
    };
}
class SigningStargateClient extends StargateClient_js_1.StargateClient {
    registry;
    broadcastTimeoutMs;
    ...
    constructor(tmClient, signer, options) {
        ...
        const { registry = new proto_signing_1.Registry(stargate_3.defaultRegistryTypes), aminoTypes = new stargate_1.AminoTypes(createDefaultAminoConverters()), } = options;
    ...
    async delegateTokens(delegatorAddress, validatorAddress, amount, fee, memo = '') {
        const delegateMsg = {
            ...
            value: tx_js_4.MsgDelegate.fromPartial({
    ...
    async undelegateTokens(delegatorAddress, validatorAddress, amount, fee, memo = '') {
        const undelegateMsg = {
            ...
            value: tx_js_4.MsgUndelegate.fromPartial({
                delegatorAddress: delegatorAddress,
                validatorAddress: validatorAddress,
                amount: amount,
            }),
    ...
    async withdrawRewards(delegatorAddress, validatorAddress, fee, memo = '') {
        const withdrawMsg = {
            ...
            value: tx_js_3.MsgWithdrawDelegatorReward.fromPartial({
                delegatorAddress: delegatorAddress,
                validatorAddress: validatorAddress,
            }),
        };
    ...
    timeoutTimestamp, fee, memo = '') {
        ...
        const transferMsg = {
            ...
            value: tx_js_2.MsgTransfer.fromPartial({
