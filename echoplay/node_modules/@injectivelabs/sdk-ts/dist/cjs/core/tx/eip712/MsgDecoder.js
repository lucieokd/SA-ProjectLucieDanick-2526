...
const index_js_2 = require("../../modules/exchange/index.js");
class MsgDecoder {
    static decode(message) {
        ...
        switch (true) {
            case type.includes('MsgIncreasePositionMargin'): {
                ...
                return index_js_2.MsgIncreasePositionMargin.fromJSON({
            ...
            case type.includes('MsgSignData'): {
                ...
                return index_js_2.MsgSignData.fromJSON({
                    data: Buffer.from(msg.Data).toString('utf-8'),
                    sender: (0, index_js_1.getInjectiveAddress)(Buffer.from(msg.Signer).toString('hex')),
                });
            }
            default:
