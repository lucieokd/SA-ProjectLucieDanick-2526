...
const getEip712TypedData = ({ msgs, tx, fee, evmChainId, }) => {
    ...
    const types = (0, utils_js_2.getDefaultEip712Types)();
    ...
    const typesWithFeePayer = (0, utils_js_2.getTypesIncludingFeePayer)({
        fee,
    ...
    return {
        ...typesWithFeePayer,
        primaryType: 'Tx',
        ...(0, utils_js_2.getEip712Domain)(evmChainId),
        message: {
            ...(0, utils_js_2.getEipTxDetails)(tx),
            ...(0, utils_js_2.getEip712Fee)(fee),
            msgs: eip712Msgs,
        },
    };
};
...
const getEip712TypedDataV2 = ({ msgs, tx, fee, evmChainId, }) => {
    ...
    const types = (0, utils_js_2.getDefaultEip712TypesV2)();
    return {
        ...types,
        primaryType: 'Tx',
        ...(0, utils_js_2.getEip712DomainV2)(evmChainId),
        message: {
            context: JSON.stringify((0, utils_js_1.getEipTxContext)({ ...tx, fee })),
