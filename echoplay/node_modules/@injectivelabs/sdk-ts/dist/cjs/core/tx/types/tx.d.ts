...
import type { CosmosTxV1Beta1Tx, CosmosTxV1Beta1Service, CosmosTxSigningV1Beta1Signing, GoogleProtobufAny } from '@injectivelabs/core-proto-ts';
...
export declare const TxClientMode: {
    readonly gRpc: "grpc";
    readonly rest: "rest";
};
