...
exports.EIP712Version = exports.MsgStatus = exports.MsgType = exports.ChainId = exports.EvmChainId = void 0;
exports.EvmChainId = {
    Mainnet: 1,
    Ropsten: 3,
    Rinkeby: 4,
...
exports.MsgType = {
    ...
    MsgBatchExchangeModificationProposal: 'injective.exchange.v1beta1.BatchExchangeModificationProposal',
    MsgSpotMarketParamUpdateProposal: 'injective.exchange.v1beta1.SpotMarketParamUpdateProposal',
    MsgSpotMarketLaunchProposal: 'injective.exchange.v1beta1.SpotMarketLaunchProposal',
    MsgPerpetualMarketLaunchProposal: 'injective.exchange.v1beta1.PerpetualMarketLaunchProposal',
    MsgExpiryFuturesMarketLaunchProposal: 'injective.exchange.v1beta1.ExpiryFuturesMarketLaunchProposal',
    MsgDerivativeMarketParamUpdateProposal: 'injective.exchange.v1beta1.DerivativeMarketParamUpdateProposal',
    MsgMarketForcedSettlementProposal: 'injective.exchange.v1beta1.MarketForcedSettlementProposal',
    MsgUpdateDenomDecimalsProposal: 'injective.exchange.v1beta1.UpdateDenomDecimalsProposal',
    MsgTradingRewardCampaignLaunchProposal: 'injective.exchange.v1beta1.TradingRewardCampaignLaunchProposal',
    MsgTradingRewardCampaignUpdateProposal: 'injective.exchange.v1beta1.TradingRewardCampaignUpdateProposal',
    MsgTradingRewardPendingPointsUpdateProposal: 'injective.exchange.v1beta1.TradingRewardPendingPointsUpdateProposal',
    MsgFeeDiscountProposal: 'injective.exchange.v1beta1.FeeDiscountProposal',
    MsgBatchCommunityPoolSpendProposal: 'injective.exchange.v1beta1.BatchCommunityPoolSpendProposal',
    MsgBinaryOptionsMarketParamUpdateProposal: 'injective.exchange.v1beta1.BinaryOptionsMarketParamUpdateProposal',
    MsgBinaryOptionsMarketLaunchProposal: 'injective.exchange.v1beta1.BinaryOptionsMarketLaunchProposal',
    // Exchange v1beta1 - Authz
    MsgCreateSpotLimitOrderAuthz: 'injective.exchange.v1beta1.CreateSpotLimitOrderAuthz',
    MsgCreateSpotMarketOrderAuthz: 'injective.exchange.v1beta1.CreateSpotMarketOrderAuthz',
    MsgBatchCreateSpotLimitOrdersAuthz: 'injective.exchange.v1beta1.BatchCreateSpotLimitOrdersAuthz',
    MsgCancelSpotOrderAuthz: 'injective.exchange.v1beta1.CancelSpotOrderAuthz',
    MsgBatchCancelSpotOrdersAuthz: 'injective.exchange.v1beta1.BatchCancelSpotOrdersAuthz',
    MsgCreateDerivativeLimitOrderAuthz: 'injective.exchange.v1beta1.CreateDerivativeLimitOrderAuthz',
    MsgCreateDerivativeMarketOrderAuthz: 'injective.exchange.v1beta1.CreateDerivativeMarketOrderAuthz',
    MsgBatchCreateDerivativeLimitOrdersAuthz: 'injective.exchange.v1beta1.BatchCreateDerivativeLimitOrdersAuthz',
    MsgCancelDerivativeOrderAuthz: 'injective.exchange.v1beta1.CancelDerivativeOrderAuthz',
    MsgBatchCancelDerivativeOrdersAuthz: 'injective.exchange.v1beta1.BatchCancelDerivativeOrdersAuthz',
    MsgBatchUpdateOrdersAuthz: 'injective.exchange.v1beta1.BatchUpdateOrdersAuthz',
    // Exchange V2
    ...
    MsgSubmitBadSignatureEvidence: 'injective.peggy.v1beta1.MsgSubmitBadSignatureEvidence',
    // Peggy - Proposals
    MsgBlacklistEthereumAddressesProposal: 'injective.peggy.v1beta1.BlacklistEthereumAddressesProposal',
    MsgRevokeEthereumBlacklistProposal: 'injective.peggy.v1beta1.RevokeEthereumBlacklistProposal',
    // Permissions
    ...
    // WasmX - Proposals
    MsgContractRegistrationRequestProposal: 'injective.wasmx.v1beta1.ContractRegistrationRequestProposal',
    MsgBatchContractRegistrationRequestProposal: 'injective.wasmx.v1beta1.BatchContractRegistrationRequestProposal',
    // TxFees
