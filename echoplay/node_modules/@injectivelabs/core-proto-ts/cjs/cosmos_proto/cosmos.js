...
function scalarTypeFromJSON(object) {
    switch (object) {
        ...
        case "SCALAR_TYPE_UNSPECIFIED":
            return exports.ScalarType.SCALAR_TYPE_UNSPECIFIED;
        case 1:
        case "SCALAR_TYPE_STRING":
            return exports.ScalarType.SCALAR_TYPE_STRING;
        case 2:
        case "SCALAR_TYPE_BYTES":
            return exports.ScalarType.SCALAR_TYPE_BYTES;
        case -1:
        case "UNRECOGNIZED":
        default:
            return exports.ScalarType.UNRECOGNIZED;
    }
}
function scalarTypeToJSON(object) {
    switch (object) {
        case exports.ScalarType.SCALAR_TYPE_UNSPECIFIED:
            return "SCALAR_TYPE_UNSPECIFIED";
        case exports.ScalarType.SCALAR_TYPE_STRING:
            return "SCALAR_TYPE_STRING";
        case exports.ScalarType.SCALAR_TYPE_BYTES:
            return "SCALAR_TYPE_BYTES";
        case exports.ScalarType.UNRECOGNIZED:
        default:
            return "UNRECOGNIZED";
    }
}
...
exports.ScalarDescriptor = {
    encode: function (message, writer) {
        ...
        try {
            for (var _b = __values(message.fieldType), _c = _b.next(); !_c.done; _c = _b.next()) {
                var v = _c.value;
                writer.int32(v);
            }
        }
    ...
    fromJSON: function (object) {
        return {
            name: isSet(object.name) ? String(object.name) : "",
            description: isSet(object.description) ? String(object.description) : "",
            fieldType: Array.isArray(object === null || object === void 0 ? void 0 : object.fieldType) ? object.fieldType.map(function (e) { return scalarTypeFromJSON(e); }) : [],
        };
    },
    toJSON: function (message) {
        var obj = {};
