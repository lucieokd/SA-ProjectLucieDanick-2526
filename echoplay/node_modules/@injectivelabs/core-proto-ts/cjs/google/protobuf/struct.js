...
function nullValueFromJSON(object) {
    switch (object) {
        case 0:
        case "NULL_VALUE":
            return exports.NullValue.NULL_VALUE;
        case -1:
        case "UNRECOGNIZED":
        default:
            return exports.NullValue.UNRECOGNIZED;
    }
}
function nullValueToJSON(object) {
    switch (object) {
        case exports.NullValue.NULL_VALUE:
            return "NULL_VALUE";
        case exports.NullValue.UNRECOGNIZED:
        default:
            return "UNRECOGNIZED";
    }
}
...
exports.Value = {
    ...
    fromJSON: function (object) {
        return {
            ...
            listValue: Array.isArray(object.listValue) ? __spreadArray([], __read(object.listValue), false) : undefined,
        };
    },
    toJSON: function (message) {
        var obj = {};
    ...
    wrap: function (value) {
        ...
        if (value === null) {
            result.nullValue = exports.NullValue.NULL_VALUE;
        }
...
exports.ListValue = {
    ...
    fromJSON: function (object) {
        return { values: Array.isArray(object === null || object === void 0 ? void 0 : object.values) ? __spreadArray([], __read(object.values), false) : [] };
    },
    toJSON: function (message) {
        var obj = {};
        if (message.values) {
