...
exports.FullActiveGrant = exports.FullGrantAuthorizations = exports.SubaccountNonce = exports.TradingRewardCampaignAccountPendingPoints = exports.TradingRewardCampaignAccountPoints = exports.AccountVolume = exports.FeeDiscountBucketVolumeAccounts = exports.FeeDiscountAccountTierTTL = exports.OrderbookSequence = exports.GenesisState = exports.protobufPackage = void 0;
/* eslint-disable */
...
exports.GenesisState = {
    encode: function (message, writer) {
        ...
        try {
            for (var _7 = __values(message.spotMarkets), _8 = _7.next(); !_8.done; _8 = _7.next()) {
                var v = _8.value;
                market_1.SpotMarket.encode(v, writer.uint32(18).fork()).ldelim();
            }
        }
        ...
        try {
            for (var _9 = __values(message.derivativeMarkets), _10 = _9.next(); !_10.done; _10 = _9.next()) {
                var v = _10.value;
                market_1.DerivativeMarket.encode(v, writer.uint32(26).fork()).ldelim();
            }
        }
        ...
        try {
            for (var _11 = __values(message.spotOrderbook), _12 = _11.next(); !_12.done; _12 = _11.next()) {
                var v = _12.value;
                orderbook_1.SpotOrderBook.encode(v, writer.uint32(34).fork()).ldelim();
            }
        }
        ...
        try {
            for (var _13 = __values(message.derivativeOrderbook), _14 = _13.next(); !_14.done; _14 = _13.next()) {
                var v = _14.value;
                orderbook_1.DerivativeOrderBook.encode(v, writer.uint32(42).fork()).ldelim();
            }
        }
        ...
        try {
            for (var _15 = __values(message.balances), _16 = _15.next(); !_16.done; _16 = _15.next()) {
                var v = _16.value;
                exchange_1.Balance.encode(v, writer.uint32(50).fork()).ldelim();
            }
        }
        ...
        try {
            for (var _17 = __values(message.positions), _18 = _17.next(); !_18.done; _18 = _17.next()) {
                var v = _18.value;
                exchange_1.DerivativePosition.encode(v, writer.uint32(58).fork()).ldelim();
            }
        }
        ...
        try {
            for (var _21 = __values(message.expiryFuturesMarketInfoState), _22 = _21.next(); !_22.done; _22 = _21.next()) {
                var v = _22.value;
                market_1.ExpiryFuturesMarketInfoState.encode(v, writer.uint32(74).fork()).ldelim();
            }
        }
        ...
        try {
            for (var _23 = __values(message.perpetualMarketInfo), _24 = _23.next(); !_24.done; _24 = _23.next()) {
                var v = _24.value;
                market_1.PerpetualMarketInfo.encode(v, writer.uint32(82).fork()).ldelim();
            }
        }
        ...
        try {
            for (var _25 = __values(message.perpetualMarketFundingState), _26 = _25.next(); !_26.done; _26 = _25.next()) {
                var v = _26.value;
                market_1.PerpetualMarketFundingState.encode(v, writer.uint32(90).fork()).ldelim();
            }
        }
        ...
        try {
            for (var _27 = __values(message.derivativeMarketSettlementScheduled), _28 = _27.next(); !_28.done; _28 = _27.next()) {
                var v = _28.value;
                market_1.DerivativeMarketSettlementInfo.encode(v, writer.uint32(98).fork()).ldelim();
            }
        }
        ...
        try {
            for (var _45 = __values(message.binaryOptionsMarkets), _46 = _45.next(); !_46.done; _46 = _45.next()) {
                var v = _46.value;
                market_1.BinaryOptionsMarket.encode(v, writer.uint32(210).fork()).ldelim();
            }
        }
        ...
        try {
            for (var _53 = __values(message.conditionalDerivativeOrderbooks), _54 = _53.next(); !_54.done; _54 = _53.next()) {
                var v = _54.value;
                orderbook_1.ConditionalDerivativeOrderBook.encode(v, writer.uint32(242).fork()).ldelim();
            }
        }
        ...
        try {
            for (var _55 = __values(message.marketFeeMultipliers), _56 = _55.next(); !_56.done; _56 = _55.next()) {
                var v = _56.value;
                market_1.MarketFeeMultiplier.encode(v, writer.uint32(250).fork()).ldelim();
            }
        }
        ...
        try {
            for (var _61 = __values(message.marketVolumes), _62 = _61.next(); !_62.done; _62 = _61.next()) {
                var v = _62.value;
                market_1.MarketVolume.encode(v, writer.uint32(274).fork()).ldelim();
            }
        }
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                case 1:
                    ...
                    break;
                case 2:
                    message.spotMarkets.push(market_1.SpotMarket.decode(reader, reader.uint32()));
                    break;
                case 3:
                    message.derivativeMarkets.push(market_1.DerivativeMarket.decode(reader, reader.uint32()));
                    break;
                case 4:
                    message.spotOrderbook.push(orderbook_1.SpotOrderBook.decode(reader, reader.uint32()));
                    break;
                case 5:
                    message.derivativeOrderbook.push(orderbook_1.DerivativeOrderBook.decode(reader, reader.uint32()));
                    break;
                case 6:
                    message.balances.push(exchange_1.Balance.decode(reader, reader.uint32()));
                    break;
                case 7:
                    message.positions.push(exchange_1.DerivativePosition.decode(reader, reader.uint32()));
                    break;
                case 8:
                    message.subaccountTradeNonces.push(exports.SubaccountNonce.decode(reader, reader.uint32()));
                    break;
                case 9:
                    message.expiryFuturesMarketInfoState.push(market_1.ExpiryFuturesMarketInfoState.decode(reader, reader.uint32()));
                    break;
                case 10:
                    message.perpetualMarketInfo.push(market_1.PerpetualMarketInfo.decode(reader, reader.uint32()));
                    break;
                case 11:
                    message.perpetualMarketFundingState.push(market_1.PerpetualMarketFundingState.decode(reader, reader.uint32()));
                    break;
                case 12:
                    message.derivativeMarketSettlementScheduled.push(market_1.DerivativeMarketSettlementInfo.decode(reader, reader.uint32()));
                    break;
                case 13:
                ...
                case 25:
                    ...
                    break;
                case 26:
                    message.binaryOptionsMarkets.push(market_1.BinaryOptionsMarket.decode(reader, reader.uint32()));
                    break;
                case 27:
                ...
                case 29:
                    ...
                    break;
                case 30:
                    message.conditionalDerivativeOrderbooks.push(orderbook_1.ConditionalDerivativeOrderBook.decode(reader, reader.uint32()));
                    break;
                case 31:
                ...
                case 33:
                    ...
                    break;
                case 34:
                    message.marketVolumes.push(market_1.MarketVolume.decode(reader, reader.uint32()));
                    break;
                case 35:
    ...
    fromJSON: function (object) {
        return {
            ...
            spotMarkets: Array.isArray(object === null || object === void 0 ? void 0 : object.spotMarkets) ? object.spotMarkets.map(function (e) { return market_1.SpotMarket.fromJSON(e); }) : [],
            derivativeMarkets: Array.isArray(object === null || object === void 0 ? void 0 : object.derivativeMarkets)
                ? object.derivativeMarkets.map(function (e) { return market_1.DerivativeMarket.fromJSON(e); })
                : [],
            spotOrderbook: Array.isArray(object === null || object === void 0 ? void 0 : object.spotOrderbook)
                ? object.spotOrderbook.map(function (e) { return orderbook_1.SpotOrderBook.fromJSON(e); })
                : [],
            derivativeOrderbook: Array.isArray(object === null || object === void 0 ? void 0 : object.derivativeOrderbook)
                ? object.derivativeOrderbook.map(function (e) { return orderbook_1.DerivativeOrderBook.fromJSON(e); })
                : [],
            balances: Array.isArray(object === null || object === void 0 ? void 0 : object.balances) ? object.balances.map(function (e) { return exchange_1.Balance.fromJSON(e); }) : [],
            positions: Array.isArray(object === null || object === void 0 ? void 0 : object.positions)
                ? object.positions.map(function (e) { return exchange_1.DerivativePosition.fromJSON(e); })
                : [],
            ...
            expiryFuturesMarketInfoState: Array.isArray(object === null || object === void 0 ? void 0 : object.expiryFuturesMarketInfoState)
                ? object.expiryFuturesMarketInfoState.map(function (e) { return market_1.ExpiryFuturesMarketInfoState.fromJSON(e); })
                : [],
            perpetualMarketInfo: Array.isArray(object === null || object === void 0 ? void 0 : object.perpetualMarketInfo)
                ? object.perpetualMarketInfo.map(function (e) { return market_1.PerpetualMarketInfo.fromJSON(e); })
                : [],
            perpetualMarketFundingState: Array.isArray(object === null || object === void 0 ? void 0 : object.perpetualMarketFundingState)
                ? object.perpetualMarketFundingState.map(function (e) { return market_1.PerpetualMarketFundingState.fromJSON(e); })
                : [],
            derivativeMarketSettlementScheduled: Array.isArray(object === null || object === void 0 ? void 0 : object.derivativeMarketSettlementScheduled)
                ? object.derivativeMarketSettlementScheduled.map(function (e) { return market_1.DerivativeMarketSettlementInfo.fromJSON(e); })
                : [],
            ...
            binaryOptionsMarkets: Array.isArray(object === null || object === void 0 ? void 0 : object.binaryOptionsMarkets)
                ? object.binaryOptionsMarkets.map(function (e) { return market_1.BinaryOptionsMarket.fromJSON(e); })
                : [],
            ...
            conditionalDerivativeOrderbooks: Array.isArray(object === null || object === void 0 ? void 0 : object.conditionalDerivativeOrderbooks)
                ? object.conditionalDerivativeOrderbooks.map(function (e) { return orderbook_1.ConditionalDerivativeOrderBook.fromJSON(e); })
                : [],
            ...
            marketVolumes: Array.isArray(object === null || object === void 0 ? void 0 : object.marketVolumes)
                ? object.marketVolumes.map(function (e) { return market_1.MarketVolume.fromJSON(e); })
                : [],
    ...
    toJSON: function (message) {
        ...
        if (message.spotMarkets) {
            obj.spotMarkets = message.spotMarkets.map(function (e) { return e ? market_1.SpotMarket.toJSON(e) : undefined; });
        }
        else {
            obj.spotMarkets = [];
        }
        if (message.derivativeMarkets) {
            obj.derivativeMarkets = message.derivativeMarkets.map(function (e) { return e ? market_1.DerivativeMarket.toJSON(e) : undefined; });
        }
        else {
            obj.derivativeMarkets = [];
        }
        if (message.spotOrderbook) {
            obj.spotOrderbook = message.spotOrderbook.map(function (e) { return e ? orderbook_1.SpotOrderBook.toJSON(e) : undefined; });
        }
        else {
            obj.spotOrderbook = [];
        }
        if (message.derivativeOrderbook) {
            obj.derivativeOrderbook = message.derivativeOrderbook.map(function (e) { return e ? orderbook_1.DerivativeOrderBook.toJSON(e) : undefined; });
        }
        else {
        ...
        if (message.positions) {
            obj.positions = message.positions.map(function (e) { return e ? exchange_1.DerivativePosition.toJSON(e) : undefined; });
        }
        else {
            obj.positions = [];
        }
        ...
        if (message.expiryFuturesMarketInfoState) {
            obj.expiryFuturesMarketInfoState = message.expiryFuturesMarketInfoState.map(function (e) {
                return e ? market_1.ExpiryFuturesMarketInfoState.toJSON(e) : undefined;
            });
        }
        else {
        ...
        if (message.perpetualMarketInfo) {
            obj.perpetualMarketInfo = message.perpetualMarketInfo.map(function (e) { return e ? market_1.PerpetualMarketInfo.toJSON(e) : undefined; });
        }
        else {
        ...
        if (message.perpetualMarketFundingState) {
            obj.perpetualMarketFundingState = message.perpetualMarketFundingState.map(function (e) {
                return e ? market_1.PerpetualMarketFundingState.toJSON(e) : undefined;
            });
        }
        else {
        ...
        if (message.derivativeMarketSettlementScheduled) {
            obj.derivativeMarketSettlementScheduled = message.derivativeMarketSettlementScheduled.map(function (e) {
                return e ? market_1.DerivativeMarketSettlementInfo.toJSON(e) : undefined;
            });
        }
        else {
        ...
        if (message.binaryOptionsMarkets) {
            obj.binaryOptionsMarkets = message.binaryOptionsMarkets.map(function (e) { return e ? market_1.BinaryOptionsMarket.toJSON(e) : undefined; });
        }
        else {
        ...
        if (message.conditionalDerivativeOrderbooks) {
            obj.conditionalDerivativeOrderbooks = message.conditionalDerivativeOrderbooks.map(function (e) {
                return e ? orderbook_1.ConditionalDerivativeOrderBook.toJSON(e) : undefined;
            });
        }
        else {
        ...
        if (message.marketVolumes) {
            obj.marketVolumes = message.marketVolumes.map(function (e) { return e ? market_1.MarketVolume.toJSON(e) : undefined; });
        }
        else {
            obj.marketVolumes = [];
        }
    ...
    fromPartial: function (object) {
        ...
        message.params = (object.params !== undefined && object.params !== null)
            ...
            : undefined;
        message.spotMarkets = ((_a = object.spotMarkets) === null || _a === void 0 ? void 0 : _a.map(function (e) { return market_1.SpotMarket.fromPartial(e); })) || [];
        message.derivativeMarkets = ((_b = object.derivativeMarkets) === null || _b === void 0 ? void 0 : _b.map(function (e) { return market_1.DerivativeMarket.fromPartial(e); })) || [];
        message.spotOrderbook = ((_c = object.spotOrderbook) === null || _c === void 0 ? void 0 : _c.map(function (e) { return orderbook_1.SpotOrderBook.fromPartial(e); })) || [];
        message.derivativeOrderbook = ((_d = object.derivativeOrderbook) === null || _d === void 0 ? void 0 : _d.map(function (e) { return orderbook_1.DerivativeOrderBook.fromPartial(e); })) || [];
        message.balances = ((_e = object.balances) === null || _e === void 0 ? void 0 : _e.map(function (e) { return exchange_1.Balance.fromPartial(e); })) || [];
        message.positions = ((_f = object.positions) === null || _f === void 0 ? void 0 : _f.map(function (e) { return exchange_1.DerivativePosition.fromPartial(e); })) || [];
        ...
        message.expiryFuturesMarketInfoState =
            ((_h = object.expiryFuturesMarketInfoState) === null || _h === void 0 ? void 0 : _h.map(function (e) { return market_1.ExpiryFuturesMarketInfoState.fromPartial(e); })) || [];
        message.perpetualMarketInfo = ((_j = object.perpetualMarketInfo) === null || _j === void 0 ? void 0 : _j.map(function (e) { return market_1.PerpetualMarketInfo.fromPartial(e); })) || [];
        message.perpetualMarketFundingState =
            ((_k = object.perpetualMarketFundingState) === null || _k === void 0 ? void 0 : _k.map(function (e) { return market_1.PerpetualMarketFundingState.fromPartial(e); })) || [];
        message.derivativeMarketSettlementScheduled =
            ((_l = object.derivativeMarketSettlementScheduled) === null || _l === void 0 ? void 0 : _l.map(function (e) { return market_1.DerivativeMarketSettlementInfo.fromPartial(e); })) || [];
        ...
        message.binaryOptionsMarkets = ((_y = object.binaryOptionsMarkets) === null || _y === void 0 ? void 0 : _y.map(function (e) { return market_1.BinaryOptionsMarket.fromPartial(e); })) || [];
        ...
        message.conditionalDerivativeOrderbooks =
            ((_2 = object.conditionalDerivativeOrderbooks) === null || _2 === void 0 ? void 0 : _2.map(function (e) { return orderbook_1.ConditionalDerivativeOrderBook.fromPartial(e); })) || [];
        message.marketFeeMultipliers = ((_3 = object.marketFeeMultipliers) === null || _3 === void 0 ? void 0 : _3.map(function (e) { return market_1.MarketFeeMultiplier.fromPartial(e); })) || [];
        ...
        message.subaccountVolumes = ((_5 = object.subaccountVolumes) === null || _5 === void 0 ? void 0 : _5.map(function (e) { return exchange_1.AggregateSubaccountVolumeRecord.fromPartial(e); })) ||
            [];
        message.marketVolumes = ((_6 = object.marketVolumes) === null || _6 === void 0 ? void 0 : _6.map(function (e) { return market_1.MarketVolume.fromPartial(e); })) || [];
