...
exports.ExchangeType = { EXCHANGE_UNSPECIFIED: 0, SPOT: 1, DERIVATIVES: 2, UNRECOGNIZED: -1 };
function exchangeTypeFromJSON(object) {
    switch (object) {
        case 0:
        case "EXCHANGE_UNSPECIFIED":
            return exports.ExchangeType.EXCHANGE_UNSPECIFIED;
        case 1:
        case "SPOT":
            return exports.ExchangeType.SPOT;
        case 2:
        case "DERIVATIVES":
            return exports.ExchangeType.DERIVATIVES;
        case -1:
        case "UNRECOGNIZED":
        default:
            return exports.ExchangeType.UNRECOGNIZED;
    }
}
function exchangeTypeToJSON(object) {
    switch (object) {
        case exports.ExchangeType.EXCHANGE_UNSPECIFIED:
            return "EXCHANGE_UNSPECIFIED";
        case exports.ExchangeType.SPOT:
            return "SPOT";
        case exports.ExchangeType.DERIVATIVES:
            return "DERIVATIVES";
        case exports.ExchangeType.UNRECOGNIZED:
        default:
            return "UNRECOGNIZED";
    }
}
...
exports.PerpetualMarketLaunchProposal = {
    encode: function (message, writer) {
        ...
        if (message.reduceMarginRatio !== "") {
            writer.uint32(138).string(message.reduceMarginRatio);
        }
        return writer;
    },
    decode: function (input, length) {
...
exports.ExpiryFuturesMarketLaunchProposal = {
    encode: function (message, writer) {
        ...
        if (message.reduceMarginRatio !== "") {
            writer.uint32(146).string(message.reduceMarginRatio);
        }
        return writer;
    },
    decode: function (input, length) {
    ...
    fromPartial: function (object) {
        ...
        message.adminInfo = (object.adminInfo !== undefined && object.adminInfo !== null)
            ? exports.AdminInfo.fromPartial(object.adminInfo)
            : undefined;
        message.reduceMarginRatio = (_s = object.reduceMarginRatio) !== null && _s !== void 0 ? _s : "";
        return message;
    },
};
...
exports.AtomicMarketOrderFeeMultiplierScheduleProposal = {
    encode: function (message, writer) {
        ...
        try {
            for (var _b = __values(message.marketFeeMultipliers), _c = _b.next(); !_c.done; _c = _b.next()) {
                var v = _c.value;
                market_1.MarketFeeMultiplier.encode(v, writer.uint32(26).fork()).ldelim();
            }
        }
    ...
    fromPartial: function (object) {
        ...
        message.title = (_a = object.title) !== null && _a !== void 0 ? _a : "";
        message.description = (_b = object.description) !== null && _b !== void 0 ? _b : "";
        message.marketFeeMultipliers = ((_c = object.marketFeeMultipliers) === null || _c === void 0 ? void 0 : _c.map(function (e) { return market_1.MarketFeeMultiplier.fromPartial(e); })) || [];
        return message;
    },
};
