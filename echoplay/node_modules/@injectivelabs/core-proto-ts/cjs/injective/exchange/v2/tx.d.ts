...
export interface MsgSpotMarketLaunch {
    /** message sender, that is also the TX signer */
    sender: string;
    proposal: SpotMarketLaunchProposal | undefined;
}
...
export interface MsgPerpetualMarketLaunch {
    /** message sender, that is also the TX signer */
    sender: string;
    proposal: PerpetualMarketLaunchProposal | undefined;
}
...
export interface MsgExpiryFuturesMarketLaunch {
    /** message sender, that is also the TX signer */
    sender: string;
    proposal: ExpiryFuturesMarketLaunchProposal | undefined;
}
...
export interface MsgBinaryOptionsMarketLaunch {
    /** message sender, that is also the TX signer */
    sender: string;
    proposal: BinaryOptionsMarketLaunchProposal | undefined;
}
...
export interface MsgBatchCommunityPoolSpend {
    /** message sender, that is also the TX signer */
    sender: string;
    proposal: BatchCommunityPoolSpendProposal | undefined;
}
...
export interface MsgSpotMarketParamUpdate {
    /** message sender, that is also the TX signer */
    sender: string;
    proposal: SpotMarketParamUpdateProposal | undefined;
}
...
export interface MsgDerivativeMarketParamUpdate {
    /** message sender, that is also the TX signer */
    sender: string;
    proposal: DerivativeMarketParamUpdateProposal | undefined;
}
...
export interface MsgBinaryOptionsMarketParamUpdate {
    /** message sender, that is also the TX signer */
    sender: string;
    proposal: BinaryOptionsMarketParamUpdateProposal | undefined;
}
...
export interface MsgMarketForcedSettlement {
    /** message sender, that is also the TX signer */
    sender: string;
    proposal: MarketForcedSettlementProposal | undefined;
}
...
export interface MsgTradingRewardCampaignLaunch {
    /** message sender, that is also the TX signer */
    sender: string;
    proposal: TradingRewardCampaignLaunchProposal | undefined;
}
...
export interface MsgExchangeEnable {
    /** message sender, that is also the TX signer */
    sender: string;
    proposal: ExchangeEnableProposal | undefined;
}
...
export interface MsgTradingRewardCampaignUpdate {
    /** message sender, that is also the TX signer */
    sender: string;
    proposal: TradingRewardCampaignUpdateProposal | undefined;
}
...
export interface MsgTradingRewardPendingPointsUpdate {
    /** message sender, that is also the TX signer */
    sender: string;
    proposal: TradingRewardPendingPointsUpdateProposal | undefined;
}
...
export interface MsgFeeDiscount {
    /** message sender, that is also the TX signer */
    sender: string;
    proposal: FeeDiscountProposal | undefined;
}
...
export interface MsgAtomicMarketOrderFeeMultiplierSchedule {
    /** message sender, that is also the TX signer */
    sender: string;
    proposal: AtomicMarketOrderFeeMultiplierScheduleProposal | undefined;
}
 ...
 * transfer receivers
 */
export interface MsgSetDelegationTransferReceivers {
 ...
 */
export interface MsgSetDelegationTransferReceiversResponse {
}
...
export declare const MsgSpotMarketLaunch: {
    encode(message: MsgSpotMarketLaunch, writer?: _m0.Writer): _m0.Writer;
    decode(input: _m0.Reader | Uint8Array, length?: number): MsgSpotMarketLaunch;
    fromJSON(object: any): MsgSpotMarketLaunch;
    toJSON(message: MsgSpotMarketLaunch): unknown;
    create(base?: DeepPartial<MsgSpotMarketLaunch>): MsgSpotMarketLaunch;
    fromPartial(object: DeepPartial<MsgSpotMarketLaunch>): MsgSpotMarketLaunch;
};
export declare const MsgSpotMarketLaunchResponse: {
    encode(_: MsgSpotMarketLaunchResponse, writer?: _m0.Writer): _m0.Writer;
    decode(input: _m0.Reader | Uint8Array, length?: number): MsgSpotMarketLaunchResponse;
    fromJSON(_: any): MsgSpotMarketLaunchResponse;
    toJSON(_: MsgSpotMarketLaunchResponse): unknown;
    create(base?: DeepPartial<MsgSpotMarketLaunchResponse>): MsgSpotMarketLaunchResponse;
    fromPartial(_: DeepPartial<MsgSpotMarketLaunchResponse>): MsgSpotMarketLaunchResponse;
};
export declare const MsgPerpetualMarketLaunch: {
    encode(message: MsgPerpetualMarketLaunch, writer?: _m0.Writer): _m0.Writer;
    decode(input: _m0.Reader | Uint8Array, length?: number): MsgPerpetualMarketLaunch;
    fromJSON(object: any): MsgPerpetualMarketLaunch;
    toJSON(message: MsgPerpetualMarketLaunch): unknown;
    create(base?: DeepPartial<MsgPerpetualMarketLaunch>): MsgPerpetualMarketLaunch;
    fromPartial(object: DeepPartial<MsgPerpetualMarketLaunch>): MsgPerpetualMarketLaunch;
};
export declare const MsgPerpetualMarketLaunchResponse: {
    encode(_: MsgPerpetualMarketLaunchResponse, writer?: _m0.Writer): _m0.Writer;
    decode(input: _m0.Reader | Uint8Array, length?: number): MsgPerpetualMarketLaunchResponse;
    fromJSON(_: any): MsgPerpetualMarketLaunchResponse;
    toJSON(_: MsgPerpetualMarketLaunchResponse): unknown;
    create(base?: DeepPartial<MsgPerpetualMarketLaunchResponse>): MsgPerpetualMarketLaunchResponse;
    fromPartial(_: DeepPartial<MsgPerpetualMarketLaunchResponse>): MsgPerpetualMarketLaunchResponse;
};
export declare const MsgExpiryFuturesMarketLaunch: {
    encode(message: MsgExpiryFuturesMarketLaunch, writer?: _m0.Writer): _m0.Writer;
    decode(input: _m0.Reader | Uint8Array, length?: number): MsgExpiryFuturesMarketLaunch;
    fromJSON(object: any): MsgExpiryFuturesMarketLaunch;
    toJSON(message: MsgExpiryFuturesMarketLaunch): unknown;
    create(base?: DeepPartial<MsgExpiryFuturesMarketLaunch>): MsgExpiryFuturesMarketLaunch;
    fromPartial(object: DeepPartial<MsgExpiryFuturesMarketLaunch>): MsgExpiryFuturesMarketLaunch;
};
export declare const MsgExpiryFuturesMarketLaunchResponse: {
    encode(_: MsgExpiryFuturesMarketLaunchResponse, writer?: _m0.Writer): _m0.Writer;
    decode(input: _m0.Reader | Uint8Array, length?: number): MsgExpiryFuturesMarketLaunchResponse;
    fromJSON(_: any): MsgExpiryFuturesMarketLaunchResponse;
    toJSON(_: MsgExpiryFuturesMarketLaunchResponse): unknown;
    create(base?: DeepPartial<MsgExpiryFuturesMarketLaunchResponse>): MsgExpiryFuturesMarketLaunchResponse;
    fromPartial(_: DeepPartial<MsgExpiryFuturesMarketLaunchResponse>): MsgExpiryFuturesMarketLaunchResponse;
};
export declare const MsgBinaryOptionsMarketLaunch: {
    encode(message: MsgBinaryOptionsMarketLaunch, writer?: _m0.Writer): _m0.Writer;
    decode(input: _m0.Reader | Uint8Array, length?: number): MsgBinaryOptionsMarketLaunch;
    fromJSON(object: any): MsgBinaryOptionsMarketLaunch;
    toJSON(message: MsgBinaryOptionsMarketLaunch): unknown;
    create(base?: DeepPartial<MsgBinaryOptionsMarketLaunch>): MsgBinaryOptionsMarketLaunch;
    fromPartial(object: DeepPartial<MsgBinaryOptionsMarketLaunch>): MsgBinaryOptionsMarketLaunch;
};
export declare const MsgBinaryOptionsMarketLaunchResponse: {
    encode(_: MsgBinaryOptionsMarketLaunchResponse, writer?: _m0.Writer): _m0.Writer;
    decode(input: _m0.Reader | Uint8Array, length?: number): MsgBinaryOptionsMarketLaunchResponse;
    fromJSON(_: any): MsgBinaryOptionsMarketLaunchResponse;
    toJSON(_: MsgBinaryOptionsMarketLaunchResponse): unknown;
    create(base?: DeepPartial<MsgBinaryOptionsMarketLaunchResponse>): MsgBinaryOptionsMarketLaunchResponse;
    fromPartial(_: DeepPartial<MsgBinaryOptionsMarketLaunchResponse>): MsgBinaryOptionsMarketLaunchResponse;
};
export declare const MsgBatchCommunityPoolSpend: {
    encode(message: MsgBatchCommunityPoolSpend, writer?: _m0.Writer): _m0.Writer;
    decode(input: _m0.Reader | Uint8Array, length?: number): MsgBatchCommunityPoolSpend;
    fromJSON(object: any): MsgBatchCommunityPoolSpend;
    toJSON(message: MsgBatchCommunityPoolSpend): unknown;
    create(base?: DeepPartial<MsgBatchCommunityPoolSpend>): MsgBatchCommunityPoolSpend;
    fromPartial(object: DeepPartial<MsgBatchCommunityPoolSpend>): MsgBatchCommunityPoolSpend;
};
export declare const MsgBatchCommunityPoolSpendResponse: {
    encode(_: MsgBatchCommunityPoolSpendResponse, writer?: _m0.Writer): _m0.Writer;
    decode(input: _m0.Reader | Uint8Array, length?: number): MsgBatchCommunityPoolSpendResponse;
    fromJSON(_: any): MsgBatchCommunityPoolSpendResponse;
    toJSON(_: MsgBatchCommunityPoolSpendResponse): unknown;
    create(base?: DeepPartial<MsgBatchCommunityPoolSpendResponse>): MsgBatchCommunityPoolSpendResponse;
    fromPartial(_: DeepPartial<MsgBatchCommunityPoolSpendResponse>): MsgBatchCommunityPoolSpendResponse;
};
export declare const MsgSpotMarketParamUpdate: {
    encode(message: MsgSpotMarketParamUpdate, writer?: _m0.Writer): _m0.Writer;
    decode(input: _m0.Reader | Uint8Array, length?: number): MsgSpotMarketParamUpdate;
    fromJSON(object: any): MsgSpotMarketParamUpdate;
    toJSON(message: MsgSpotMarketParamUpdate): unknown;
    create(base?: DeepPartial<MsgSpotMarketParamUpdate>): MsgSpotMarketParamUpdate;
    fromPartial(object: DeepPartial<MsgSpotMarketParamUpdate>): MsgSpotMarketParamUpdate;
};
export declare const MsgSpotMarketParamUpdateResponse: {
    encode(_: MsgSpotMarketParamUpdateResponse, writer?: _m0.Writer): _m0.Writer;
    decode(input: _m0.Reader | Uint8Array, length?: number): MsgSpotMarketParamUpdateResponse;
    fromJSON(_: any): MsgSpotMarketParamUpdateResponse;
    toJSON(_: MsgSpotMarketParamUpdateResponse): unknown;
    create(base?: DeepPartial<MsgSpotMarketParamUpdateResponse>): MsgSpotMarketParamUpdateResponse;
    fromPartial(_: DeepPartial<MsgSpotMarketParamUpdateResponse>): MsgSpotMarketParamUpdateResponse;
};
export declare const MsgDerivativeMarketParamUpdate: {
    encode(message: MsgDerivativeMarketParamUpdate, writer?: _m0.Writer): _m0.Writer;
    decode(input: _m0.Reader | Uint8Array, length?: number): MsgDerivativeMarketParamUpdate;
    fromJSON(object: any): MsgDerivativeMarketParamUpdate;
    toJSON(message: MsgDerivativeMarketParamUpdate): unknown;
    create(base?: DeepPartial<MsgDerivativeMarketParamUpdate>): MsgDerivativeMarketParamUpdate;
    fromPartial(object: DeepPartial<MsgDerivativeMarketParamUpdate>): MsgDerivativeMarketParamUpdate;
};
export declare const MsgDerivativeMarketParamUpdateResponse: {
    encode(_: MsgDerivativeMarketParamUpdateResponse, writer?: _m0.Writer): _m0.Writer;
    decode(input: _m0.Reader | Uint8Array, length?: number): MsgDerivativeMarketParamUpdateResponse;
    fromJSON(_: any): MsgDerivativeMarketParamUpdateResponse;
    toJSON(_: MsgDerivativeMarketParamUpdateResponse): unknown;
    create(base?: DeepPartial<MsgDerivativeMarketParamUpdateResponse>): MsgDerivativeMarketParamUpdateResponse;
    fromPartial(_: DeepPartial<MsgDerivativeMarketParamUpdateResponse>): MsgDerivativeMarketParamUpdateResponse;
};
export declare const MsgBinaryOptionsMarketParamUpdate: {
    encode(message: MsgBinaryOptionsMarketParamUpdate, writer?: _m0.Writer): _m0.Writer;
    decode(input: _m0.Reader | Uint8Array, length?: number): MsgBinaryOptionsMarketParamUpdate;
    fromJSON(object: any): MsgBinaryOptionsMarketParamUpdate;
    toJSON(message: MsgBinaryOptionsMarketParamUpdate): unknown;
    create(base?: DeepPartial<MsgBinaryOptionsMarketParamUpdate>): MsgBinaryOptionsMarketParamUpdate;
    fromPartial(object: DeepPartial<MsgBinaryOptionsMarketParamUpdate>): MsgBinaryOptionsMarketParamUpdate;
};
export declare const MsgBinaryOptionsMarketParamUpdateResponse: {
    encode(_: MsgBinaryOptionsMarketParamUpdateResponse, writer?: _m0.Writer): _m0.Writer;
    decode(input: _m0.Reader | Uint8Array, length?: number): MsgBinaryOptionsMarketParamUpdateResponse;
    fromJSON(_: any): MsgBinaryOptionsMarketParamUpdateResponse;
    toJSON(_: MsgBinaryOptionsMarketParamUpdateResponse): unknown;
    create(base?: DeepPartial<MsgBinaryOptionsMarketParamUpdateResponse>): MsgBinaryOptionsMarketParamUpdateResponse;
    fromPartial(_: DeepPartial<MsgBinaryOptionsMarketParamUpdateResponse>): MsgBinaryOptionsMarketParamUpdateResponse;
};
export declare const MsgMarketForcedSettlement: {
    encode(message: MsgMarketForcedSettlement, writer?: _m0.Writer): _m0.Writer;
    decode(input: _m0.Reader | Uint8Array, length?: number): MsgMarketForcedSettlement;
    fromJSON(object: any): MsgMarketForcedSettlement;
    toJSON(message: MsgMarketForcedSettlement): unknown;
    create(base?: DeepPartial<MsgMarketForcedSettlement>): MsgMarketForcedSettlement;
    fromPartial(object: DeepPartial<MsgMarketForcedSettlement>): MsgMarketForcedSettlement;
};
export declare const MsgMarketForcedSettlementResponse: {
    encode(_: MsgMarketForcedSettlementResponse, writer?: _m0.Writer): _m0.Writer;
    decode(input: _m0.Reader | Uint8Array, length?: number): MsgMarketForcedSettlementResponse;
    fromJSON(_: any): MsgMarketForcedSettlementResponse;
    toJSON(_: MsgMarketForcedSettlementResponse): unknown;
    create(base?: DeepPartial<MsgMarketForcedSettlementResponse>): MsgMarketForcedSettlementResponse;
    fromPartial(_: DeepPartial<MsgMarketForcedSettlementResponse>): MsgMarketForcedSettlementResponse;
};
export declare const MsgTradingRewardCampaignLaunch: {
    encode(message: MsgTradingRewardCampaignLaunch, writer?: _m0.Writer): _m0.Writer;
    decode(input: _m0.Reader | Uint8Array, length?: number): MsgTradingRewardCampaignLaunch;
    fromJSON(object: any): MsgTradingRewardCampaignLaunch;
    toJSON(message: MsgTradingRewardCampaignLaunch): unknown;
    create(base?: DeepPartial<MsgTradingRewardCampaignLaunch>): MsgTradingRewardCampaignLaunch;
    fromPartial(object: DeepPartial<MsgTradingRewardCampaignLaunch>): MsgTradingRewardCampaignLaunch;
};
export declare const MsgTradingRewardCampaignLaunchResponse: {
    encode(_: MsgTradingRewardCampaignLaunchResponse, writer?: _m0.Writer): _m0.Writer;
    decode(input: _m0.Reader | Uint8Array, length?: number): MsgTradingRewardCampaignLaunchResponse;
    fromJSON(_: any): MsgTradingRewardCampaignLaunchResponse;
    toJSON(_: MsgTradingRewardCampaignLaunchResponse): unknown;
    create(base?: DeepPartial<MsgTradingRewardCampaignLaunchResponse>): MsgTradingRewardCampaignLaunchResponse;
    fromPartial(_: DeepPartial<MsgTradingRewardCampaignLaunchResponse>): MsgTradingRewardCampaignLaunchResponse;
};
export declare const MsgExchangeEnable: {
    encode(message: MsgExchangeEnable, writer?: _m0.Writer): _m0.Writer;
    decode(input: _m0.Reader | Uint8Array, length?: number): MsgExchangeEnable;
    fromJSON(object: any): MsgExchangeEnable;
    toJSON(message: MsgExchangeEnable): unknown;
    create(base?: DeepPartial<MsgExchangeEnable>): MsgExchangeEnable;
    fromPartial(object: DeepPartial<MsgExchangeEnable>): MsgExchangeEnable;
};
export declare const MsgExchangeEnableResponse: {
    encode(_: MsgExchangeEnableResponse, writer?: _m0.Writer): _m0.Writer;
    decode(input: _m0.Reader | Uint8Array, length?: number): MsgExchangeEnableResponse;
    fromJSON(_: any): MsgExchangeEnableResponse;
    toJSON(_: MsgExchangeEnableResponse): unknown;
    create(base?: DeepPartial<MsgExchangeEnableResponse>): MsgExchangeEnableResponse;
    fromPartial(_: DeepPartial<MsgExchangeEnableResponse>): MsgExchangeEnableResponse;
};
export declare const MsgTradingRewardCampaignUpdate: {
    encode(message: MsgTradingRewardCampaignUpdate, writer?: _m0.Writer): _m0.Writer;
    decode(input: _m0.Reader | Uint8Array, length?: number): MsgTradingRewardCampaignUpdate;
    fromJSON(object: any): MsgTradingRewardCampaignUpdate;
    toJSON(message: MsgTradingRewardCampaignUpdate): unknown;
    create(base?: DeepPartial<MsgTradingRewardCampaignUpdate>): MsgTradingRewardCampaignUpdate;
    fromPartial(object: DeepPartial<MsgTradingRewardCampaignUpdate>): MsgTradingRewardCampaignUpdate;
};
export declare const MsgTradingRewardCampaignUpdateResponse: {
    encode(_: MsgTradingRewardCampaignUpdateResponse, writer?: _m0.Writer): _m0.Writer;
    decode(input: _m0.Reader | Uint8Array, length?: number): MsgTradingRewardCampaignUpdateResponse;
    fromJSON(_: any): MsgTradingRewardCampaignUpdateResponse;
    toJSON(_: MsgTradingRewardCampaignUpdateResponse): unknown;
    create(base?: DeepPartial<MsgTradingRewardCampaignUpdateResponse>): MsgTradingRewardCampaignUpdateResponse;
    fromPartial(_: DeepPartial<MsgTradingRewardCampaignUpdateResponse>): MsgTradingRewardCampaignUpdateResponse;
};
export declare const MsgTradingRewardPendingPointsUpdate: {
    encode(message: MsgTradingRewardPendingPointsUpdate, writer?: _m0.Writer): _m0.Writer;
    decode(input: _m0.Reader | Uint8Array, length?: number): MsgTradingRewardPendingPointsUpdate;
    fromJSON(object: any): MsgTradingRewardPendingPointsUpdate;
    toJSON(message: MsgTradingRewardPendingPointsUpdate): unknown;
    create(base?: DeepPartial<MsgTradingRewardPendingPointsUpdate>): MsgTradingRewardPendingPointsUpdate;
    fromPartial(object: DeepPartial<MsgTradingRewardPendingPointsUpdate>): MsgTradingRewardPendingPointsUpdate;
};
export declare const MsgTradingRewardPendingPointsUpdateResponse: {
    encode(_: MsgTradingRewardPendingPointsUpdateResponse, writer?: _m0.Writer): _m0.Writer;
    decode(input: _m0.Reader | Uint8Array, length?: number): MsgTradingRewardPendingPointsUpdateResponse;
    fromJSON(_: any): MsgTradingRewardPendingPointsUpdateResponse;
    toJSON(_: MsgTradingRewardPendingPointsUpdateResponse): unknown;
    create(base?: DeepPartial<MsgTradingRewardPendingPointsUpdateResponse>): MsgTradingRewardPendingPointsUpdateResponse;
    fromPartial(_: DeepPartial<MsgTradingRewardPendingPointsUpdateResponse>): MsgTradingRewardPendingPointsUpdateResponse;
};
export declare const MsgFeeDiscount: {
    encode(message: MsgFeeDiscount, writer?: _m0.Writer): _m0.Writer;
    decode(input: _m0.Reader | Uint8Array, length?: number): MsgFeeDiscount;
    fromJSON(object: any): MsgFeeDiscount;
    toJSON(message: MsgFeeDiscount): unknown;
    create(base?: DeepPartial<MsgFeeDiscount>): MsgFeeDiscount;
    fromPartial(object: DeepPartial<MsgFeeDiscount>): MsgFeeDiscount;
};
export declare const MsgFeeDiscountResponse: {
    encode(_: MsgFeeDiscountResponse, writer?: _m0.Writer): _m0.Writer;
    decode(input: _m0.Reader | Uint8Array, length?: number): MsgFeeDiscountResponse;
    fromJSON(_: any): MsgFeeDiscountResponse;
    toJSON(_: MsgFeeDiscountResponse): unknown;
    create(base?: DeepPartial<MsgFeeDiscountResponse>): MsgFeeDiscountResponse;
    fromPartial(_: DeepPartial<MsgFeeDiscountResponse>): MsgFeeDiscountResponse;
};
export declare const MsgAtomicMarketOrderFeeMultiplierSchedule: {
    encode(message: MsgAtomicMarketOrderFeeMultiplierSchedule, writer?: _m0.Writer): _m0.Writer;
    decode(input: _m0.Reader | Uint8Array, length?: number): MsgAtomicMarketOrderFeeMultiplierSchedule;
    fromJSON(object: any): MsgAtomicMarketOrderFeeMultiplierSchedule;
    toJSON(message: MsgAtomicMarketOrderFeeMultiplierSchedule): unknown;
    create(base?: DeepPartial<MsgAtomicMarketOrderFeeMultiplierSchedule>): MsgAtomicMarketOrderFeeMultiplierSchedule;
    fromPartial(object: DeepPartial<MsgAtomicMarketOrderFeeMultiplierSchedule>): MsgAtomicMarketOrderFeeMultiplierSchedule;
};
export declare const MsgAtomicMarketOrderFeeMultiplierScheduleResponse: {
    encode(_: MsgAtomicMarketOrderFeeMultiplierScheduleResponse, writer?: _m0.Writer): _m0.Writer;
    decode(input: _m0.Reader | Uint8Array, length?: number): MsgAtomicMarketOrderFeeMultiplierScheduleResponse;
    fromJSON(_: any): MsgAtomicMarketOrderFeeMultiplierScheduleResponse;
    toJSON(_: MsgAtomicMarketOrderFeeMultiplierScheduleResponse): unknown;
    create(base?: DeepPartial<MsgAtomicMarketOrderFeeMultiplierScheduleResponse>): MsgAtomicMarketOrderFeeMultiplierScheduleResponse;
    fromPartial(_: DeepPartial<MsgAtomicMarketOrderFeeMultiplierScheduleResponse>): MsgAtomicMarketOrderFeeMultiplierScheduleResponse;
};
export declare const MsgSetDelegationTransferReceivers: {
    encode(message: MsgSetDelegationTransferReceivers, writer?: _m0.Writer): _m0.Writer;
    decode(input: _m0.Reader | Uint8Array, length?: number): MsgSetDelegationTransferReceivers;
    fromJSON(object: any): MsgSetDelegationTransferReceivers;
    toJSON(message: MsgSetDelegationTransferReceivers): unknown;
    create(base?: DeepPartial<MsgSetDelegationTransferReceivers>): MsgSetDelegationTransferReceivers;
    fromPartial(object: DeepPartial<MsgSetDelegationTransferReceivers>): MsgSetDelegationTransferReceivers;
};
export declare const MsgSetDelegationTransferReceiversResponse: {
    encode(_: MsgSetDelegationTransferReceiversResponse, writer?: _m0.Writer): _m0.Writer;
    decode(input: _m0.Reader | Uint8Array, length?: number): MsgSetDelegationTransferReceiversResponse;
    fromJSON(_: any): MsgSetDelegationTransferReceiversResponse;
    toJSON(_: MsgSetDelegationTransferReceiversResponse): unknown;
    create(base?: DeepPartial<MsgSetDelegationTransferReceiversResponse>): MsgSetDelegationTransferReceiversResponse;
    fromPartial(_: DeepPartial<MsgSetDelegationTransferReceiversResponse>): MsgSetDelegationTransferReceiversResponse;
};
export declare const MsgCancelPostOnlyMode: {
    encode(message: MsgCancelPostOnlyMode, writer?: _m0.Writer): _m0.Writer;
    decode(input: _m0.Reader | Uint8Array, length?: number): MsgCancelPostOnlyMode;
    fromJSON(object: any): MsgCancelPostOnlyMode;
    toJSON(message: MsgCancelPostOnlyMode): unknown;
    create(base?: DeepPartial<MsgCancelPostOnlyMode>): MsgCancelPostOnlyMode;
    fromPartial(object: DeepPartial<MsgCancelPostOnlyMode>): MsgCancelPostOnlyMode;
};
export declare const MsgCancelPostOnlyModeResponse: {
    encode(_: MsgCancelPostOnlyModeResponse, writer?: _m0.Writer): _m0.Writer;
    decode(input: _m0.Reader | Uint8Array, length?: number): MsgCancelPostOnlyModeResponse;
    fromJSON(_: any): MsgCancelPostOnlyModeResponse;
    toJSON(_: MsgCancelPostOnlyModeResponse): unknown;
    create(base?: DeepPartial<MsgCancelPostOnlyModeResponse>): MsgCancelPostOnlyModeResponse;
    fromPartial(_: DeepPartial<MsgCancelPostOnlyModeResponse>): MsgCancelPostOnlyModeResponse;
};
...
export interface Msg {
    ...
    LaunchSpotMarket(request: DeepPartial<MsgSpotMarketLaunch>, metadata?: grpc.Metadata): Promise<MsgSpotMarketLaunchResponse>;
    LaunchPerpetualMarket(request: DeepPartial<MsgPerpetualMarketLaunch>, metadata?: grpc.Metadata): Promise<MsgPerpetualMarketLaunchResponse>;
    LaunchExpiryFuturesMarket(request: DeepPartial<MsgExpiryFuturesMarketLaunch>, metadata?: grpc.Metadata): Promise<MsgExpiryFuturesMarketLaunchResponse>;
    LaunchBinaryOptionsMarket(request: DeepPartial<MsgBinaryOptionsMarketLaunch>, metadata?: grpc.Metadata): Promise<MsgBinaryOptionsMarketLaunchResponse>;
    BatchSpendCommunityPool(request: DeepPartial<MsgBatchCommunityPoolSpend>, metadata?: grpc.Metadata): Promise<MsgBatchCommunityPoolSpendResponse>;
    SpotMarketParamUpdate(request: DeepPartial<MsgSpotMarketParamUpdate>, metadata?: grpc.Metadata): Promise<MsgSpotMarketParamUpdateResponse>;
    DerivativeMarketParamUpdate(request: DeepPartial<MsgDerivativeMarketParamUpdate>, metadata?: grpc.Metadata): Promise<MsgDerivativeMarketParamUpdateResponse>;
    BinaryOptionsMarketParamUpdate(request: DeepPartial<MsgBinaryOptionsMarketParamUpdate>, metadata?: grpc.Metadata): Promise<MsgBinaryOptionsMarketParamUpdateResponse>;
    ForceSettleMarket(request: DeepPartial<MsgMarketForcedSettlement>, metadata?: grpc.Metadata): Promise<MsgMarketForcedSettlementResponse>;
    LaunchTradingRewardCampaign(request: DeepPartial<MsgTradingRewardCampaignLaunch>, metadata?: grpc.Metadata): Promise<MsgTradingRewardCampaignLaunchResponse>;
    EnableExchange(request: DeepPartial<MsgExchangeEnable>, metadata?: grpc.Metadata): Promise<MsgExchangeEnableResponse>;
    UpdateTradingRewardCampaign(request: DeepPartial<MsgTradingRewardCampaignUpdate>, metadata?: grpc.Metadata): Promise<MsgTradingRewardCampaignUpdateResponse>;
    UpdateTradingRewardPendingPoints(request: DeepPartial<MsgTradingRewardPendingPointsUpdate>, metadata?: grpc.Metadata): Promise<MsgTradingRewardPendingPointsUpdateResponse>;
    UpdateFeeDiscount(request: DeepPartial<MsgFeeDiscount>, metadata?: grpc.Metadata): Promise<MsgFeeDiscountResponse>;
    UpdateAtomicMarketOrderFeeMultiplierSchedule(request: DeepPartial<MsgAtomicMarketOrderFeeMultiplierSchedule>, metadata?: grpc.Metadata): Promise<MsgAtomicMarketOrderFeeMultiplierScheduleResponse>;
    SetDelegationTransferReceivers(request: DeepPartial<MsgSetDelegationTransferReceivers>, metadata?: grpc.Metadata): Promise<MsgSetDelegationTransferReceiversResponse>;
    CancelPostOnlyMode(request: DeepPartial<MsgCancelPostOnlyMode>, metadata?: grpc.Metadata): Promise<MsgCancelPostOnlyModeResponse>;
}
...
export declare const MsgLaunchSpotMarketDesc: UnaryMethodDefinitionish;
export declare const MsgLaunchPerpetualMarketDesc: UnaryMethodDefinitionish;
export declare const MsgLaunchExpiryFuturesMarketDesc: UnaryMethodDefinitionish;
export declare const MsgLaunchBinaryOptionsMarketDesc: UnaryMethodDefinitionish;
export declare const MsgBatchSpendCommunityPoolDesc: UnaryMethodDefinitionish;
export declare const MsgSpotMarketParamUpdateDesc: UnaryMethodDefinitionish;
export declare const MsgDerivativeMarketParamUpdateDesc: UnaryMethodDefinitionish;
export declare const MsgBinaryOptionsMarketParamUpdateDesc: UnaryMethodDefinitionish;
export declare const MsgForceSettleMarketDesc: UnaryMethodDefinitionish;
export declare const MsgLaunchTradingRewardCampaignDesc: UnaryMethodDefinitionish;
export declare const MsgEnableExchangeDesc: UnaryMethodDefinitionish;
export declare const MsgUpdateTradingRewardCampaignDesc: UnaryMethodDefinitionish;
export declare const MsgUpdateTradingRewardPendingPointsDesc: UnaryMethodDefinitionish;
export declare const MsgUpdateFeeDiscountDesc: UnaryMethodDefinitionish;
export declare const MsgUpdateAtomicMarketOrderFeeMultiplierScheduleDesc: UnaryMethodDefinitionish;
export declare const MsgSetDelegationTransferReceiversDesc: UnaryMethodDefinitionish;
export declare const MsgCancelPostOnlyModeDesc: UnaryMethodDefinitionish;
