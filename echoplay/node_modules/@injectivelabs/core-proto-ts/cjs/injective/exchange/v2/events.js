...
exports.EventBinaryOptionsMarketUpdate = {
    encode: function (message, writer) {
        ...
        if (message.market !== undefined) {
            market_1.BinaryOptionsMarket.encode(message.market, writer.uint32(10).fork()).ldelim();
        }
        return writer;
    },
    decode: function (input, length) {
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                case 1:
                    message.market = market_1.BinaryOptionsMarket.decode(reader, reader.uint32());
                    break;
                default:
                    reader.skipType(tag & 7);
                    break;
    ...
    fromJSON: function (object) {
        return { market: isSet(object.market) ? market_1.BinaryOptionsMarket.fromJSON(object.market) : undefined };
    },
    toJSON: function (message) {
        var obj = {};
        message.market !== undefined &&
            (obj.market = message.market ? market_1.BinaryOptionsMarket.toJSON(message.market) : undefined);
        return obj;
    },
    create: function (base) {
    ...
    fromPartial: function (object) {
        ...
        message.market = (object.market !== undefined && object.market !== null)
            ? market_1.BinaryOptionsMarket.fromPartial(object.market)
            : undefined;
        return message;
    },
};
...
exports.EventNewSpotOrders = {
    encode: function (message, writer) {
        ...
        try {
            for (var _c = __values(message.buyOrders), _d = _c.next(); !_d.done; _d = _c.next()) {
                var v = _d.value;
                order_1.SpotLimitOrder.encode(v, writer.uint32(18).fork()).ldelim();
            }
        }
        ...
        try {
            for (var _e = __values(message.sellOrders), _f = _e.next(); !_f.done; _f = _e.next()) {
                var v = _f.value;
                order_1.SpotLimitOrder.encode(v, writer.uint32(26).fork()).ldelim();
            }
        }
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                case 1:
                    ...
                    break;
                case 2:
                    message.buyOrders.push(order_1.SpotLimitOrder.decode(reader, reader.uint32()));
                    break;
                case 3:
                    message.sellOrders.push(order_1.SpotLimitOrder.decode(reader, reader.uint32()));
                    break;
                default:
                    reader.skipType(tag & 7);
                    break;
    ...
    fromJSON: function (object) {
        return {
            marketId: isSet(object.marketId) ? String(object.marketId) : "",
            buyOrders: Array.isArray(object === null || object === void 0 ? void 0 : object.buyOrders) ? object.buyOrders.map(function (e) { return order_1.SpotLimitOrder.fromJSON(e); }) : [],
            sellOrders: Array.isArray(object === null || object === void 0 ? void 0 : object.sellOrders)
                ? object.sellOrders.map(function (e) { return order_1.SpotLimitOrder.fromJSON(e); })
                : [],
        };
    },
    toJSON: function (message) {
        ...
        if (message.buyOrders) {
            obj.buyOrders = message.buyOrders.map(function (e) { return e ? order_1.SpotLimitOrder.toJSON(e) : undefined; });
        }
        else {
            obj.buyOrders = [];
        }
        if (message.sellOrders) {
            obj.sellOrders = message.sellOrders.map(function (e) { return e ? order_1.SpotLimitOrder.toJSON(e) : undefined; });
        }
        else {
            obj.sellOrders = [];
        }
    ...
    fromPartial: function (object) {
        ...
        var message = createBaseEventNewSpotOrders();
        message.marketId = (_a = object.marketId) !== null && _a !== void 0 ? _a : "";
        message.buyOrders = ((_b = object.buyOrders) === null || _b === void 0 ? void 0 : _b.map(function (e) { return order_1.SpotLimitOrder.fromPartial(e); })) || [];
        message.sellOrders = ((_c = object.sellOrders) === null || _c === void 0 ? void 0 : _c.map(function (e) { return order_1.SpotLimitOrder.fromPartial(e); })) || [];
        return message;
    },
};
...
exports.EventNewDerivativeOrders = {
    encode: function (message, writer) {
        ...
        try {
            for (var _c = __values(message.buyOrders), _d = _c.next(); !_d.done; _d = _c.next()) {
                var v = _d.value;
                order_1.DerivativeLimitOrder.encode(v, writer.uint32(18).fork()).ldelim();
            }
        }
        ...
        try {
            for (var _e = __values(message.sellOrders), _f = _e.next(); !_f.done; _f = _e.next()) {
                var v = _f.value;
                order_1.DerivativeLimitOrder.encode(v, writer.uint32(26).fork()).ldelim();
            }
        }
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                case 1:
                    ...
                    break;
                case 2:
                    message.buyOrders.push(order_1.DerivativeLimitOrder.decode(reader, reader.uint32()));
                    break;
                case 3:
                    message.sellOrders.push(order_1.DerivativeLimitOrder.decode(reader, reader.uint32()));
                    break;
                default:
                    reader.skipType(tag & 7);
                    break;
    ...
    fromJSON: function (object) {
        return {
            ...
            buyOrders: Array.isArray(object === null || object === void 0 ? void 0 : object.buyOrders)
                ? object.buyOrders.map(function (e) { return order_1.DerivativeLimitOrder.fromJSON(e); })
                : [],
            sellOrders: Array.isArray(object === null || object === void 0 ? void 0 : object.sellOrders)
                ? object.sellOrders.map(function (e) { return order_1.DerivativeLimitOrder.fromJSON(e); })
                : [],
        };
    },
    toJSON: function (message) {
        ...
        message.marketId !== undefined && (obj.marketId = message.marketId);
        if (message.buyOrders) {
            obj.buyOrders = message.buyOrders.map(function (e) { return e ? order_1.DerivativeLimitOrder.toJSON(e) : undefined; });
        }
        else {
            obj.buyOrders = [];
        }
        if (message.sellOrders) {
            obj.sellOrders = message.sellOrders.map(function (e) { return e ? order_1.DerivativeLimitOrder.toJSON(e) : undefined; });
        }
        else {
            obj.sellOrders = [];
        }
    ...
    fromPartial: function (object) {
        ...
        var message = createBaseEventNewDerivativeOrders();
        message.marketId = (_a = object.marketId) !== null && _a !== void 0 ? _a : "";
        message.buyOrders = ((_b = object.buyOrders) === null || _b === void 0 ? void 0 : _b.map(function (e) { return order_1.DerivativeLimitOrder.fromPartial(e); })) || [];
        message.sellOrders = ((_c = object.sellOrders) === null || _c === void 0 ? void 0 : _c.map(function (e) { return order_1.DerivativeLimitOrder.fromPartial(e); })) || [];
        return message;
    },
};
...
exports.EventCancelSpotOrder = {
    encode: function (message, writer) {
        ...
        if (message.order !== undefined) {
            order_1.SpotLimitOrder.encode(message.order, writer.uint32(18).fork()).ldelim();
        }
        return writer;
    },
    decode: function (input, length) {
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                case 1:
                    ...
                    break;
                case 2:
                    message.order = order_1.SpotLimitOrder.decode(reader, reader.uint32());
                    break;
                default:
                    reader.skipType(tag & 7);
                    break;
    ...
    fromJSON: function (object) {
        return {
            marketId: isSet(object.marketId) ? String(object.marketId) : "",
            order: isSet(object.order) ? order_1.SpotLimitOrder.fromJSON(object.order) : undefined,
        };
    },
    toJSON: function (message) {
        var obj = {};
        message.marketId !== undefined && (obj.marketId = message.marketId);
        message.order !== undefined && (obj.order = message.order ? order_1.SpotLimitOrder.toJSON(message.order) : undefined);
        return obj;
    },
    create: function (base) {
    ...
    fromPartial: function (object) {
        ...
        message.order = (object.order !== undefined && object.order !== null)
            ? order_1.SpotLimitOrder.fromPartial(object.order)
            : undefined;
        return message;
    },
};
...
exports.EventSpotMarketUpdate = {
    encode: function (message, writer) {
        if (writer === void 0) { writer = minimal_js_1.default.Writer.create(); }
        if (message.market !== undefined) {
            market_1.SpotMarket.encode(message.market, writer.uint32(10).fork()).ldelim();
        }
        return writer;
    },
    decode: function (input, length) {
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                case 1:
                    message.market = market_1.SpotMarket.decode(reader, reader.uint32());
                    break;
                default:
                    reader.skipType(tag & 7);
                    break;
    ...
    fromJSON: function (object) {
        return { market: isSet(object.market) ? market_1.SpotMarket.fromJSON(object.market) : undefined };
    },
    toJSON: function (message) {
        var obj = {};
        message.market !== undefined && (obj.market = message.market ? market_1.SpotMarket.toJSON(message.market) : undefined);
        return obj;
    },
    create: function (base) {
    ...
    fromPartial: function (object) {
        var message = createBaseEventSpotMarketUpdate();
        message.market = (object.market !== undefined && object.market !== null)
            ? market_1.SpotMarket.fromPartial(object.market)
            : undefined;
        return message;
    },
};
...
exports.EventPerpetualMarketUpdate = {
    encode: function (message, writer) {
        if (writer === void 0) { writer = minimal_js_1.default.Writer.create(); }
        if (message.market !== undefined) {
            market_1.DerivativeMarket.encode(message.market, writer.uint32(10).fork()).ldelim();
        }
        if (message.perpetualMarketInfo !== undefined) {
            market_1.PerpetualMarketInfo.encode(message.perpetualMarketInfo, writer.uint32(18).fork()).ldelim();
        }
        if (message.funding !== undefined) {
            market_1.PerpetualMarketFunding.encode(message.funding, writer.uint32(26).fork()).ldelim();
        }
        return writer;
    },
    decode: function (input, length) {
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                case 1:
                    message.market = market_1.DerivativeMarket.decode(reader, reader.uint32());
                    break;
                case 2:
                    message.perpetualMarketInfo = market_1.PerpetualMarketInfo.decode(reader, reader.uint32());
                    break;
                case 3:
                    message.funding = market_1.PerpetualMarketFunding.decode(reader, reader.uint32());
                    break;
                default:
                    reader.skipType(tag & 7);
                    break;
    ...
    fromJSON: function (object) {
        return {
            market: isSet(object.market) ? market_1.DerivativeMarket.fromJSON(object.market) : undefined,
            perpetualMarketInfo: isSet(object.perpetualMarketInfo)
                ? market_1.PerpetualMarketInfo.fromJSON(object.perpetualMarketInfo)
                : undefined,
            funding: isSet(object.funding) ? market_1.PerpetualMarketFunding.fromJSON(object.funding) : undefined,
        };
    },
    toJSON: function (message) {
        var obj = {};
        message.market !== undefined && (obj.market = message.market ? market_1.DerivativeMarket.toJSON(message.market) : undefined);
        message.perpetualMarketInfo !== undefined && (obj.perpetualMarketInfo = message.perpetualMarketInfo
            ? market_1.PerpetualMarketInfo.toJSON(message.perpetualMarketInfo)
            : undefined);
        message.funding !== undefined &&
            (obj.funding = message.funding ? market_1.PerpetualMarketFunding.toJSON(message.funding) : undefined);
        return obj;
    },
    create: function (base) {
    ...
    fromPartial: function (object) {
        var message = createBaseEventPerpetualMarketUpdate();
        message.market = (object.market !== undefined && object.market !== null)
            ? market_1.DerivativeMarket.fromPartial(object.market)
            : undefined;
        message.perpetualMarketInfo = (object.perpetualMarketInfo !== undefined && object.perpetualMarketInfo !== null)
            ? market_1.PerpetualMarketInfo.fromPartial(object.perpetualMarketInfo)
            : undefined;
        message.funding = (object.funding !== undefined && object.funding !== null)
            ? market_1.PerpetualMarketFunding.fromPartial(object.funding)
            : undefined;
        return message;
    },
};
...
exports.EventExpiryFuturesMarketUpdate = {
    encode: function (message, writer) {
        ...
        if (message.expiryFuturesMarketInfo !== undefined) {
            market_1.ExpiryFuturesMarketInfo.encode(message.expiryFuturesMarketInfo, writer.uint32(26).fork()).ldelim();
        }
        return writer;
    },
    decode: function (input, length) {
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                case 1:
                    ...
                    break;
                case 3:
                    message.expiryFuturesMarketInfo = market_1.ExpiryFuturesMarketInfo.decode(reader, reader.uint32());
                    break;
                default:
                    reader.skipType(tag & 7);
                    break;
    ...
    fromJSON: function (object) {
        return {
            ...
            expiryFuturesMarketInfo: isSet(object.expiryFuturesMarketInfo)
                ? market_1.ExpiryFuturesMarketInfo.fromJSON(object.expiryFuturesMarketInfo)
                : undefined,
        };
    },
    toJSON: function (message) {
        ...
        message.expiryFuturesMarketInfo !== undefined && (obj.expiryFuturesMarketInfo = message.expiryFuturesMarketInfo
            ? market_1.ExpiryFuturesMarketInfo.toJSON(message.expiryFuturesMarketInfo)
            : undefined);
        return obj;
    },
    create: function (base) {
    ...
    fromPartial: function (object) {
        ...
        message.expiryFuturesMarketInfo =
            (object.expiryFuturesMarketInfo !== undefined && object.expiryFuturesMarketInfo !== null)
                ? market_1.ExpiryFuturesMarketInfo.fromPartial(object.expiryFuturesMarketInfo)
                : undefined;
        return message;
    },
};
...
exports.EventPerpetualMarketFundingUpdate = {
    encode: function (message, writer) {
        ...
        if (message.funding !== undefined) {
            market_1.PerpetualMarketFunding.encode(message.funding, writer.uint32(18).fork()).ldelim();
        }
...
exports.DerivativeMarketOrderCancel = {
    encode: function (message, writer) {
        ...
        if (message.marketOrder !== undefined) {
            order_1.DerivativeMarketOrder.encode(message.marketOrder, writer.uint32(10).fork()).ldelim();
        }
    ...
    decode: function (input, length) {
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                case 1:
                    message.marketOrder = order_1.DerivativeMarketOrder.decode(reader, reader.uint32());
                    break;
                case 2:
    ...
    fromJSON: function (object) {
        return {
            marketOrder: isSet(object.marketOrder) ? order_1.DerivativeMarketOrder.fromJSON(object.marketOrder) : undefined,
    ...
    toJSON: function (message) {
        ...
        message.marketOrder !== undefined &&
            (obj.marketOrder = message.marketOrder ? order_1.DerivativeMarketOrder.toJSON(message.marketOrder) : undefined);
    ...
    fromPartial: function (object) {
        ...
        message.marketOrder = (object.marketOrder !== undefined && object.marketOrder !== null)
            ? order_1.DerivativeMarketOrder.fromPartial(object.marketOrder)
            : undefined;
...
exports.EventCancelDerivativeOrder = {
    encode: function (message, writer) {
        ...
        if (message.limitOrder !== undefined) {
            order_1.DerivativeLimitOrder.encode(message.limitOrder, writer.uint32(26).fork()).ldelim();
        }
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                ...
                case 2:
                    ...
                    break;
                case 3:
                    message.limitOrder = order_1.DerivativeLimitOrder.decode(reader, reader.uint32());
                    break;
                case 4:
    ...
    fromJSON: function (object) {
        return {
            ...
            limitOrder: isSet(object.limitOrder) ? order_1.DerivativeLimitOrder.fromJSON(object.limitOrder) : undefined,
    ...
    toJSON: function (message) {
        ...
        message.limitOrder !== undefined &&
            (obj.limitOrder = message.limitOrder ? order_1.DerivativeLimitOrder.toJSON(message.limitOrder) : undefined);
    ...
    fromPartial: function (object) {
        ...
        message.limitOrder = (object.limitOrder !== undefined && object.limitOrder !== null)
            ? order_1.DerivativeLimitOrder.fromPartial(object.limitOrder)
            : undefined;
...
exports.EventCancelConditionalDerivativeOrder = {
    encode: function (message, writer) {
        ...
        if (message.marketOrder !== undefined) {
            order_1.DerivativeMarketOrder.encode(message.marketOrder, writer.uint32(34).fork()).ldelim();
        }
        return writer;
    },
    decode: function (input, length) {
...
exports.EventAtomicMarketOrderFeeMultipliersUpdated = {
    encode: function (message, writer) {
        ...
        try {
            for (var _b = __values(message.marketFeeMultipliers), _c = _b.next(); !_c.done; _c = _b.next()) {
                var v = _c.value;
                market_1.MarketFeeMultiplier.encode(v, writer.uint32(10).fork()).ldelim();
            }
        }
    ...
    decode: function (input, length) {
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                case 1:
                    message.marketFeeMultipliers.push(market_1.MarketFeeMultiplier.decode(reader, reader.uint32()));
                    break;
                default:
                    reader.skipType(tag & 7);
                    break;
    ...
    fromJSON: function (object) {
        return {
            marketFeeMultipliers: Array.isArray(object === null || object === void 0 ? void 0 : object.marketFeeMultipliers)
                ? object.marketFeeMultipliers.map(function (e) { return market_1.MarketFeeMultiplier.fromJSON(e); })
                : [],
        };
    },
    toJSON: function (message) {
        ...
        if (message.marketFeeMultipliers) {
            obj.marketFeeMultipliers = message.marketFeeMultipliers.map(function (e) { return e ? market_1.MarketFeeMultiplier.toJSON(e) : undefined; });
        }
        else {
    ...
    fromPartial: function (object) {
        var _a;
        var message = createBaseEventAtomicMarketOrderFeeMultipliersUpdated();
        message.marketFeeMultipliers = ((_a = object.marketFeeMultipliers) === null || _a === void 0 ? void 0 : _a.map(function (e) { return market_1.MarketFeeMultiplier.fromPartial(e); })) || [];
        return message;
    },
};
...
function createBaseEventDerivativeOrdersV2Migration() {
    return { marketId: "", buyOrderChanges: [], sellOrderChanges: [] };
}
exports.EventDerivativeOrdersV2Migration = {
    encode: function (message, writer) {
        var e_20, _a, e_21, _b;
        if (writer === void 0) { writer = minimal_js_1.default.Writer.create(); }
        if (message.marketId !== "") {
        ...
        try {
            for (var _c = __values(message.buyOrderChanges), _d = _c.next(); !_d.done; _d = _c.next()) {
                var v = _d.value;
                exports.DerivativeOrderV2Changes.encode(v, writer.uint32(18).fork()).ldelim();
            }
        }
        ...
        try {
            for (var _e = __values(message.sellOrderChanges), _f = _e.next(); !_f.done; _f = _e.next()) {
                var v = _f.value;
                exports.DerivativeOrderV2Changes.encode(v, writer.uint32(26).fork()).ldelim();
            }
        }
    ...
    decode: function (input, length) {
        var reader = input instanceof minimal_js_1.default.Reader ? input : new minimal_js_1.default.Reader(input);
        var end = length === undefined ? reader.len : reader.pos + length;
        var message = createBaseEventDerivativeOrdersV2Migration();
        while (reader.pos < end) {
            var tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
                    ...
                    break;
                case 2:
                    message.buyOrderChanges.push(exports.DerivativeOrderV2Changes.decode(reader, reader.uint32()));
                    break;
                case 3:
                    message.sellOrderChanges.push(exports.DerivativeOrderV2Changes.decode(reader, reader.uint32()));
                    break;
                default:
                    reader.skipType(tag & 7);
                    break;
    ...
    fromJSON: function (object) {
        return {
            marketId: isSet(object.marketId) ? String(object.marketId) : "",
            buyOrderChanges: Array.isArray(object === null || object === void 0 ? void 0 : object.buyOrderChanges)
                ? object.buyOrderChanges.map(function (e) { return exports.DerivativeOrderV2Changes.fromJSON(e); })
                : [],
            sellOrderChanges: Array.isArray(object === null || object === void 0 ? void 0 : object.sellOrderChanges)
                ? object.sellOrderChanges.map(function (e) { return exports.DerivativeOrderV2Changes.fromJSON(e); })
                : [],
        };
    },
    toJSON: function (message) {
        var obj = {};
        message.marketId !== undefined && (obj.marketId = message.marketId);
        if (message.buyOrderChanges) {
            obj.buyOrderChanges = message.buyOrderChanges.map(function (e) { return e ? exports.DerivativeOrderV2Changes.toJSON(e) : undefined; });
        }
        else {
            obj.buyOrderChanges = [];
        }
        if (message.sellOrderChanges) {
            obj.sellOrderChanges = message.sellOrderChanges.map(function (e) { return e ? exports.DerivativeOrderV2Changes.toJSON(e) : undefined; });
        }
        else {
            obj.sellOrderChanges = [];
        }
        return obj;
    },
    create: function (base) {
        return exports.EventDerivativeOrdersV2Migration.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial: function (object) {
        var _a, _b, _c;
        var message = createBaseEventDerivativeOrdersV2Migration();
        message.marketId = (_a = object.marketId) !== null && _a !== void 0 ? _a : "";
        message.buyOrderChanges = ((_b = object.buyOrderChanges) === null || _b === void 0 ? void 0 : _b.map(function (e) { return exports.DerivativeOrderV2Changes.fromPartial(e); })) || [];
        message.sellOrderChanges = ((_c = object.sellOrderChanges) === null || _c === void 0 ? void 0 : _c.map(function (e) { return exports.DerivativeOrderV2Changes.fromPartial(e); })) || [];
        return message;
    },
};
function createBaseDerivativeOrderV2Changes() {
    return { cid: "", hash: new Uint8Array(), p: "", q: "", m: "", f: "", tp: "" };
}
exports.DerivativeOrderV2Changes = {
    encode: function (message, writer) {
        if (writer === void 0) { writer = minimal_js_1.default.Writer.create(); }
        if (message.cid !== "") {
        ...
        if (message.p !== "") {
            writer.uint32(26).string(message.p);
        }
        if (message.q !== "") {
            writer.uint32(34).string(message.q);
        }
        if (message.m !== "") {
            writer.uint32(42).string(message.m);
        }
        if (message.f !== "") {
            writer.uint32(50).string(message.f);
        }
        if (message.tp !== "") {
            writer.uint32(58).string(message.tp);
        }
        return writer;
    },
    decode: function (input, length) {
        var reader = input instanceof minimal_js_1.default.Reader ? input : new minimal_js_1.default.Reader(input);
        var end = length === undefined ? reader.len : reader.pos + length;
        var message = createBaseDerivativeOrderV2Changes();
        while (reader.pos < end) {
            var tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
    ...
    fromJSON: function (object) {
        return {
            ...
            f: isSet(object.f) ? String(object.f) : "",
    ...
    toJSON: function (message) {
        ...
        message.tp !== undefined && (obj.tp = message.tp);
        return obj;
    },
    create: function (base) {
        return exports.DerivativeOrderV2Changes.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial: function (object) {
        ...
        message.hash = (_b = object.hash) !== null && _b !== void 0 ? _b : new Uint8Array();
        message.p = (_c = object.p) !== null && _c !== void 0 ? _c : "";
        message.q = (_d = object.q) !== null && _d !== void 0 ? _d : "";
        message.m = (_e = object.m) !== null && _e !== void 0 ? _e : "";
        message.f = (_f = object.f) !== null && _f !== void 0 ? _f : "";
        message.tp = (_g = object.tp) !== null && _g !== void 0 ? _g : "";
        return message;
    },
};
function createBaseEventSpotOrdersV2Migration() {
    return { marketId: "", buyOrderChanges: [], sellOrderChanges: [] };
}
exports.EventSpotOrdersV2Migration = {
    encode: function (message, writer) {
        var e_22, _a, e_23, _b;
        if (writer === void 0) { writer = minimal_js_1.default.Writer.create(); }
        if (message.marketId !== "") {
        ...
        try {
            for (var _c = __values(message.buyOrderChanges), _d = _c.next(); !_d.done; _d = _c.next()) {
                var v = _d.value;
                exports.SpotOrderV2Changes.encode(v, writer.uint32(18).fork()).ldelim();
            }
        }
        ...
        try {
            for (var _e = __values(message.sellOrderChanges), _f = _e.next(); !_f.done; _f = _e.next()) {
                var v = _f.value;
                exports.SpotOrderV2Changes.encode(v, writer.uint32(26).fork()).ldelim();
            }
        }
    ...
    decode: function (input, length) {
        var reader = input instanceof minimal_js_1.default.Reader ? input : new minimal_js_1.default.Reader(input);
        var end = length === undefined ? reader.len : reader.pos + length;
        var message = createBaseEventSpotOrdersV2Migration();
        while (reader.pos < end) {
            var tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
                    ...
                    break;
                case 2:
                    message.buyOrderChanges.push(exports.SpotOrderV2Changes.decode(reader, reader.uint32()));
                    break;
                case 3:
                    message.sellOrderChanges.push(exports.SpotOrderV2Changes.decode(reader, reader.uint32()));
                    break;
                default:
                    reader.skipType(tag & 7);
                    break;
    ...
    fromJSON: function (object) {
        return {
            marketId: isSet(object.marketId) ? String(object.marketId) : "",
            buyOrderChanges: Array.isArray(object === null || object === void 0 ? void 0 : object.buyOrderChanges)
                ? object.buyOrderChanges.map(function (e) { return exports.SpotOrderV2Changes.fromJSON(e); })
                : [],
            sellOrderChanges: Array.isArray(object === null || object === void 0 ? void 0 : object.sellOrderChanges)
                ? object.sellOrderChanges.map(function (e) { return exports.SpotOrderV2Changes.fromJSON(e); })
                : [],
        };
    },
    toJSON: function (message) {
        ...
        message.marketId !== undefined && (obj.marketId = message.marketId);
        if (message.buyOrderChanges) {
            obj.buyOrderChanges = message.buyOrderChanges.map(function (e) { return e ? exports.SpotOrderV2Changes.toJSON(e) : undefined; });
        }
        else {
            obj.buyOrderChanges = [];
        }
        if (message.sellOrderChanges) {
            obj.sellOrderChanges = message.sellOrderChanges.map(function (e) { return e ? exports.SpotOrderV2Changes.toJSON(e) : undefined; });
        }
        else {
            obj.sellOrderChanges = [];
        }
    ...
    create: function (base) {
        return exports.EventSpotOrdersV2Migration.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial: function (object) {
        var _a, _b, _c;
        var message = createBaseEventSpotOrdersV2Migration();
        message.marketId = (_a = object.marketId) !== null && _a !== void 0 ? _a : "";
        message.buyOrderChanges = ((_b = object.buyOrderChanges) === null || _b === void 0 ? void 0 : _b.map(function (e) { return exports.SpotOrderV2Changes.fromPartial(e); })) || [];
        message.sellOrderChanges = ((_c = object.sellOrderChanges) === null || _c === void 0 ? void 0 : _c.map(function (e) { return exports.SpotOrderV2Changes.fromPartial(e); })) || [];
        return message;
    },
};
function createBaseEventTriggerConditionalMarketOrderFailed() {
    return { marketId: "", subaccountId: "", markPrice: "", orderHash: new Uint8Array(), triggerErr: "" };
}
exports.EventTriggerConditionalMarketOrderFailed = {
    encode: function (message, writer) {
        if (writer === void 0) { writer = minimal_js_1.default.Writer.create(); }
        if (message.marketId !== "") {
            writer.uint32(10).string(message.marketId);
        ...
        if (message.markPrice !== "") {
            writer.uint32(26).string(message.markPrice);
        }
        if (message.orderHash.length !== 0) {
            writer.uint32(34).bytes(message.orderHash);
        }
        if (message.triggerErr !== "") {
            writer.uint32(42).string(message.triggerErr);
        }
        return writer;
    },
    decode: function (input, length) {
        var reader = input instanceof minimal_js_1.default.Reader ? input : new minimal_js_1.default.Reader(input);
        var end = length === undefined ? reader.len : reader.pos + length;
        var message = createBaseEventTriggerConditionalMarketOrderFailed();
        while (reader.pos < end) {
            var tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
    ...
    fromJSON: function (object) {
        return {
            ...
            triggerErr: isSet(object.triggerErr) ? String(object.triggerErr) : "",
        };
    },
    toJSON: function (message) {
        var obj = {};
        ...
        message.triggerErr !== undefined && (obj.triggerErr = message.triggerErr);
        return obj;
    },
    create: function (base) {
        return exports.EventTriggerConditionalMarketOrderFailed.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial: function (object) {
        var _a, _b, _c, _d, _e;
        var message = createBaseEventTriggerConditionalMarketOrderFailed();
        message.marketId = (_a = object.marketId) !== null && _a !== void 0 ? _a : "";
        message.subaccountId = (_b = object.subaccountId) !== null && _b !== void 0 ? _b : "";
        message.markPrice = (_c = object.markPrice) !== null && _c !== void 0 ? _c : "";
        message.orderHash = (_d = object.orderHash) !== null && _d !== void 0 ? _d : new Uint8Array();
        message.triggerErr = (_e = object.triggerErr) !== null && _e !== void 0 ? _e : "";
        return message;
    },
};
function createBaseEventTriggerConditionalLimitOrderFailed() {
    return { marketId: "", subaccountId: "", markPrice: "", orderHash: new Uint8Array(), triggerErr: "" };
}
exports.EventTriggerConditionalLimitOrderFailed = {
    encode: function (message, writer) {
        if (writer === void 0) { writer = minimal_js_1.default.Writer.create(); }
        if (message.marketId !== "") {
            writer.uint32(10).string(message.marketId);
    ...
    decode: function (input, length) {
        var reader = input instanceof minimal_js_1.default.Reader ? input : new minimal_js_1.default.Reader(input);
        var end = length === undefined ? reader.len : reader.pos + length;
        var message = createBaseEventTriggerConditionalLimitOrderFailed();
        while (reader.pos < end) {
            var tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
    ...
    create: function (base) {
        return exports.EventTriggerConditionalLimitOrderFailed.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial: function (object) {
        var _a, _b, _c, _d, _e;
        var message = createBaseEventTriggerConditionalLimitOrderFailed();
...
function createBaseSpotOrderV2Changes() {
    return { cid: "", hash: new Uint8Array(), p: "", q: "", f: "", tp: "" };
}
exports.SpotOrderV2Changes = {
    encode: function (message, writer) {
        if (writer === void 0) { writer = minimal_js_1.default.Writer.create(); }
        if (message.cid !== "") {
            writer.uint32(10).string(message.cid);
        ...
        if (message.f !== "") {
            writer.uint32(42).string(message.f);
        }
        if (message.tp !== "") {
            writer.uint32(50).string(message.tp);
        }
        return writer;
    },
    decode: function (input, length) {
        var reader = input instanceof minimal_js_1.default.Reader ? input : new minimal_js_1.default.Reader(input);
        var end = length === undefined ? reader.len : reader.pos + length;
        var message = createBaseSpotOrderV2Changes();
        while (reader.pos < end) {
            var tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
    ...
    create: function (base) {
        return exports.SpotOrderV2Changes.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial: function (object) {
        var _a, _b, _c, _d, _e, _f;
        var message = createBaseSpotOrderV2Changes();
        ...
        message.p = (_c = object.p) !== null && _c !== void 0 ? _c : "";
        message.q = (_d = object.q) !== null && _d !== void 0 ? _d : "";
        message.f = (_e = object.f) !== null && _e !== void 0 ? _e : "";
        message.tp = (_f = object.tp) !== null && _f !== void 0 ? _f : "";
        return message;
    },
};
function createBaseEventDerivativePositionV2Migration() {
    return { position: undefined };
}
exports.EventDerivativePositionV2Migration = {
    encode: function (message, writer) {
        if (writer === void 0) { writer = minimal_js_1.default.Writer.create(); }
        if (message.position !== undefined) {
            exchange_1.DerivativePosition.encode(message.position, writer.uint32(10).fork()).ldelim();
        }
        return writer;
    },
    decode: function (input, length) {
        var reader = input instanceof minimal_js_1.default.Reader ? input : new minimal_js_1.default.Reader(input);
        var end = length === undefined ? reader.len : reader.pos + length;
        var message = createBaseEventDerivativePositionV2Migration();
        while (reader.pos < end) {
            var tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
                    message.position = exchange_1.DerivativePosition.decode(reader, reader.uint32());
                    break;
                default:
                    reader.skipType(tag & 7);
                    break;
    ...
    fromJSON: function (object) {
        return { position: isSet(object.position) ? exchange_1.DerivativePosition.fromJSON(object.position) : undefined };
    },
    toJSON: function (message) {
        var obj = {};
        message.position !== undefined &&
            (obj.position = message.position ? exchange_1.DerivativePosition.toJSON(message.position) : undefined);
        return obj;
    },
    create: function (base) {
        return exports.EventDerivativePositionV2Migration.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial: function (object) {
        var message = createBaseEventDerivativePositionV2Migration();
        message.position = (object.position !== undefined && object.position !== null)
            ? exchange_1.DerivativePosition.fromPartial(object.position)
            : undefined;
        return message;
    },
};
