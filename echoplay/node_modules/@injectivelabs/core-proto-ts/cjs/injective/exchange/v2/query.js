...
function orderSideFromJSON(object) {
    switch (object) {
        ...
        case "Side_Unspecified":
            return exports.OrderSide.Side_Unspecified;
        case 1:
        case "Buy":
            return exports.OrderSide.Buy;
        case 2:
        case "Sell":
            return exports.OrderSide.Sell;
        case -1:
        case "UNRECOGNIZED":
        default:
            return exports.OrderSide.UNRECOGNIZED;
    }
}
function orderSideToJSON(object) {
    switch (object) {
        case exports.OrderSide.Side_Unspecified:
            return "Side_Unspecified";
        case exports.OrderSide.Buy:
            return "Buy";
        case exports.OrderSide.Sell:
            return "Sell";
        case exports.OrderSide.UNRECOGNIZED:
        default:
            return "UNRECOGNIZED";
    }
}
...
function cancellationStrategyFromJSON(object) {
    switch (object) {
        ...
        case "UnspecifiedOrder":
            return exports.CancellationStrategy.UnspecifiedOrder;
        case 1:
        case "FromWorstToBest":
            return exports.CancellationStrategy.FromWorstToBest;
        case 2:
        case "FromBestToWorst":
            return exports.CancellationStrategy.FromBestToWorst;
        case -1:
        case "UNRECOGNIZED":
        default:
            return exports.CancellationStrategy.UNRECOGNIZED;
    }
}
function cancellationStrategyToJSON(object) {
    switch (object) {
        case exports.CancellationStrategy.UnspecifiedOrder:
            return "UnspecifiedOrder";
        case exports.CancellationStrategy.FromWorstToBest:
            return "FromWorstToBest";
        case exports.CancellationStrategy.FromBestToWorst:
            return "FromBestToWorst";
        case exports.CancellationStrategy.UNRECOGNIZED:
        default:
            return "UNRECOGNIZED";
    }
}
...
exports.SubaccountOrderbookMetadataWithMarket = {
    encode: function (message, writer) {
        ...
        if (message.metadata !== undefined) {
            orderbook_1.SubaccountOrderbookMetadata.encode(message.metadata, writer.uint32(10).fork()).ldelim();
        }
        if (message.marketId !== "") {
            writer.uint32(18).string(message.marketId);
        }
    ...
    decode: function (input, length) {
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                case 1:
                    message.metadata = orderbook_1.SubaccountOrderbookMetadata.decode(reader, reader.uint32());
                    break;
                case 2:
                    message.marketId = reader.string();
                    break;
    ...
    fromJSON: function (object) {
        return {
            metadata: isSet(object.metadata) ? orderbook_1.SubaccountOrderbookMetadata.fromJSON(object.metadata) : undefined,
            marketId: isSet(object.marketId) ? String(object.marketId) : "",
    ...
    toJSON: function (message) {
        ...
        message.metadata !== undefined &&
            (obj.metadata = message.metadata ? orderbook_1.SubaccountOrderbookMetadata.toJSON(message.metadata) : undefined);
        message.marketId !== undefined && (obj.marketId = message.marketId);
    ...
    fromPartial: function (object) {
        ...
        message.metadata = (object.metadata !== undefined && object.metadata !== null)
            ? orderbook_1.SubaccountOrderbookMetadata.fromPartial(object.metadata)
            : undefined;
...
exports.QueryExchangeBalancesResponse = {
    encode: function (message, writer) {
        ...
        try {
            for (var _b = __values(message.balances), _c = _b.next(); !_c.done; _c = _b.next()) {
                var v = _c.value;
                exchange_1.Balance.encode(v, writer.uint32(10).fork()).ldelim();
            }
        }
    ...
    decode: function (input, length) {
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                case 1:
                    message.balances.push(exchange_1.Balance.decode(reader, reader.uint32()));
                    break;
                default:
                    reader.skipType(tag & 7);
                    break;
    ...
    fromJSON: function (object) {
        return { balances: Array.isArray(object === null || object === void 0 ? void 0 : object.balances) ? object.balances.map(function (e) { return exchange_1.Balance.fromJSON(e); }) : [] };
    },
    toJSON: function (message) {
        var obj = {};
        if (message.balances) {
            obj.balances = message.balances.map(function (e) { return e ? exchange_1.Balance.toJSON(e) : undefined; });
        }
        else {
            obj.balances = [];
        }
    ...
    fromPartial: function (object) {
        var _a;
        var message = createBaseQueryExchangeBalancesResponse();
        message.balances = ((_a = object.balances) === null || _a === void 0 ? void 0 : _a.map(function (e) { return exchange_1.Balance.fromPartial(e); })) || [];
        return message;
    },
};
...
exports.QueryAggregateVolumeResponse = {
    encode: function (message, writer) {
        ...
        try {
            for (var _b = __values(message.aggregateVolumes), _c = _b.next(); !_c.done; _c = _b.next()) {
                var v = _c.value;
                market_1.MarketVolume.encode(v, writer.uint32(10).fork()).ldelim();
            }
        }
    ...
    decode: function (input, length) {
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                case 1:
                    message.aggregateVolumes.push(market_1.MarketVolume.decode(reader, reader.uint32()));
                    break;
                default:
                    reader.skipType(tag & 7);
                    break;
    ...
    fromJSON: function (object) {
        return {
            aggregateVolumes: Array.isArray(object === null || object === void 0 ? void 0 : object.aggregateVolumes)
                ? object.aggregateVolumes.map(function (e) { return market_1.MarketVolume.fromJSON(e); })
                : [],
        };
    },
    toJSON: function (message) {
        ...
        if (message.aggregateVolumes) {
            obj.aggregateVolumes = message.aggregateVolumes.map(function (e) { return e ? market_1.MarketVolume.toJSON(e) : undefined; });
        }
        else {
    ...
    fromPartial: function (object) {
        var _a;
        var message = createBaseQueryAggregateVolumeResponse();
        message.aggregateVolumes = ((_a = object.aggregateVolumes) === null || _a === void 0 ? void 0 : _a.map(function (e) { return market_1.MarketVolume.fromPartial(e); })) || [];
        return message;
    },
};
...
exports.QueryAggregateVolumesResponse = {
    encode: function (message, writer) {
        ...
        try {
            for (var _e = __values(message.aggregateMarketVolumes), _f = _e.next(); !_f.done; _f = _e.next()) {
                var v = _f.value;
                market_1.MarketVolume.encode(v, writer.uint32(18).fork()).ldelim();
            }
        }
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                case 1:
                    ...
                    break;
                case 2:
                    message.aggregateMarketVolumes.push(market_1.MarketVolume.decode(reader, reader.uint32()));
                    break;
                default:
                    reader.skipType(tag & 7);
                    break;
    ...
    fromJSON: function (object) {
        return {
            ...
            aggregateMarketVolumes: Array.isArray(object === null || object === void 0 ? void 0 : object.aggregateMarketVolumes)
                ? object.aggregateMarketVolumes.map(function (e) { return market_1.MarketVolume.fromJSON(e); })
                : [],
        };
    },
    toJSON: function (message) {
        ...
        if (message.aggregateMarketVolumes) {
            obj.aggregateMarketVolumes = message.aggregateMarketVolumes.map(function (e) { return e ? market_1.MarketVolume.toJSON(e) : undefined; });
        }
        else {
    ...
    fromPartial: function (object) {
        ...
        message.aggregateMarketVolumes = ((_b = object.aggregateMarketVolumes) === null || _b === void 0 ? void 0 : _b.map(function (e) { return market_1.MarketVolume.fromPartial(e); })) || [];
        return message;
    },
};
...
exports.QueryAggregateMarketVolumeResponse = {
    encode: function (message, writer) {
        ...
        if (message.volume !== undefined) {
            market_1.VolumeRecord.encode(message.volume, writer.uint32(10).fork()).ldelim();
        }
        return writer;
    },
    decode: function (input, length) {
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                case 1:
                    message.volume = market_1.VolumeRecord.decode(reader, reader.uint32());
                    break;
                default:
                    reader.skipType(tag & 7);
                    break;
    ...
    fromJSON: function (object) {
        return { volume: isSet(object.volume) ? market_1.VolumeRecord.fromJSON(object.volume) : undefined };
    },
    toJSON: function (message) {
        var obj = {};
        message.volume !== undefined && (obj.volume = message.volume ? market_1.VolumeRecord.toJSON(message.volume) : undefined);
        return obj;
    },
    create: function (base) {
    ...
    fromPartial: function (object) {
        ...
        message.volume = (object.volume !== undefined && object.volume !== null)
            ? market_1.VolumeRecord.fromPartial(object.volume)
            : undefined;
        return message;
    },
};
...
exports.QueryAggregateMarketVolumesResponse = {
    ...
    decode: function (input, length) {
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                case 1:
                    message.volumes.push(market_1.MarketVolume.decode(reader, reader.uint32()));
                    break;
                default:
                    reader.skipType(tag & 7);
                    break;
    ...
    fromJSON: function (object) {
        return { volumes: Array.isArray(object === null || object === void 0 ? void 0 : object.volumes) ? object.volumes.map(function (e) { return market_1.MarketVolume.fromJSON(e); }) : [] };
    },
    toJSON: function (message) {
        var obj = {};
        if (message.volumes) {
            obj.volumes = message.volumes.map(function (e) { return e ? market_1.MarketVolume.toJSON(e) : undefined; });
        }
        else {
            obj.volumes = [];
        }
    ...
    fromPartial: function (object) {
        var _a;
        var message = createBaseQueryAggregateMarketVolumesResponse();
        message.volumes = ((_a = object.volumes) === null || _a === void 0 ? void 0 : _a.map(function (e) { return market_1.MarketVolume.fromPartial(e); })) || [];
        return message;
    },
};
...
exports.QuerySpotMarketsResponse = {
    encode: function (message, writer) {
        ...
        try {
            for (var _b = __values(message.markets), _c = _b.next(); !_c.done; _c = _b.next()) {
                var v = _c.value;
                market_1.SpotMarket.encode(v, writer.uint32(10).fork()).ldelim();
            }
        }
    ...
    decode: function (input, length) {
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                case 1:
                    message.markets.push(market_1.SpotMarket.decode(reader, reader.uint32()));
                    break;
                default:
                    reader.skipType(tag & 7);
                    break;
    ...
    fromJSON: function (object) {
        return { markets: Array.isArray(object === null || object === void 0 ? void 0 : object.markets) ? object.markets.map(function (e) { return market_1.SpotMarket.fromJSON(e); }) : [] };
    },
    toJSON: function (message) {
        var obj = {};
        if (message.markets) {
            obj.markets = message.markets.map(function (e) { return e ? market_1.SpotMarket.toJSON(e) : undefined; });
        }
        else {
            obj.markets = [];
        }
    ...
    fromPartial: function (object) {
        var _a;
        var message = createBaseQuerySpotMarketsResponse();
        message.markets = ((_a = object.markets) === null || _a === void 0 ? void 0 : _a.map(function (e) { return market_1.SpotMarket.fromPartial(e); })) || [];
        return message;
    },
};
...
exports.FullSpotMarket = {
    ...
    fromJSON: function (object) {
        return {
            market: isSet(object.market) ? market_1.SpotMarket.fromJSON(object.market) : undefined,
...
exports.PerpetualMarketState = {
    encode: function (message, writer) {
        ...
        if (message.marketInfo !== undefined) {
            market_1.PerpetualMarketInfo.encode(message.marketInfo, writer.uint32(10).fork()).ldelim();
        }
        if (message.fundingInfo !== undefined) {
            market_1.PerpetualMarketFunding.encode(message.fundingInfo, writer.uint32(18).fork()).ldelim();
        }
        return writer;
    },
    decode: function (input, length) {
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                case 1:
                    message.marketInfo = market_1.PerpetualMarketInfo.decode(reader, reader.uint32());
                    break;
                case 2:
                    message.fundingInfo = market_1.PerpetualMarketFunding.decode(reader, reader.uint32());
                    break;
                default:
                    reader.skipType(tag & 7);
                    break;
    ...
    fromJSON: function (object) {
        return {
            marketInfo: isSet(object.marketInfo) ? market_1.PerpetualMarketInfo.fromJSON(object.marketInfo) : undefined,
            fundingInfo: isSet(object.fundingInfo) ? market_1.PerpetualMarketFunding.fromJSON(object.fundingInfo) : undefined,
        };
    },
    toJSON: function (message) {
        var obj = {};
        message.marketInfo !== undefined &&
            (obj.marketInfo = message.marketInfo ? market_1.PerpetualMarketInfo.toJSON(message.marketInfo) : undefined);
        message.fundingInfo !== undefined &&
            (obj.fundingInfo = message.fundingInfo ? market_1.PerpetualMarketFunding.toJSON(message.fundingInfo) : undefined);
        return obj;
    },
    create: function (base) {
    ...
    fromPartial: function (object) {
        ...
        message.marketInfo = (object.marketInfo !== undefined && object.marketInfo !== null)
            ? market_1.PerpetualMarketInfo.fromPartial(object.marketInfo)
            : undefined;
        message.fundingInfo = (object.fundingInfo !== undefined && object.fundingInfo !== null)
            ? market_1.PerpetualMarketFunding.fromPartial(object.fundingInfo)
            : undefined;
        return message;
    },
};
...
exports.FullDerivativeMarket = {
    encode: function (message, writer) {
        ...
        if (message.futuresInfo !== undefined) {
            market_1.ExpiryFuturesMarketInfo.encode(message.futuresInfo, writer.uint32(26).fork()).ldelim();
        }
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                ...
                case 2:
                    ...
                    break;
                case 3:
                    message.futuresInfo = market_1.ExpiryFuturesMarketInfo.decode(reader, reader.uint32());
                    break;
                case 4:
    ...
    fromJSON: function (object) {
        return {
            ...
            futuresInfo: isSet(object.futuresInfo) ? market_1.ExpiryFuturesMarketInfo.fromJSON(object.futuresInfo) : undefined,
    ...
    toJSON: function (message) {
        ...
        message.futuresInfo !== undefined &&
            (obj.futuresInfo = message.futuresInfo ? market_1.ExpiryFuturesMarketInfo.toJSON(message.futuresInfo) : undefined);
    ...
    fromPartial: function (object) {
        ...
        message.futuresInfo = (object.futuresInfo !== undefined && object.futuresInfo !== null)
            ? market_1.ExpiryFuturesMarketInfo.fromPartial(object.futuresInfo)
            : undefined;
...
function createBaseQueryPositionsInMarketRequest() {
    return { marketId: "" };
}
exports.QueryPositionsInMarketRequest = {
    encode: function (message, writer) {
        if (writer === void 0) { writer = minimal_js_1.default.Writer.create(); }
        if (message.marketId !== "") {
            writer.uint32(10).string(message.marketId);
    ...
    decode: function (input, length) {
        var reader = input instanceof minimal_js_1.default.Reader ? input : new minimal_js_1.default.Reader(input);
        var end = length === undefined ? reader.len : reader.pos + length;
        var message = createBaseQueryPositionsInMarketRequest();
        while (reader.pos < end) {
            var tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
    ...
    create: function (base) {
        return exports.QueryPositionsInMarketRequest.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial: function (object) {
        var _a;
        var message = createBaseQueryPositionsInMarketRequest();
...
function createBaseQueryPositionsInMarketResponse() {
    return { state: [] };
}
exports.QueryPositionsInMarketResponse = {
    encode: function (message, writer) {
        var e_31, _a;
        if (writer === void 0) { writer = minimal_js_1.default.Writer.create(); }
        try {
            for (var _b = __values(message.state), _c = _b.next(); !_c.done; _c = _b.next()) {
                var v = _c.value;
                exchange_1.DerivativePosition.encode(v, writer.uint32(10).fork()).ldelim();
            }
        }
    ...
    decode: function (input, length) {
        var reader = input instanceof minimal_js_1.default.Reader ? input : new minimal_js_1.default.Reader(input);
        var end = length === undefined ? reader.len : reader.pos + length;
        var message = createBaseQueryPositionsInMarketResponse();
        while (reader.pos < end) {
            var tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
                    message.state.push(exchange_1.DerivativePosition.decode(reader, reader.uint32()));
                    break;
                default:
                    reader.skipType(tag & 7);
                    break;
    ...
    fromJSON: function (object) {
        return { state: Array.isArray(object === null || object === void 0 ? void 0 : object.state) ? object.state.map(function (e) { return exchange_1.DerivativePosition.fromJSON(e); }) : [] };
    },
    toJSON: function (message) {
        var obj = {};
        if (message.state) {
            obj.state = message.state.map(function (e) { return e ? exchange_1.DerivativePosition.toJSON(e) : undefined; });
        }
        else {
            obj.state = [];
        }
    ...
    create: function (base) {
        return exports.QueryPositionsInMarketResponse.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial: function (object) {
        var _a;
        var message = createBaseQueryPositionsInMarketResponse();
        message.state = ((_a = object.state) === null || _a === void 0 ? void 0 : _a.map(function (e) { return exchange_1.DerivativePosition.fromPartial(e); })) || [];
        return message;
    },
};
...
exports.QueryPerpetualMarketInfoResponse = {
    encode: function (message, writer) {
        ...
        if (message.info !== undefined) {
            market_1.PerpetualMarketInfo.encode(message.info, writer.uint32(10).fork()).ldelim();
        }
        return writer;
    },
    decode: function (input, length) {
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                case 1:
                    message.info = market_1.PerpetualMarketInfo.decode(reader, reader.uint32());
                    break;
                default:
                    reader.skipType(tag & 7);
                    break;
    ...
    fromJSON: function (object) {
        return { info: isSet(object.info) ? market_1.PerpetualMarketInfo.fromJSON(object.info) : undefined };
    },
    toJSON: function (message) {
        var obj = {};
        message.info !== undefined && (obj.info = message.info ? market_1.PerpetualMarketInfo.toJSON(message.info) : undefined);
        return obj;
    },
    create: function (base) {
    ...
    fromPartial: function (object) {
        ...
        message.info = (object.info !== undefined && object.info !== null)
            ? market_1.PerpetualMarketInfo.fromPartial(object.info)
            : undefined;
        return message;
    },
};
...
exports.QueryExpiryFuturesMarketInfoResponse = {
    encode: function (message, writer) {
        if (writer === void 0) { writer = minimal_js_1.default.Writer.create(); }
        if (message.info !== undefined) {
            market_1.ExpiryFuturesMarketInfo.encode(message.info, writer.uint32(10).fork()).ldelim();
        }
        return writer;
    },
    decode: function (input, length) {
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                case 1:
                    message.info = market_1.ExpiryFuturesMarketInfo.decode(reader, reader.uint32());
                    break;
                default:
                    reader.skipType(tag & 7);
                    break;
    ...
    fromJSON: function (object) {
        return { info: isSet(object.info) ? market_1.ExpiryFuturesMarketInfo.fromJSON(object.info) : undefined };
    },
    toJSON: function (message) {
        var obj = {};
        message.info !== undefined && (obj.info = message.info ? market_1.ExpiryFuturesMarketInfo.toJSON(message.info) : undefined);
        return obj;
    },
    create: function (base) {
    ...
    fromPartial: function (object) {
        var message = createBaseQueryExpiryFuturesMarketInfoResponse();
        message.info = (object.info !== undefined && object.info !== null)
            ? market_1.ExpiryFuturesMarketInfo.fromPartial(object.info)
            : undefined;
        return message;
    },
};
...
exports.QueryPerpetualMarketFundingResponse = {
    encode: function (message, writer) {
        if (writer === void 0) { writer = minimal_js_1.default.Writer.create(); }
        if (message.state !== undefined) {
            market_1.PerpetualMarketFunding.encode(message.state, writer.uint32(10).fork()).ldelim();
        }
        return writer;
    },
    decode: function (input, length) {
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                case 1:
                    message.state = market_1.PerpetualMarketFunding.decode(reader, reader.uint32());
                    break;
                default:
                    reader.skipType(tag & 7);
                    break;
    ...
    fromJSON: function (object) {
        return { state: isSet(object.state) ? market_1.PerpetualMarketFunding.fromJSON(object.state) : undefined };
    },
    toJSON: function (message) {
        var obj = {};
        message.state !== undefined &&
            (obj.state = message.state ? market_1.PerpetualMarketFunding.toJSON(message.state) : undefined);
        return obj;
    },
    create: function (base) {
    ...
    fromPartial: function (object) {
        var message = createBaseQueryPerpetualMarketFundingResponse();
        message.state = (object.state !== undefined && object.state !== null)
            ? market_1.PerpetualMarketFunding.fromPartial(object.state)
            : undefined;
        return message;
    },
};
...
exports.MitoVaultInfosResponse = {
    encode: function (message, writer) {
        var e_44, _a, e_45, _b, e_46, _c, e_47, _d;
        if (writer === void 0) { writer = minimal_js_1.default.Writer.create(); }
        try {
...
exports.QueryBinaryMarketsResponse = {
    encode: function (message, writer) {
        ...
        try {
            for (var _b = __values(message.markets), _c = _b.next(); !_c.done; _c = _b.next()) {
                var v = _c.value;
                market_1.BinaryOptionsMarket.encode(v, writer.uint32(10).fork()).ldelim();
            }
        }
    ...
    decode: function (input, length) {
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                case 1:
                    message.markets.push(market_1.BinaryOptionsMarket.decode(reader, reader.uint32()));
                    break;
                default:
                    reader.skipType(tag & 7);
                    break;
    ...
    fromJSON: function (object) {
        return {
            markets: Array.isArray(object === null || object === void 0 ? void 0 : object.markets) ? object.markets.map(function (e) { return market_1.BinaryOptionsMarket.fromJSON(e); }) : [],
        };
    },
    toJSON: function (message) {
        var obj = {};
        if (message.markets) {
            obj.markets = message.markets.map(function (e) { return e ? market_1.BinaryOptionsMarket.toJSON(e) : undefined; });
        }
        else {
            obj.markets = [];
        }
    ...
    fromPartial: function (object) {
        var _a;
        var message = createBaseQueryBinaryMarketsResponse();
        message.markets = ((_a = object.markets) === null || _a === void 0 ? void 0 : _a.map(function (e) { return market_1.BinaryOptionsMarket.fromPartial(e); })) || [];
        return message;
    },
};
...
exports.QueryMarketBalanceResponse = {
    encode: function (message, writer) {
        ...
        if (message.balance !== undefined) {
            exports.MarketBalance.encode(message.balance, writer.uint32(10).fork()).ldelim();
        }
        return writer;
    },
    decode: function (input, length) {
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                case 1:
                    message.balance = exports.MarketBalance.decode(reader, reader.uint32());
                    break;
                default:
                    reader.skipType(tag & 7);
                    break;
    ...
    fromJSON: function (object) {
        return { balance: isSet(object.balance) ? exports.MarketBalance.fromJSON(object.balance) : undefined };
    },
    toJSON: function (message) {
        var obj = {};
        message.balance !== undefined &&
            (obj.balance = message.balance ? exports.MarketBalance.toJSON(message.balance) : undefined);
        return obj;
    },
    create: function (base) {
    ...
    fromPartial: function (object) {
        ...
        message.balance = (object.balance !== undefined && object.balance !== null)
            ? exports.MarketBalance.fromPartial(object.balance)
            : undefined;
        return message;
    },
};
...
var QueryClientImpl = /** @class */ (function () {
    function QueryClientImpl(rpc) {
        ...
        this.PositionsInMarket = this.PositionsInMarket.bind(this);
    ...
    QueryClientImpl.prototype.PositionsInMarket = function (request, metadata) {
        return this.rpc.unary(exports.QueryPositionsInMarketDesc, exports.QueryPositionsInMarketRequest.fromPartial(request), metadata);
    };
...
exports.QueryDesc = { serviceName: "injective.exchange.v2.Query" };
...
exports.QueryPositionsInMarketDesc = {
    ...
    requestType: {
        serializeBinary: function () {
            return exports.QueryPositionsInMarketRequest.encode(this).finish();
        },
    },
    responseType: {
        deserializeBinary: function (data) {
            var value = exports.QueryPositionsInMarketResponse.decode(data);
            return __assign(__assign({}, value), { toObject: function () {
                    return value;
                } });
        },
