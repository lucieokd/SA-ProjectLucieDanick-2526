...
function marketStatusFromJSON(object) {
    switch (object) {
        case 0:
        case "Unspecified":
            return exports.MarketStatus.Unspecified;
        case 1:
        case "Active":
            return exports.MarketStatus.Active;
        case 2:
        case "Paused":
            return exports.MarketStatus.Paused;
        case 3:
        case "Demolished":
            return exports.MarketStatus.Demolished;
        case 4:
        case "Expired":
            return exports.MarketStatus.Expired;
        case -1:
        case "UNRECOGNIZED":
        default:
            return exports.MarketStatus.UNRECOGNIZED;
    }
}
function marketStatusToJSON(object) {
    switch (object) {
        case exports.MarketStatus.Unspecified:
            return "Unspecified";
        case exports.MarketStatus.Active:
            return "Active";
        case exports.MarketStatus.Paused:
            return "Paused";
        case exports.MarketStatus.Demolished:
            return "Demolished";
        case exports.MarketStatus.Expired:
            return "Expired";
        case exports.MarketStatus.UNRECOGNIZED:
        default:
            return "UNRECOGNIZED";
    }
}
...
function executionTypeFromJSON(object) {
    switch (object) {
        ...
        case "UnspecifiedExecutionType":
            return exports.ExecutionType.UnspecifiedExecutionType;
        case 1:
        case "Market":
            return exports.ExecutionType.Market;
        case 2:
        case "LimitFill":
            return exports.ExecutionType.LimitFill;
        case 3:
        case "LimitMatchRestingOrder":
            return exports.ExecutionType.LimitMatchRestingOrder;
        case 4:
        case "LimitMatchNewOrder":
            return exports.ExecutionType.LimitMatchNewOrder;
        case 5:
        case "MarketLiquidation":
            return exports.ExecutionType.MarketLiquidation;
        case 6:
        case "ExpiryMarketSettlement":
            return exports.ExecutionType.ExpiryMarketSettlement;
        case -1:
        case "UNRECOGNIZED":
        default:
            return exports.ExecutionType.UNRECOGNIZED;
    }
}
function executionTypeToJSON(object) {
    switch (object) {
        case exports.ExecutionType.UnspecifiedExecutionType:
            return "UnspecifiedExecutionType";
        case exports.ExecutionType.Market:
            return "Market";
        case exports.ExecutionType.LimitFill:
            return "LimitFill";
        case exports.ExecutionType.LimitMatchRestingOrder:
            return "LimitMatchRestingOrder";
        case exports.ExecutionType.LimitMatchNewOrder:
            return "LimitMatchNewOrder";
        case exports.ExecutionType.MarketLiquidation:
            return "MarketLiquidation";
        case exports.ExecutionType.ExpiryMarketSettlement:
            return "ExpiryMarketSettlement";
        case exports.ExecutionType.UNRECOGNIZED:
        default:
            return "UNRECOGNIZED";
    }
}
...
exports.Params = {
    ...
    fromJSON: function (object) {
        return {
            ...
            fixedGasEnabled: isSet(object.fixedGasEnabled) ? Boolean(object.fixedGasEnabled) : false,
        };
    },
    toJSON: function (message) {
        ...
        message.fixedGasEnabled !== undefined && (obj.fixedGasEnabled = message.fixedGasEnabled);
        return obj;
    },
    ...
    fromPartial: function (object) {
        ...
        message.fixedGasEnabled = (_1 = object.fixedGasEnabled) !== null && _1 !== void 0 ? _1 : false;
        return message;
    },
};
...
exports.DerivativeMarket = {
    ...
    fromPartial: function (object) {
        ...
        message.reduceMarginRatio = (_w = object.reduceMarginRatio) !== null && _w !== void 0 ? _w : "";
        return message;
    },
};
