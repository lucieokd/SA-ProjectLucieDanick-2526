...
function createBaseParams() {
    return { auctionPeriod: "0", minNextBidIncrementRate: "", injBasketMaxCap: "", biddersWhitelist: [] };
}
exports.Params = {
    encode: function (message, writer) {
        ...
        try {
            for (var _b = __values(message.biddersWhitelist), _c = _b.next(); !_c.done; _c = _b.next()) {
                var v = _c.value;
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                ...
                case 3:
                    ...
                    break;
                case 4:
                    message.biddersWhitelist.push(reader.string());
                    break;
                default:
    ...
    fromJSON: function (object) {
        return {
            ...
            biddersWhitelist: Array.isArray(object === null || object === void 0 ? void 0 : object.biddersWhitelist)
                ? object.biddersWhitelist.map(function (e) { return String(e); })
                : [],
        };
    },
    toJSON: function (message) {
        ...
        if (message.biddersWhitelist) {
            obj.biddersWhitelist = message.biddersWhitelist.map(function (e) { return e; });
        }
        else {
            obj.biddersWhitelist = [];
        }
        return obj;
    },
    ...
    fromPartial: function (object) {
        ...
        message.biddersWhitelist = ((_d = object.biddersWhitelist) === null || _d === void 0 ? void 0 : _d.map(function (e) { return e; })) || [];
        return message;
    },
};
