...
exports.QueryAuctionParamsRequest = {
    ...
    decode: function (input, length) {
        ...
        var message = createBaseQueryAuctionParamsRequest();
...
exports.QueryAuctionParamsResponse = {
    ...
    decode: function (input, length) {
        var reader = input instanceof minimal_js_1.default.Reader ? input : new minimal_js_1.default.Reader(input);
        var end = length === undefined ? reader.len : reader.pos + length;
        var message = createBaseQueryAuctionParamsResponse();
        while (reader.pos < end) {
            var tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
...
exports.QueryCurrentAuctionBasketRequest = {
    ...
    decode: function (input, length) {
        var reader = input instanceof minimal_js_1.default.Reader ? input : new minimal_js_1.default.Reader(input);
        var end = length === undefined ? reader.len : reader.pos + length;
        var message = createBaseQueryCurrentAuctionBasketRequest();
        while (reader.pos < end) {
            var tag = reader.uint32();
            switch (tag >>> 3) {
                default:
...
exports.QueryCurrentAuctionBasketResponse = {
    encode: function (message, writer) {
        ...
        if (message.auctionClosingTime !== "0") {
            writer.uint32(24).uint64(message.auctionClosingTime);
        }
    ...
    decode: function (input, length) {
        var reader = input instanceof minimal_js_1.default.Reader ? input : new minimal_js_1.default.Reader(input);
        var end = length === undefined ? reader.len : reader.pos + length;
        var message = createBaseQueryCurrentAuctionBasketResponse();
        while (reader.pos < end) {
            var tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
                ...
                case 2:
                    ...
                    break;
                case 3:
                    message.auctionClosingTime = longToString(reader.uint64());
                    break;
                case 4:
...
exports.QueryLastAuctionResultRequest = {
    ...
    decode: function (input, length) {
        var reader = input instanceof minimal_js_1.default.Reader ? input : new minimal_js_1.default.Reader(input);
        var end = length === undefined ? reader.len : reader.pos + length;
        var message = createBaseQueryLastAuctionResultRequest();
        while (reader.pos < end) {
            var tag = reader.uint32();
            switch (tag >>> 3) {
                default:
...
exports.QueryLastAuctionResultResponse = {
    ...
    decode: function (input, length) {
        var reader = input instanceof minimal_js_1.default.Reader ? input : new minimal_js_1.default.Reader(input);
        var end = length === undefined ? reader.len : reader.pos + length;
        var message = createBaseQueryLastAuctionResultResponse();
        while (reader.pos < end) {
            var tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
...
var QueryClientImpl = /** @class */ (function () {
    ...
    QueryClientImpl.prototype.AuctionParams = function (request, metadata) {
        return this.rpc.unary(exports.QueryAuctionParamsDesc, exports.QueryAuctionParamsRequest.fromPartial(request), metadata);
    };
    QueryClientImpl.prototype.CurrentAuctionBasket = function (request, metadata) {
    ...
    QueryClientImpl.prototype.AuctionModuleState = function (request, metadata) {
        return this.rpc.unary(exports.QueryAuctionModuleStateDesc, exports.QueryModuleStateRequest.fromPartial(request), metadata);
    };
    QueryClientImpl.prototype.LastAuctionResult = function (request, metadata) {
...
exports.QueryAuctionParamsDesc = {
    ...
    responseType: {
        deserializeBinary: function (data) {
            var value = exports.QueryAuctionParamsResponse.decode(data);
...
exports.QueryCurrentAuctionBasketDesc = {
    ...
    responseType: {
        deserializeBinary: function (data) {
            var value = exports.QueryCurrentAuctionBasketResponse.decode(data);
            return __assign(__assign({}, value), { toObject: function () {
                    return value;
                } });
        },
...
exports.QueryLastAuctionResultDesc = {
    ...
    responseType: {
        deserializeBinary: function (data) {
            var value = exports.QueryLastAuctionResultResponse.decode(data);
            return __assign(__assign({}, value), { toObject: function () {
                    return value;
                } });
        },
