...
var exchange_1 = require("../../exchange/v2/exchange.js");
var order_1 = require("../../exchange/v2/order.js");
exports.protobufPackage = "injective.stream.v2";
exports.OrderUpdateStatus = { Unspecified: 0, Booked: 1, Matched: 2, Cancelled: 3, UNRECOGNIZED: -1 };
function orderUpdateStatusFromJSON(object) {
    switch (object) {
        case 0:
        case "Unspecified":
            return exports.OrderUpdateStatus.Unspecified;
        case 1:
        case "Booked":
            return exports.OrderUpdateStatus.Booked;
        case 2:
        case "Matched":
            return exports.OrderUpdateStatus.Matched;
        case 3:
        case "Cancelled":
            return exports.OrderUpdateStatus.Cancelled;
        case -1:
        case "UNRECOGNIZED":
        default:
            return exports.OrderUpdateStatus.UNRECOGNIZED;
    }
}
function orderUpdateStatusToJSON(object) {
    switch (object) {
        case exports.OrderUpdateStatus.Unspecified:
            return "Unspecified";
        case exports.OrderUpdateStatus.Booked:
            return "Booked";
        case exports.OrderUpdateStatus.Matched:
            return "Matched";
        case exports.OrderUpdateStatus.Cancelled:
            return "Cancelled";
        case exports.OrderUpdateStatus.UNRECOGNIZED:
        default:
            return "UNRECOGNIZED";
    }
}
...
exports.StreamResponse = {
    encode: function (message, writer) {
        ...
        if (message.gasPrice !== "") {
            writer.uint32(106).string(message.gasPrice);
        }
        return writer;
    },
    decode: function (input, length) {
    ...
    fromPartial: function (object) {
        ...
        message.gasPrice = (_o = object.gasPrice) !== null && _o !== void 0 ? _o : "";
        return message;
    },
};
...
exports.DerivativeOrder = {
    encode: function (message, writer) {
        ...
        if (message.order !== undefined) {
            order_1.DerivativeLimitOrder.encode(message.order, writer.uint32(18).fork()).ldelim();
        }
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                case 1:
                    ...
                    break;
                case 2:
                    message.order = order_1.DerivativeLimitOrder.decode(reader, reader.uint32());
                    break;
                case 3:
    ...
    fromJSON: function (object) {
        return {
            marketId: isSet(object.marketId) ? String(object.marketId) : "",
            order: isSet(object.order) ? order_1.DerivativeLimitOrder.fromJSON(object.order) : undefined,
    ...
    toJSON: function (message) {
        var obj = {};
        message.marketId !== undefined && (obj.marketId = message.marketId);
        message.order !== undefined && (obj.order = message.order ? order_1.DerivativeLimitOrder.toJSON(message.order) : undefined);
    ...
    fromPartial: function (object) {
        ...
        message.marketId = (_a = object.marketId) !== null && _a !== void 0 ? _a : "";
        message.order = (object.order !== undefined && object.order !== null)
            ? order_1.DerivativeLimitOrder.fromPartial(object.order)
            : undefined;
...
var StreamClientImpl = /** @class */ (function () {
    function StreamClientImpl(rpc) {
        this.rpc = rpc;
        this.StreamV2 = this.StreamV2.bind(this);
    }
    StreamClientImpl.prototype.StreamV2 = function (request, metadata) {
        return this.rpc.invoke(exports.StreamStreamV2Desc, exports.StreamRequest.fromPartial(request), metadata);
    };
    return StreamClientImpl;
}());
exports.StreamClientImpl = StreamClientImpl;
exports.StreamDesc = { serviceName: "injective.stream.v2.Stream" };
exports.StreamStreamV2Desc = {
    methodName: "StreamV2",
