...
function actionFromJSON(object) {
    switch (object) {
        case 0:
        case "UNSPECIFIED":
            return exports.Action.UNSPECIFIED;
        case 1:
        case "MINT":
            return exports.Action.MINT;
        case 2:
        case "RECEIVE":
            return exports.Action.RECEIVE;
        case 4:
        case "BURN":
            return exports.Action.BURN;
        case 8:
        case "SEND":
            return exports.Action.SEND;
        case 16:
        case "SUPER_BURN":
            return exports.Action.SUPER_BURN;
        case 134217728:
        case "MODIFY_POLICY_MANAGERS":
            return exports.Action.MODIFY_POLICY_MANAGERS;
        case 268435456:
        case "MODIFY_CONTRACT_HOOK":
            return exports.Action.MODIFY_CONTRACT_HOOK;
        case 536870912:
        case "MODIFY_ROLE_PERMISSIONS":
            return exports.Action.MODIFY_ROLE_PERMISSIONS;
        case 1073741824:
        case "MODIFY_ROLE_MANAGERS":
            return exports.Action.MODIFY_ROLE_MANAGERS;
        case -1:
        case "UNRECOGNIZED":
        default:
            return exports.Action.UNRECOGNIZED;
    }
}
function actionToJSON(object) {
    switch (object) {
        case exports.Action.UNSPECIFIED:
            return "UNSPECIFIED";
        case exports.Action.MINT:
            return "MINT";
        case exports.Action.RECEIVE:
            return "RECEIVE";
        case exports.Action.BURN:
            return "BURN";
        case exports.Action.SEND:
            return "SEND";
        case exports.Action.SUPER_BURN:
            return "SUPER_BURN";
        case exports.Action.MODIFY_POLICY_MANAGERS:
            return "MODIFY_POLICY_MANAGERS";
        case exports.Action.MODIFY_CONTRACT_HOOK:
            return "MODIFY_CONTRACT_HOOK";
        case exports.Action.MODIFY_ROLE_PERMISSIONS:
            return "MODIFY_ROLE_PERMISSIONS";
        case exports.Action.MODIFY_ROLE_MANAGERS:
            return "MODIFY_ROLE_MANAGERS";
        case exports.Action.UNRECOGNIZED:
        default:
            return "UNRECOGNIZED";
    }
}
