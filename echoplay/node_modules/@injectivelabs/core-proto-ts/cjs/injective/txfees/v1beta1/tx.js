...
var txfees_1 = require("./txfees.js");
...
exports.MsgUpdateParams = {
    encode: function (message, writer) {
        ...
        if (message.params !== undefined) {
            txfees_1.Params.encode(message.params, writer.uint32(18).fork()).ldelim();
        }
        return writer;
    },
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                case 1:
                    ...
                    break;
                case 2:
                    message.params = txfees_1.Params.decode(reader, reader.uint32());
                    break;
                default:
    ...
    fromJSON: function (object) {
        return {
            ...
            params: isSet(object.params) ? txfees_1.Params.fromJSON(object.params) : undefined,
        };
    },
    toJSON: function (message) {
        var obj = {};
        message.authority !== undefined && (obj.authority = message.authority);
        message.params !== undefined && (obj.params = message.params ? txfees_1.Params.toJSON(message.params) : undefined);
        return obj;
    },
    ...
    fromPartial: function (object) {
        ...
        message.params = (object.params !== undefined && object.params !== null)
            ? txfees_1.Params.fromPartial(object.params)
            : undefined;
        return message;
    },
};
...
exports.MsgDesc = { serviceName: "injective.txfees.v1beta1.Msg" };
