...
export interface MsgSetDenomMetadata {
    ...
    adminBurnDisabled: MsgSetDenomMetadata_AdminBurnDisabled | undefined;
}
...
export declare const MsgSetDenomMetadata_AdminBurnDisabled: {
    encode(message: MsgSetDenomMetadata_AdminBurnDisabled, writer?: _m0.Writer): _m0.Writer;
    decode(input: _m0.Reader | Uint8Array, length?: number): MsgSetDenomMetadata_AdminBurnDisabled;
    fromJSON(object: any): MsgSetDenomMetadata_AdminBurnDisabled;
    toJSON(message: MsgSetDenomMetadata_AdminBurnDisabled): unknown;
    create(base?: DeepPartial<MsgSetDenomMetadata_AdminBurnDisabled>): MsgSetDenomMetadata_AdminBurnDisabled;
