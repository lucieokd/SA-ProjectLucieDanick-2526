...
var types_1 = require("../version/types.js");
...
function signedMsgTypeFromJSON(object) {
    switch (object) {
        ...
        case "SIGNED_MSG_TYPE_UNKNOWN":
            return exports.SignedMsgType.SIGNED_MSG_TYPE_UNKNOWN;
        case 1:
        case "SIGNED_MSG_TYPE_PREVOTE":
            return exports.SignedMsgType.SIGNED_MSG_TYPE_PREVOTE;
        case 2:
        case "SIGNED_MSG_TYPE_PRECOMMIT":
            return exports.SignedMsgType.SIGNED_MSG_TYPE_PRECOMMIT;
        case 32:
        case "SIGNED_MSG_TYPE_PROPOSAL":
            return exports.SignedMsgType.SIGNED_MSG_TYPE_PROPOSAL;
        case -1:
        case "UNRECOGNIZED":
        default:
            return exports.SignedMsgType.UNRECOGNIZED;
    }
}
function signedMsgTypeToJSON(object) {
    switch (object) {
        case exports.SignedMsgType.SIGNED_MSG_TYPE_UNKNOWN:
            return "SIGNED_MSG_TYPE_UNKNOWN";
        case exports.SignedMsgType.SIGNED_MSG_TYPE_PREVOTE:
            return "SIGNED_MSG_TYPE_PREVOTE";
        case exports.SignedMsgType.SIGNED_MSG_TYPE_PRECOMMIT:
            return "SIGNED_MSG_TYPE_PRECOMMIT";
        case exports.SignedMsgType.SIGNED_MSG_TYPE_PROPOSAL:
            return "SIGNED_MSG_TYPE_PROPOSAL";
        case exports.SignedMsgType.UNRECOGNIZED:
        default:
            return "UNRECOGNIZED";
    }
}
...
exports.Vote = {
    ...
    fromPartial: function (object) {
        ...
        message.extension = (_h = object.extension) !== null && _h !== void 0 ? _h : new Uint8Array();
        message.extensionSignature = (_j = object.extensionSignature) !== null && _j !== void 0 ? _j : new Uint8Array();
        return message;
    },
};
...
exports.ExtendedCommit = {
    encode: function (message, writer) {
        ...
        try {
            for (var _b = __values(message.extendedSignatures), _c = _b.next(); !_c.done; _c = _b.next()) {
                var v = _c.value;
    ...
    fromJSON: function (object) {
        return {
            ...
            extendedSignatures: Array.isArray(object === null || object === void 0 ? void 0 : object.extendedSignatures)
                ? object.extendedSignatures.map(function (e) { return exports.ExtendedCommitSig.fromJSON(e); })
                : [],
        };
    },
    toJSON: function (message) {
        ...
        if (message.extendedSignatures) {
            obj.extendedSignatures = message.extendedSignatures.map(function (e) { return e ? exports.ExtendedCommitSig.toJSON(e) : undefined; });
        }
        else {
    ...
    fromPartial: function (object) {
        ...
        message.blockId = (object.blockId !== undefined && object.blockId !== null)
            ? exports.BlockID.fromPartial(object.blockId)
            : undefined;
        message.extendedSignatures = ((_c = object.extendedSignatures) === null || _c === void 0 ? void 0 : _c.map(function (e) { return exports.ExtendedCommitSig.fromPartial(e); })) || [];
        return message;
    },
};
