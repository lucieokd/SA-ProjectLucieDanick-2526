...
var types_2 = require("../types/types.js");
var validator_1 = require("../types/validator.js");
var types_3 = require("../version/types.js");
...
exports.ABCIResponsesInfo = {
    encode: function (message, writer) {
        ...
        if (message.responseFinalizeBlock !== undefined) {
            types_1.ResponseFinalizeBlock.encode(message.responseFinalizeBlock, writer.uint32(26).fork()).ldelim();
        }
        return writer;
    },
    decode: function (input, length) {
