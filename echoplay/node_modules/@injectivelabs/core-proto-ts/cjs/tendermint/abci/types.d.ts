...
export declare const MisbehaviorType: {
    readonly UNKNOWN: 0;
    readonly DUPLICATE_VOTE: 1;
    readonly LIGHT_CLIENT_ATTACK: 2;
    readonly UNRECOGNIZED: -1;
};
...
export declare const ResponseOfferSnapshot_Result: {
    ...
    readonly REJECT_FORMAT: 4;
    /** REJECT_SENDER - Reject all snapshots from the sender(s), try others */
    readonly REJECT_SENDER: 5;
    readonly UNRECOGNIZED: -1;
};
export type ResponseOfferSnapshot_Result = typeof ResponseOfferSnapshot_Result[keyof typeof ResponseOfferSnapshot_Result];
...
export declare const ResponseApplySnapshotChunk_Result: {
    /** UNKNOWN - Unknown result, abort all snapshot restoration */
    readonly UNKNOWN: 0;
    ...
    readonly RETRY_SNAPSHOT: 4;
    /** REJECT_SNAPSHOT - Reject this snapshot, try others */
    readonly REJECT_SNAPSHOT: 5;
    readonly UNRECOGNIZED: -1;
};
export type ResponseApplySnapshotChunk_Result = typeof ResponseApplySnapshotChunk_Result[keyof typeof ResponseApplySnapshotChunk_Result];
...
export declare const ResponseProcessProposal_ProposalStatus: {
    readonly UNKNOWN: 0;
    readonly ACCEPT: 1;
    readonly REJECT: 2;
    readonly UNRECOGNIZED: -1;
};
export type ResponseProcessProposal_ProposalStatus = typeof ResponseProcessProposal_ProposalStatus[keyof typeof ResponseProcessProposal_ProposalStatus];
...
export declare const ResponseVerifyVoteExtension_VerifyStatus: {
    readonly UNKNOWN: 0;
    readonly ACCEPT: 1;
    /**
...
export type ResponseVerifyVoteExtension_VerifyStatus = typeof ResponseVerifyVoteExtension_VerifyStatus[keyof typeof ResponseVerifyVoteExtension_VerifyStatus];
