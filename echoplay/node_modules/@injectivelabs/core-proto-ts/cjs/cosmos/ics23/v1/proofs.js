...
function hashOpFromJSON(object) {
    switch (object) {
        case 0:
        case "NO_HASH":
            return exports.HashOp.NO_HASH;
        case 1:
        case "SHA256":
            return exports.HashOp.SHA256;
        case 2:
        case "SHA512":
            return exports.HashOp.SHA512;
        case 3:
        case "KECCAK256":
            return exports.HashOp.KECCAK256;
        case 4:
        case "RIPEMD160":
            return exports.HashOp.RIPEMD160;
        case 5:
        case "BITCOIN":
            return exports.HashOp.BITCOIN;
        case 6:
        case "SHA512_256":
            return exports.HashOp.SHA512_256;
        case 7:
        case "BLAKE2B_512":
            return exports.HashOp.BLAKE2B_512;
        case 8:
        case "BLAKE2S_256":
            return exports.HashOp.BLAKE2S_256;
        case 9:
        case "BLAKE3":
            return exports.HashOp.BLAKE3;
        case -1:
        case "UNRECOGNIZED":
        default:
            return exports.HashOp.UNRECOGNIZED;
    }
}
function hashOpToJSON(object) {
    switch (object) {
        case exports.HashOp.NO_HASH:
            return "NO_HASH";
        case exports.HashOp.SHA256:
            return "SHA256";
        case exports.HashOp.SHA512:
            return "SHA512";
        case exports.HashOp.KECCAK256:
            return "KECCAK256";
        case exports.HashOp.RIPEMD160:
            return "RIPEMD160";
        case exports.HashOp.BITCOIN:
            return "BITCOIN";
        case exports.HashOp.SHA512_256:
            return "SHA512_256";
        case exports.HashOp.BLAKE2B_512:
            return "BLAKE2B_512";
        case exports.HashOp.BLAKE2S_256:
            return "BLAKE2S_256";
        case exports.HashOp.BLAKE3:
            return "BLAKE3";
        case exports.HashOp.UNRECOGNIZED:
        default:
            return "UNRECOGNIZED";
    }
}
...
function lengthOpFromJSON(object) {
    switch (object) {
        case 0:
        case "NO_PREFIX":
            return exports.LengthOp.NO_PREFIX;
        case 1:
        case "VAR_PROTO":
            return exports.LengthOp.VAR_PROTO;
        case 2:
        case "VAR_RLP":
            return exports.LengthOp.VAR_RLP;
        case 3:
        case "FIXED32_BIG":
            return exports.LengthOp.FIXED32_BIG;
        case 4:
        case "FIXED32_LITTLE":
            return exports.LengthOp.FIXED32_LITTLE;
        case 5:
        case "FIXED64_BIG":
            return exports.LengthOp.FIXED64_BIG;
        case 6:
        case "FIXED64_LITTLE":
            return exports.LengthOp.FIXED64_LITTLE;
        case 7:
        case "REQUIRE_32_BYTES":
            return exports.LengthOp.REQUIRE_32_BYTES;
        case 8:
        case "REQUIRE_64_BYTES":
            return exports.LengthOp.REQUIRE_64_BYTES;
        case -1:
        case "UNRECOGNIZED":
        default:
            return exports.LengthOp.UNRECOGNIZED;
    }
}
function lengthOpToJSON(object) {
    switch (object) {
        case exports.LengthOp.NO_PREFIX:
            return "NO_PREFIX";
        case exports.LengthOp.VAR_PROTO:
            return "VAR_PROTO";
        case exports.LengthOp.VAR_RLP:
            return "VAR_RLP";
        case exports.LengthOp.FIXED32_BIG:
            return "FIXED32_BIG";
        case exports.LengthOp.FIXED32_LITTLE:
            return "FIXED32_LITTLE";
        case exports.LengthOp.FIXED64_BIG:
            return "FIXED64_BIG";
        case exports.LengthOp.FIXED64_LITTLE:
            return "FIXED64_LITTLE";
        case exports.LengthOp.REQUIRE_32_BYTES:
            return "REQUIRE_32_BYTES";
        case exports.LengthOp.REQUIRE_64_BYTES:
            return "REQUIRE_64_BYTES";
        case exports.LengthOp.UNRECOGNIZED:
        default:
            return "UNRECOGNIZED";
    }
}
...
exports.ExistenceProof = {
    ...
    fromJSON: function (object) {
        return {
            ...
            path: Array.isArray(object === null || object === void 0 ? void 0 : object.path) ? object.path.map(function (e) { return exports.InnerOp.fromJSON(e); }) : [],
        };
    },
    toJSON: function (message) {
        ...
        if (message.path) {
            obj.path = message.path.map(function (e) { return e ? exports.InnerOp.toJSON(e) : undefined; });
        }
        else {
            obj.path = [];
        }
...
exports.InnerSpec = {
    encode: function (message, writer) {
        ...
        try {
            for (var _b = __values(message.childOrder), _c = _b.next(); !_c.done; _c = _b.next()) {
                var v = _c.value;
                writer.int32(v);
            }
        }
    ...
    fromJSON: function (object) {
        return {
            childOrder: Array.isArray(object === null || object === void 0 ? void 0 : object.childOrder) ? object.childOrder.map(function (e) { return Number(e); }) : [],
    ...
    toJSON: function (message) {
        ...
        if (message.childOrder) {
            obj.childOrder = message.childOrder.map(function (e) { return Math.round(e); });
        }
        else {
            obj.childOrder = [];
        }
...
exports.BatchProof = {
    ...
    fromJSON: function (object) {
        return { entries: Array.isArray(object === null || object === void 0 ? void 0 : object.entries) ? object.entries.map(function (e) { return exports.BatchEntry.fromJSON(e); }) : [] };
    },
    toJSON: function (message) {
        var obj = {};
        if (message.entries) {
            obj.entries = message.entries.map(function (e) { return e ? exports.BatchEntry.toJSON(e) : undefined; });
        }
        else {
            obj.entries = [];
        }
...
exports.CompressedBatchProof = {
    encode: function (message, writer) {
        ...
        if (writer === void 0) { writer = minimal_js_1.default.Writer.create(); }
        try {
            for (var _c = __values(message.entries), _d = _c.next(); !_d.done; _d = _c.next()) {
                var v = _d.value;
        ...
        try {
            for (var _e = __values(message.lookupInners), _f = _e.next(); !_f.done; _f = _e.next()) {
                var v = _f.value;
    ...
    fromJSON: function (object) {
        return {
            entries: Array.isArray(object === null || object === void 0 ? void 0 : object.entries) ? object.entries.map(function (e) { return exports.CompressedBatchEntry.fromJSON(e); }) : [],
            lookupInners: Array.isArray(object === null || object === void 0 ? void 0 : object.lookupInners) ? object.lookupInners.map(function (e) { return exports.InnerOp.fromJSON(e); }) : [],
        };
    },
    toJSON: function (message) {
        var obj = {};
        if (message.entries) {
            obj.entries = message.entries.map(function (e) { return e ? exports.CompressedBatchEntry.toJSON(e) : undefined; });
        }
        else {
            obj.entries = [];
        }
        if (message.lookupInners) {
            obj.lookupInners = message.lookupInners.map(function (e) { return e ? exports.InnerOp.toJSON(e) : undefined; });
        }
        else {
            obj.lookupInners = [];
        }
