...
import { Block } from "../../../cometbft/types/v1/block";
import { BlockID } from "../../../cometbft/types/v1/types";
...
export declare const OrderBy: {
     ...
     * to ASC in this case.
     */
    readonly ORDER_BY_UNSPECIFIED: 0;
    /** ORDER_BY_ASC - ORDER_BY_ASC defines ascending order */
    readonly ORDER_BY_ASC: 1;
    /** ORDER_BY_DESC - ORDER_BY_DESC defines descending order */
    readonly ORDER_BY_DESC: 2;
...
export declare const BroadcastMode: {
    ...
    readonly BROADCAST_MODE_UNSPECIFIED: 0;
    /**
     ...
     * @deprecated
     */
    readonly BROADCAST_MODE_BLOCK: 1;
    /**
     * BROADCAST_MODE_SYNC - BROADCAST_MODE_SYNC defines a tx broadcasting mode where the client waits
     * for a CheckTx execution response only.
     */
    readonly BROADCAST_MODE_SYNC: 2;
    /**
     * BROADCAST_MODE_ASYNC - BROADCAST_MODE_ASYNC defines a tx broadcasting mode where the client
     * returns immediately.
     */
    readonly BROADCAST_MODE_ASYNC: 3;
    readonly UNRECOGNIZED: -1;
};
