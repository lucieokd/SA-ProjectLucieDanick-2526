...
var params_1 = require("../../../cometbft/types/v1/params.js");
...
exports.MsgUpdateParams = {
    encode: function (message, writer) {
        ...
        if (message.synchrony !== undefined) {
            params_1.SynchronyParams.encode(message.synchrony, writer.uint32(50).fork()).ldelim();
        }
        if (message.feature !== undefined) {
            params_1.FeatureParams.encode(message.feature, writer.uint32(58).fork()).ldelim();
        }
        return writer;
    },
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                ...
                case 5:
                    ...
                    break;
                case 6:
                    message.synchrony = params_1.SynchronyParams.decode(reader, reader.uint32());
                    break;
                case 7:
                    message.feature = params_1.FeatureParams.decode(reader, reader.uint32());
                    break;
                default:
    ...
    fromJSON: function (object) {
        return {
            ...
            synchrony: isSet(object.synchrony) ? params_1.SynchronyParams.fromJSON(object.synchrony) : undefined,
            feature: isSet(object.feature) ? params_1.FeatureParams.fromJSON(object.feature) : undefined,
        };
    },
    toJSON: function (message) {
        ...
        message.synchrony !== undefined &&
            (obj.synchrony = message.synchrony ? params_1.SynchronyParams.toJSON(message.synchrony) : undefined);
        message.feature !== undefined &&
            (obj.feature = message.feature ? params_1.FeatureParams.toJSON(message.feature) : undefined);
        return obj;
    },
    ...
    fromPartial: function (object) {
        ...
        message.synchrony = (object.synchrony !== undefined && object.synchrony !== null)
            ? params_1.SynchronyParams.fromPartial(object.synchrony)
            : undefined;
        message.feature = (object.feature !== undefined && object.feature !== null)
            ? params_1.FeatureParams.fromPartial(object.feature)
            : undefined;
        return message;
    },
};
