...
exports.TxResponse = {
    encode: function (message, writer) {
        ...
        try {
            for (var _c = __values(message.logs), _d = _c.next(); !_d.done; _d = _c.next()) {
                var v = _d.value;
...
exports.Result = {
    encode: function (message, writer) {
        ...
        try {
            for (var _c = __values(message.events), _d = _c.next(); !_d.done; _d = _c.next()) {
                var v = _d.value;
        ...
        try {
            for (var _e = __values(message.msgResponses), _f = _e.next(); !_f.done; _f = _e.next()) {
                var v = _f.value;
    ...
    fromJSON: function (object) {
        return {
            ...
            log: isSet(object.log) ? String(object.log) : "",
            events: Array.isArray(object === null || object === void 0 ? void 0 : object.events) ? object.events.map(function (e) { return types_1.Event.fromJSON(e); }) : [],
            msgResponses: Array.isArray(object === null || object === void 0 ? void 0 : object.msgResponses) ? object.msgResponses.map(function (e) { return any_1.Any.fromJSON(e); }) : [],
        };
    },
    toJSON: function (message) {
        var obj = {};
        ...
        if (message.msgResponses) {
            obj.msgResponses = message.msgResponses.map(function (e) { return e ? any_1.Any.toJSON(e) : undefined; });
        }
        else {
            obj.msgResponses = [];
        }
...
exports.TxMsgData = {
    encode: function (message, writer) {
        ...
        if (writer === void 0) { writer = minimal_js_1.default.Writer.create(); }
        try {
            for (var _c = __values(message.data), _d = _c.next(); !_d.done; _d = _c.next()) {
                var v = _d.value;
...
exports.SearchBlocksResult = {
    encode: function (message, writer) {
        ...
        try {
            for (var _b = __values(message.blocks), _c = _b.next(); !_c.done; _c = _b.next()) {
                var v = _c.value;
    ...
    decode: function (input, length) {
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                case 1:
                    message.totalCount = longToString(reader.int64());
                    break;
                case 2:
                    message.count = longToString(reader.int64());
                    break;
                case 3:
                    message.pageNumber = longToString(reader.int64());
                    break;
                case 4:
                    message.pageTotal = longToString(reader.int64());
                    break;
                case 5:
    ...
    fromJSON: function (object) {
        return {
            ...
            pageTotal: isSet(object.pageTotal) ? String(object.pageTotal) : "0",
            limit: isSet(object.limit) ? String(object.limit) : "0",
            blocks: Array.isArray(object === null || object === void 0 ? void 0 : object.blocks) ? object.blocks.map(function (e) { return block_1.Block.fromJSON(e); }) : [],
        };
    },
    toJSON: function (message) {
        var obj = {};
        ...
        message.limit !== undefined && (obj.limit = message.limit);
        if (message.blocks) {
            obj.blocks = message.blocks.map(function (e) { return e ? block_1.Block.toJSON(e) : undefined; });
        }
        else {
            obj.blocks = [];
        }
    ...
    fromPartial: function (object) {
        ...
        message.pageTotal = (_d = object.pageTotal) !== null && _d !== void 0 ? _d : "0";
        message.limit = (_e = object.limit) !== null && _e !== void 0 ? _e : "0";
        message.blocks = ((_f = object.blocks) === null || _f === void 0 ? void 0 : _f.map(function (e) { return block_1.Block.fromPartial(e); })) || [];
        return message;
    },
};
