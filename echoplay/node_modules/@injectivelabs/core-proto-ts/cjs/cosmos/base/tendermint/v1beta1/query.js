...
var types_1 = require("../../../../cometbft/p2p/v1/types.js");
var block_1 = require("../../../../cometbft/types/v1/block.js");
var types_2 = require("../../../../cometbft/types/v1/types.js");
var any_1 = require("../../../../google/protobuf/any.js");
var pagination_1 = require("../../query/v1beta1/pagination.js");
var types_3 = require("./types.js");
...
exports.VersionInfo = {
    encode: function (message, writer) {
        ...
        try {
            for (var _b = __values(message.buildDeps), _c = _b.next(); !_c.done; _c = _b.next()) {
                var v = _c.value;
...
exports.ProofOps = {
    encode: function (message, writer) {
        ...
        if (writer === void 0) { writer = minimal_js_1.default.Writer.create(); }
        try {
            for (var _b = __values(message.ops), _c = _b.next(); !_c.done; _c = _b.next()) {
                var v = _c.value;
...
var ServiceClientImpl = /** @class */ (function () {
    ...
    ServiceClientImpl.prototype.GetValidatorSetByHeight = function (request, metadata) {
    ...
    ServiceClientImpl.prototype.ABCIQuery = function (request, metadata) {
...
exports.ServiceGetNodeInfoDesc = {
    ...
    responseType: {
        deserializeBinary: function (data) {
            var value = exports.GetNodeInfoResponse.decode(data);
...
exports.ServiceGetSyncingDesc = {
    ...
    responseType: {
        deserializeBinary: function (data) {
            var value = exports.GetSyncingResponse.decode(data);
            return __assign(__assign({}, value), { toObject: function () {
                    return value;
                } });
        },
...
exports.ServiceGetLatestBlockDesc = {
    ...
    responseType: {
        deserializeBinary: function (data) {
            var value = exports.GetLatestBlockResponse.decode(data);
            return __assign(__assign({}, value), { toObject: function () {
                    return value;
                } });
        },
...
exports.ServiceGetBlockByHeightDesc = {
    ...
    responseType: {
        deserializeBinary: function (data) {
            var value = exports.GetBlockByHeightResponse.decode(data);
            return __assign(__assign({}, value), { toObject: function () {
                    return value;
                } });
        },
...
exports.ServiceGetLatestValidatorSetDesc = {
    ...
    responseType: {
        deserializeBinary: function (data) {
            var value = exports.GetLatestValidatorSetResponse.decode(data);
            return __assign(__assign({}, value), { toObject: function () {
                    return value;
                } });
        },
...
exports.ServiceGetValidatorSetByHeightDesc = {
    ...
    responseType: {
        deserializeBinary: function (data) {
            var value = exports.GetValidatorSetByHeightResponse.decode(data);
            return __assign(__assign({}, value), { toObject: function () {
                    return value;
                } });
        },
...
exports.ServiceABCIQueryDesc = {
    ...
    responseType: {
        deserializeBinary: function (data) {
            var value = exports.ABCIQueryResponse.decode(data);
            return __assign(__assign({}, value), { toObject: function () {
                    return value;
                } });
        },
