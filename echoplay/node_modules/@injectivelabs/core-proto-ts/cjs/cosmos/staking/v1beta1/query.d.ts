 ...
 */
export interface QueryAllowedDelegationTransferReceiversRequest {
}
/**
 * QueryAllowedDelegationTransferReceiversResponse response type for the
 * Query/AllowedDelegationTransferReceivers RPC method.
 */
export interface QueryAllowedDelegationTransferReceiversResponse {
    addresses: string[];
}
/**
...
export declare const QueryAllowedDelegationTransferReceiversRequest: {
    encode(_: QueryAllowedDelegationTransferReceiversRequest, writer?: _m0.Writer): _m0.Writer;
    decode(input: _m0.Reader | Uint8Array, length?: number): QueryAllowedDelegationTransferReceiversRequest;
    fromJSON(_: any): QueryAllowedDelegationTransferReceiversRequest;
    toJSON(_: QueryAllowedDelegationTransferReceiversRequest): unknown;
    create(base?: DeepPartial<QueryAllowedDelegationTransferReceiversRequest>): QueryAllowedDelegationTransferReceiversRequest;
    fromPartial(_: DeepPartial<QueryAllowedDelegationTransferReceiversRequest>): QueryAllowedDelegationTransferReceiversRequest;
};
export declare const QueryAllowedDelegationTransferReceiversResponse: {
    encode(message: QueryAllowedDelegationTransferReceiversResponse, writer?: _m0.Writer): _m0.Writer;
    decode(input: _m0.Reader | Uint8Array, length?: number): QueryAllowedDelegationTransferReceiversResponse;
    fromJSON(object: any): QueryAllowedDelegationTransferReceiversResponse;
    toJSON(message: QueryAllowedDelegationTransferReceiversResponse): unknown;
    create(base?: DeepPartial<QueryAllowedDelegationTransferReceiversResponse>): QueryAllowedDelegationTransferReceiversResponse;
    fromPartial(object: DeepPartial<QueryAllowedDelegationTransferReceiversResponse>): QueryAllowedDelegationTransferReceiversResponse;
};
...
export interface Query {
    ...
    AllowedDelegationTransferReceivers(request: DeepPartial<QueryAllowedDelegationTransferReceiversRequest>, metadata?: grpc.Metadata): Promise<QueryAllowedDelegationTransferReceiversResponse>;
...
export declare const QueryAllowedDelegationTransferReceiversDesc: UnaryMethodDefinitionish;
