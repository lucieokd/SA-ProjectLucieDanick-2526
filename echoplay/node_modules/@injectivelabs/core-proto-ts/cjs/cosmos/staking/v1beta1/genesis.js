...
exports.GenesisState = {
    encode: function (message, writer) {
        ...
        try {
            for (var _g = __values(message.lastValidatorPowers), _h = _g.next(); !_h.done; _h = _g.next()) {
                var v = _h.value;
        ...
        try {
            for (var _j = __values(message.validators), _k = _j.next(); !_k.done; _k = _j.next()) {
                var v = _k.value;
        ...
        try {
            for (var _l = __values(message.delegations), _m = _l.next(); !_m.done; _m = _l.next()) {
                var v = _m.value;
        ...
        try {
            for (var _o = __values(message.unbondingDelegations), _p = _o.next(); !_p.done; _p = _o.next()) {
                var v = _p.value;
        ...
        try {
            for (var _q = __values(message.redelegations), _r = _q.next(); !_r.done; _r = _q.next()) {
                var v = _r.value;
        ...
        try {
            for (var _s = __values(message.allowedDelegationTransferReceivers), _t = _s.next(); !_t.done; _t = _s.next()) {
                var v = _t.value;
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                ...
                case 8:
                    ...
                    break;
                case 9:
                    message.allowedDelegationTransferReceivers.push(reader.string());
                    break;
                default:
    ...
    fromJSON: function (object) {
        return {
            ...
            allowedDelegationTransferReceivers: Array.isArray(object === null || object === void 0 ? void 0 : object.allowedDelegationTransferReceivers)
                ? object.allowedDelegationTransferReceivers.map(function (e) { return String(e); })
                : [],
        };
    },
    toJSON: function (message) {
        ...
        if (message.allowedDelegationTransferReceivers) {
            obj.allowedDelegationTransferReceivers = message.allowedDelegationTransferReceivers.map(function (e) { return e; });
        }
        else {
            obj.allowedDelegationTransferReceivers = [];
        }
        return obj;
    },
    ...
    fromPartial: function (object) {
        ...
        message.allowedDelegationTransferReceivers = ((_h = object.allowedDelegationTransferReceivers) === null || _h === void 0 ? void 0 : _h.map(function (e) { return e; })) || [];
        return message;
    },
};
