...
exports.QueryAllowedDelegationTransferReceiversRequest = {
    ...
    decode: function (input, length) {
        var reader = input instanceof minimal_js_1.default.Reader ? input : new minimal_js_1.default.Reader(input);
        var end = length === undefined ? reader.len : reader.pos + length;
        var message = createBaseQueryAllowedDelegationTransferReceiversRequest();
        while (reader.pos < end) {
            var tag = reader.uint32();
            switch (tag >>> 3) {
                default:
    ...
    create: function (base) {
        return exports.QueryAllowedDelegationTransferReceiversRequest.fromPartial(base !== null && base !== void 0 ? base : {});
    },
...
exports.QueryAllowedDelegationTransferReceiversResponse = {
    ...
    decode: function (input, length) {
        var reader = input instanceof minimal_js_1.default.Reader ? input : new minimal_js_1.default.Reader(input);
        var end = length === undefined ? reader.len : reader.pos + length;
        var message = createBaseQueryAllowedDelegationTransferReceiversResponse();
        while (reader.pos < end) {
            var tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
    ...
    create: function (base) {
        return exports.QueryAllowedDelegationTransferReceiversResponse.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial: function (object) {
        var _a;
        var message = createBaseQueryAllowedDelegationTransferReceiversResponse();
...
var QueryClientImpl = /** @class */ (function () {
    ...
    QueryClientImpl.prototype.AllowedDelegationTransferReceivers = function (request, metadata) {
        return this.rpc.unary(exports.QueryAllowedDelegationTransferReceiversDesc, exports.QueryAllowedDelegationTransferReceiversRequest.fromPartial(request), metadata);
    };
...
exports.QueryAllowedDelegationTransferReceiversDesc = {
    ...
    requestType: {
        serializeBinary: function () {
            return exports.QueryAllowedDelegationTransferReceiversRequest.encode(this).finish();
        },
    },
    responseType: {
        deserializeBinary: function (data) {
            var value = exports.QueryAllowedDelegationTransferReceiversResponse.decode(data);
            return __assign(__assign({}, value), { toObject: function () {
                    return value;
                } });
        },
