 ...
 */
export interface MsgTransferDelegation {
    delegatorAddress: string;
    validatorAddress: string;
...
export interface MsgTransferDelegationResponse {
}
/**
...
export declare const MsgTransferDelegation: {
    encode(message: MsgTransferDelegation, writer?: _m0.Writer): _m0.Writer;
    decode(input: _m0.Reader | Uint8Array, length?: number): MsgTransferDelegation;
    fromJSON(object: any): MsgTransferDelegation;
    toJSON(message: MsgTransferDelegation): unknown;
    create(base?: DeepPartial<MsgTransferDelegation>): MsgTransferDelegation;
    fromPartial(object: DeepPartial<MsgTransferDelegation>): MsgTransferDelegation;
};
export declare const MsgTransferDelegationResponse: {
    encode(_: MsgTransferDelegationResponse, writer?: _m0.Writer): _m0.Writer;
    decode(input: _m0.Reader | Uint8Array, length?: number): MsgTransferDelegationResponse;
    fromJSON(_: any): MsgTransferDelegationResponse;
    toJSON(_: MsgTransferDelegationResponse): unknown;
    create(base?: DeepPartial<MsgTransferDelegationResponse>): MsgTransferDelegationResponse;
    fromPartial(_: DeepPartial<MsgTransferDelegationResponse>): MsgTransferDelegationResponse;
};
...
export interface Msg {
     ...
     * from a delegator to another address.
     */
    TransferDelegation(request: DeepPartial<MsgTransferDelegation>, metadata?: grpc.Metadata): Promise<MsgTransferDelegationResponse>;
    /**
...
export declare const MsgTransferDelegationDesc: UnaryMethodDefinitionish;
