...
exports.GrpcWebError = exports.GrpcWebImpl = exports.MsgUpdateParamsDesc = exports.MsgCancelUnbondingDelegationDesc = exports.MsgUndelegateDesc = exports.MsgBeginRedelegateDesc = exports.MsgTransferDelegationDesc = exports.MsgDelegateDesc = exports.MsgEditValidatorDesc = exports.MsgCreateValidatorDesc = exports.MsgDesc = exports.MsgClientImpl = exports.MsgUpdateParamsResponse = exports.MsgUpdateParams = exports.MsgCancelUnbondingDelegationResponse = exports.MsgCancelUnbondingDelegation = exports.MsgUndelegateResponse = exports.MsgUndelegate = exports.MsgBeginRedelegateResponse = exports.MsgBeginRedelegate = exports.MsgTransferDelegationResponse = exports.MsgTransferDelegation = exports.MsgDelegateResponse = exports.MsgDelegate = exports.MsgEditValidatorResponse = exports.MsgEditValidator = exports.MsgCreateValidatorResponse = exports.MsgCreateValidator = exports.protobufPackage = void 0;
/* eslint-disable */
...
function createBaseMsgTransferDelegation() {
    return { delegatorAddress: "", validatorAddress: "", receiverAddress: "", amount: undefined };
}
exports.MsgTransferDelegation = {
    encode: function (message, writer) {
        if (writer === void 0) { writer = minimal_js_1.default.Writer.create(); }
        if (message.delegatorAddress !== "") {
            writer.uint32(10).string(message.delegatorAddress);
    ...
    decode: function (input, length) {
        var reader = input instanceof minimal_js_1.default.Reader ? input : new minimal_js_1.default.Reader(input);
        var end = length === undefined ? reader.len : reader.pos + length;
        var message = createBaseMsgTransferDelegation();
        while (reader.pos < end) {
            var tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
    ...
    create: function (base) {
        return exports.MsgTransferDelegation.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial: function (object) {
        var _a, _b, _c;
        var message = createBaseMsgTransferDelegation();
        message.delegatorAddress = (_a = object.delegatorAddress) !== null && _a !== void 0 ? _a : "";
        message.validatorAddress = (_b = object.validatorAddress) !== null && _b !== void 0 ? _b : "";
        message.receiverAddress = (_c = object.receiverAddress) !== null && _c !== void 0 ? _c : "";
        message.amount = (object.amount !== undefined && object.amount !== null)
            ? coin_1.Coin.fromPartial(object.amount)
            : undefined;
        return message;
...
function createBaseMsgTransferDelegationResponse() {
    return {};
}
exports.MsgTransferDelegationResponse = {
    encode: function (_, writer) {
        if (writer === void 0) { writer = minimal_js_1.default.Writer.create(); }
        return writer;
    },
    decode: function (input, length) {
        var reader = input instanceof minimal_js_1.default.Reader ? input : new minimal_js_1.default.Reader(input);
        var end = length === undefined ? reader.len : reader.pos + length;
        var message = createBaseMsgTransferDelegationResponse();
        while (reader.pos < end) {
            var tag = reader.uint32();
            switch (tag >>> 3) {
                default:
    ...
    create: function (base) {
        return exports.MsgTransferDelegationResponse.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial: function (_) {
        var message = createBaseMsgTransferDelegationResponse();
        return message;
...
var MsgClientImpl = /** @class */ (function () {
    function MsgClientImpl(rpc) {
        ...
        this.TransferDelegation = this.TransferDelegation.bind(this);
        this.BeginRedelegate = this.BeginRedelegate.bind(this);
        this.Undelegate = this.Undelegate.bind(this);
        this.CancelUnbondingDelegation = this.CancelUnbondingDelegation.bind(this);
        this.UpdateParams = this.UpdateParams.bind(this);
    }
    MsgClientImpl.prototype.CreateValidator = function (request, metadata) {
        return this.rpc.unary(exports.MsgCreateValidatorDesc, exports.MsgCreateValidator.fromPartial(request), metadata);
    };
    MsgClientImpl.prototype.EditValidator = function (request, metadata) {
        return this.rpc.unary(exports.MsgEditValidatorDesc, exports.MsgEditValidator.fromPartial(request), metadata);
    };
    MsgClientImpl.prototype.Delegate = function (request, metadata) {
        return this.rpc.unary(exports.MsgDelegateDesc, exports.MsgDelegate.fromPartial(request), metadata);
    };
    MsgClientImpl.prototype.TransferDelegation = function (request, metadata) {
        return this.rpc.unary(exports.MsgTransferDelegationDesc, exports.MsgTransferDelegation.fromPartial(request), metadata);
    };
    MsgClientImpl.prototype.BeginRedelegate = function (request, metadata) {
        return this.rpc.unary(exports.MsgBeginRedelegateDesc, exports.MsgBeginRedelegate.fromPartial(request), metadata);
    };
    MsgClientImpl.prototype.Undelegate = function (request, metadata) {
        return this.rpc.unary(exports.MsgUndelegateDesc, exports.MsgUndelegate.fromPartial(request), metadata);
    };
    MsgClientImpl.prototype.CancelUnbondingDelegation = function (request, metadata) {
...
exports.MsgDesc = { serviceName: "cosmos.staking.v1beta1.Msg" };
exports.MsgCreateValidatorDesc = {
    ...
    responseType: {
        deserializeBinary: function (data) {
            var value = exports.MsgCreateValidatorResponse.decode(data);
...
exports.MsgEditValidatorDesc = {
    ...
    responseType: {
        deserializeBinary: function (data) {
            var value = exports.MsgEditValidatorResponse.decode(data);
            return __assign(__assign({}, value), { toObject: function () {
                    return value;
                } });
        },
...
exports.MsgDelegateDesc = {
    ...
    responseType: {
        deserializeBinary: function (data) {
            var value = exports.MsgDelegateResponse.decode(data);
            return __assign(__assign({}, value), { toObject: function () {
                    return value;
                } });
        },
...
exports.MsgTransferDelegationDesc = {
    ...
    requestType: {
        serializeBinary: function () {
            return exports.MsgTransferDelegation.encode(this).finish();
        },
    },
    responseType: {
        deserializeBinary: function (data) {
            var value = exports.MsgTransferDelegationResponse.decode(data);
            return __assign(__assign({}, value), { toObject: function () {
                    return value;
                } });
        },
...
exports.MsgBeginRedelegateDesc = {
    ...
    responseType: {
        deserializeBinary: function (data) {
            var value = exports.MsgBeginRedelegateResponse.decode(data);
            return __assign(__assign({}, value), { toObject: function () {
                    return value;
                } });
        },
...
exports.MsgUndelegateDesc = {
    ...
    responseType: {
        deserializeBinary: function (data) {
            var value = exports.MsgUndelegateResponse.decode(data);
            return __assign(__assign({}, value), { toObject: function () {
                    return value;
                } });
        },
...
exports.MsgCancelUnbondingDelegationDesc = {
    ...
    responseType: {
        deserializeBinary: function (data) {
            var value = exports.MsgCancelUnbondingDelegationResponse.decode(data);
            return __assign(__assign({}, value), { toObject: function () {
                    return value;
                } });
        },
