...
function proposalStatusFromJSON(object) {
    switch (object) {
        ...
        case "PROPOSAL_STATUS_DEPOSIT_PERIOD":
            return exports.ProposalStatus.PROPOSAL_STATUS_DEPOSIT_PERIOD;
        case 2:
        case "PROPOSAL_STATUS_VOTING_PERIOD":
            return exports.ProposalStatus.PROPOSAL_STATUS_VOTING_PERIOD;
        case 3:
        case "PROPOSAL_STATUS_PASSED":
            return exports.ProposalStatus.PROPOSAL_STATUS_PASSED;
        case 4:
        case "PROPOSAL_STATUS_REJECTED":
            return exports.ProposalStatus.PROPOSAL_STATUS_REJECTED;
        case 5:
        case "PROPOSAL_STATUS_FAILED":
            return exports.ProposalStatus.PROPOSAL_STATUS_FAILED;
        case -1:
        case "UNRECOGNIZED":
        default:
...
function proposalStatusToJSON(object) {
    switch (object) {
        ...
        case exports.ProposalStatus.PROPOSAL_STATUS_DEPOSIT_PERIOD:
            return "PROPOSAL_STATUS_DEPOSIT_PERIOD";
        case exports.ProposalStatus.PROPOSAL_STATUS_VOTING_PERIOD:
            return "PROPOSAL_STATUS_VOTING_PERIOD";
        case exports.ProposalStatus.PROPOSAL_STATUS_PASSED:
            return "PROPOSAL_STATUS_PASSED";
        case exports.ProposalStatus.PROPOSAL_STATUS_REJECTED:
            return "PROPOSAL_STATUS_REJECTED";
        case exports.ProposalStatus.PROPOSAL_STATUS_FAILED:
...
exports.Proposal = {
    encode: function (message, writer) {
        ...
        try {
            for (var _e = __values(message.totalDeposit), _f = _e.next(); !_f.done; _f = _e.next()) {
                var v = _f.value;
    ...
    fromJSON: function (object) {
        return {
            ...
            totalDeposit: Array.isArray(object === null || object === void 0 ? void 0 : object.totalDeposit) ? object.totalDeposit.map(function (e) { return coin_1.Coin.fromJSON(e); }) : [],
    ...
    toJSON: function (message) {
        ...
        if (message.totalDeposit) {
            obj.totalDeposit = message.totalDeposit.map(function (e) { return e ? coin_1.Coin.toJSON(e) : undefined; });
        }
        else {
            obj.totalDeposit = [];
        }
    ...
    fromPartial: function (object) {
        ...
        message.totalDeposit = ((_f = object.totalDeposit) === null || _f === void 0 ? void 0 : _f.map(function (e) { return coin_1.Coin.fromPartial(e); })) || [];
...
exports.DepositParams = {
    encode: function (message, writer) {
        ...
        if (writer === void 0) { writer = minimal_js_1.default.Writer.create(); }
        try {
            for (var _b = __values(message.minDeposit), _c = _b.next(); !_c.done; _c = _b.next()) {
                var v = _c.value;
    ...
    fromJSON: function (object) {
        return {
            minDeposit: Array.isArray(object === null || object === void 0 ? void 0 : object.minDeposit) ? object.minDeposit.map(function (e) { return coin_1.Coin.fromJSON(e); }) : [],
    ...
    toJSON: function (message) {
        ...
        if (message.minDeposit) {
            obj.minDeposit = message.minDeposit.map(function (e) { return e ? coin_1.Coin.toJSON(e) : undefined; });
        }
        else {
            obj.minDeposit = [];
        }
...
exports.Params = {
    encode: function (message, writer) {
        ...
        if (writer === void 0) { writer = minimal_js_1.default.Writer.create(); }
        try {
            for (var _c = __values(message.minDeposit), _d = _c.next(); !_d.done; _d = _c.next()) {
                var v = _d.value;
                coin_1.Coin.encode(v, writer.uint32(10).fork()).ldelim();
            }
        }
        ...
        try {
            for (var _e = __values(message.expeditedMinDeposit), _f = _e.next(); !_f.done; _f = _e.next()) {
                var v = _f.value;
    ...
    fromJSON: function (object) {
        return {
            ...
            expeditedMinDeposit: Array.isArray(object === null || object === void 0 ? void 0 : object.expeditedMinDeposit)
                ? object.expeditedMinDeposit.map(function (e) { return coin_1.Coin.fromJSON(e); })
                : [],
    ...
    toJSON: function (message) {
        ...
        message.expeditedVotingPeriod !== undefined && (obj.expeditedVotingPeriod = message.expeditedVotingPeriod
            ? duration_1.Duration.toJSON(message.expeditedVotingPeriod)
            : undefined);
        message.expeditedThreshold !== undefined && (obj.expeditedThreshold = message.expeditedThreshold);
        if (message.expeditedMinDeposit) {
            obj.expeditedMinDeposit = message.expeditedMinDeposit.map(function (e) { return e ? coin_1.Coin.toJSON(e) : undefined; });
        }
        else {
