...
exports.BlockMetadata = {
    encode: function (message, writer) {
        ...
        if (message.responseCommit !== undefined) {
            types_1.CommitResponse.encode(message.responseCommit, writer.uint32(50).fork()).ldelim();
        }
        if (message.requestFinalizeBlock !== undefined) {
            types_1.FinalizeBlockRequest.encode(message.requestFinalizeBlock, writer.uint32(58).fork()).ldelim();
        }
        if (message.responseFinalizeBlock !== undefined) {
            types_1.FinalizeBlockResponse.encode(message.responseFinalizeBlock, writer.uint32(66).fork()).ldelim();
        }
        return writer;
    },
    decode: function (input, length) {
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                case 6:
                    message.responseCommit = types_1.CommitResponse.decode(reader, reader.uint32());
                    break;
                case 7:
                    message.requestFinalizeBlock = types_1.FinalizeBlockRequest.decode(reader, reader.uint32());
                    break;
                case 8:
                    message.responseFinalizeBlock = types_1.FinalizeBlockResponse.decode(reader, reader.uint32());
                    break;
                default:
                    reader.skipType(tag & 7);
                    break;
    ...
    fromJSON: function (object) {
        return {
            responseCommit: isSet(object.responseCommit) ? types_1.CommitResponse.fromJSON(object.responseCommit) : undefined,
            requestFinalizeBlock: isSet(object.requestFinalizeBlock)
                ? types_1.FinalizeBlockRequest.fromJSON(object.requestFinalizeBlock)
                : undefined,
            responseFinalizeBlock: isSet(object.responseFinalizeBlock)
                ? types_1.FinalizeBlockResponse.fromJSON(object.responseFinalizeBlock)
                : undefined,
        };
    },
    toJSON: function (message) {
        ...
        message.responseCommit !== undefined &&
            (obj.responseCommit = message.responseCommit ? types_1.CommitResponse.toJSON(message.responseCommit) : undefined);
        message.requestFinalizeBlock !== undefined && (obj.requestFinalizeBlock = message.requestFinalizeBlock
            ? types_1.FinalizeBlockRequest.toJSON(message.requestFinalizeBlock)
            : undefined);
        message.responseFinalizeBlock !== undefined && (obj.responseFinalizeBlock = message.responseFinalizeBlock
            ? types_1.FinalizeBlockResponse.toJSON(message.responseFinalizeBlock)
            : undefined);
        return obj;
    },
    create: function (base) {
    ...
    fromPartial: function (object) {
        ...
        message.responseCommit = (object.responseCommit !== undefined && object.responseCommit !== null)
            ? types_1.CommitResponse.fromPartial(object.responseCommit)
            : undefined;
        message.requestFinalizeBlock = (object.requestFinalizeBlock !== undefined && object.requestFinalizeBlock !== null)
            ? types_1.FinalizeBlockRequest.fromPartial(object.requestFinalizeBlock)
            : undefined;
        message.responseFinalizeBlock =
            (object.responseFinalizeBlock !== undefined && object.responseFinalizeBlock !== null)
                ? types_1.FinalizeBlockResponse.fromPartial(object.responseFinalizeBlock)
                : undefined;
        return message;
    },
};
