...
exports.ListenFinalizeBlockRequest = {
    encode: function (message, writer) {
        ...
        if (message.req !== undefined) {
            types_1.FinalizeBlockRequest.encode(message.req, writer.uint32(10).fork()).ldelim();
        }
        if (message.res !== undefined) {
            types_1.FinalizeBlockResponse.encode(message.res, writer.uint32(18).fork()).ldelim();
        }
        return writer;
    },
    decode: function (input, length) {
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                case 1:
                    message.req = types_1.FinalizeBlockRequest.decode(reader, reader.uint32());
                    break;
                case 2:
                    message.res = types_1.FinalizeBlockResponse.decode(reader, reader.uint32());
                    break;
                default:
    ...
    fromJSON: function (object) {
        return {
            req: isSet(object.req) ? types_1.FinalizeBlockRequest.fromJSON(object.req) : undefined,
            res: isSet(object.res) ? types_1.FinalizeBlockResponse.fromJSON(object.res) : undefined,
        };
    },
    toJSON: function (message) {
        var obj = {};
        message.req !== undefined && (obj.req = message.req ? types_1.FinalizeBlockRequest.toJSON(message.req) : undefined);
        message.res !== undefined && (obj.res = message.res ? types_1.FinalizeBlockResponse.toJSON(message.res) : undefined);
        return obj;
    },
    ...
    fromPartial: function (object) {
        ...
        message.req = (object.req !== undefined && object.req !== null)
            ? types_1.FinalizeBlockRequest.fromPartial(object.req)
            : undefined;
        message.res = (object.res !== undefined && object.res !== null)
            ? types_1.FinalizeBlockResponse.fromPartial(object.res)
            : undefined;
        return message;
    },
};
...
exports.ListenCommitRequest = {
    encode: function (message, writer) {
        ...
        if (message.res !== undefined) {
            types_1.CommitResponse.encode(message.res, writer.uint32(18).fork()).ldelim();
        }
        try {
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                case 1:
                    ...
                    break;
                case 2:
                    message.res = types_1.CommitResponse.decode(reader, reader.uint32());
                    break;
                case 3:
    ...
    fromJSON: function (object) {
        return {
            ...
            res: isSet(object.res) ? types_1.CommitResponse.fromJSON(object.res) : undefined,
    ...
    toJSON: function (message) {
        ...
        message.res !== undefined && (obj.res = message.res ? types_1.CommitResponse.toJSON(message.res) : undefined);
    ...
    fromPartial: function (object) {
        ...
        message.res = (object.res !== undefined && object.res !== null)
            ? types_1.CommitResponse.fromPartial(object.res)
            : undefined;
