...
function stateFromJSON(object) {
    switch (object) {
        ...
        case "STATE_UNINITIALIZED_UNSPECIFIED":
            return exports.State.STATE_UNINITIALIZED_UNSPECIFIED;
        case 1:
        case "STATE_INIT":
            return exports.State.STATE_INIT;
        case 2:
        case "STATE_TRYOPEN":
            return exports.State.STATE_TRYOPEN;
        case 3:
        case "STATE_OPEN":
            return exports.State.STATE_OPEN;
        case 4:
        case "STATE_CLOSED":
            return exports.State.STATE_CLOSED;
        case 5:
        case "STATE_FLUSHING":
            return exports.State.STATE_FLUSHING;
        case 6:
        case "STATE_FLUSHCOMPLETE":
            return exports.State.STATE_FLUSHCOMPLETE;
        case -1:
        case "UNRECOGNIZED":
        default:
            return exports.State.UNRECOGNIZED;
    }
}
function stateToJSON(object) {
    switch (object) {
        case exports.State.STATE_UNINITIALIZED_UNSPECIFIED:
            return "STATE_UNINITIALIZED_UNSPECIFIED";
        case exports.State.STATE_INIT:
            return "STATE_INIT";
        case exports.State.STATE_TRYOPEN:
            return "STATE_TRYOPEN";
        case exports.State.STATE_OPEN:
            return "STATE_OPEN";
        case exports.State.STATE_CLOSED:
            return "STATE_CLOSED";
        case exports.State.STATE_FLUSHING:
            return "STATE_FLUSHING";
        case exports.State.STATE_FLUSHCOMPLETE:
            return "STATE_FLUSHCOMPLETE";
        case exports.State.UNRECOGNIZED:
        default:
            return "UNRECOGNIZED";
    }
}
...
function orderFromJSON(object) {
    switch (object) {
        ...
        case "ORDER_NONE_UNSPECIFIED":
            return exports.Order.ORDER_NONE_UNSPECIFIED;
        case 1:
        case "ORDER_UNORDERED":
            return exports.Order.ORDER_UNORDERED;
        case 2:
        case "ORDER_ORDERED":
            return exports.Order.ORDER_ORDERED;
        case -1:
        case "UNRECOGNIZED":
        default:
            return exports.Order.UNRECOGNIZED;
    }
}
function orderToJSON(object) {
    switch (object) {
        case exports.Order.ORDER_NONE_UNSPECIFIED:
            return "ORDER_NONE_UNSPECIFIED";
        case exports.Order.ORDER_UNORDERED:
            return "ORDER_UNORDERED";
        case exports.Order.ORDER_ORDERED:
            return "ORDER_ORDERED";
        case exports.Order.UNRECOGNIZED:
        default:
            return "UNRECOGNIZED";
    }
}
...
exports.Channel = {
    ...
    fromPartial: function (object) {
        ...
        message.upgradeSequence = (_e = object.upgradeSequence) !== null && _e !== void 0 ? _e : "0";
        return message;
    },
};
...
exports.IdentifiedChannel = {
    ...
    fromPartial: function (object) {
        ...
        message.upgradeSequence = (_g = object.upgradeSequence) !== null && _g !== void 0 ? _g : "0";
        return message;
    },
};
...
exports.Params = {
    ...
    toJSON: function (message) {
        ...
        message.upgradeTimeout !== undefined &&
            (obj.upgradeTimeout = message.upgradeTimeout ? exports.Timeout.toJSON(message.upgradeTimeout) : undefined);
        return obj;
    },
    create: function (base) {
