...
export declare const ResponseResultType: {
    ...
    readonly RESPONSE_RESULT_TYPE_UNSPECIFIED: 0;
    /** RESPONSE_RESULT_TYPE_NOOP - The message did not call the IBC application callbacks (because, for example, the packet had already been relayed) */
    readonly RESPONSE_RESULT_TYPE_NOOP: 1;
    /** RESPONSE_RESULT_TYPE_SUCCESS - The message was executed successfully */
    readonly RESPONSE_RESULT_TYPE_SUCCESS: 2;
    /** RESPONSE_RESULT_TYPE_FAILURE - The message was executed unsuccessfully */
    readonly RESPONSE_RESULT_TYPE_FAILURE: 3;
    readonly UNRECOGNIZED: -1;
};
export type ResponseResultType = typeof ResponseResultType[keyof typeof ResponseResultType];
