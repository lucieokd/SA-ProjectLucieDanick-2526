...
exports.ConnectionEnd = {
    encode: function (message, writer) {
        ...
        try {
            for (var _b = __values(message.versions), _c = _b.next(); !_c.done; _c = _b.next()) {
                var v = _c.value;
    ...
    fromJSON: function (object) {
        return {
            ...
            versions: Array.isArray(object === null || object === void 0 ? void 0 : object.versions) ? object.versions.map(function (e) { return exports.Version.fromJSON(e); }) : [],
    ...
    toJSON: function (message) {
        ...
        if (message.versions) {
            obj.versions = message.versions.map(function (e) { return e ? exports.Version.toJSON(e) : undefined; });
        }
        else {
            obj.versions = [];
        }
    ...
    fromPartial: function (object) {
        ...
        message.versions = ((_b = object.versions) === null || _b === void 0 ? void 0 : _b.map(function (e) { return exports.Version.fromPartial(e); })) || [];
...
exports.IdentifiedConnection = {
    ...
    fromPartial: function (object) {
        ...
        message.versions = ((_c = object.versions) === null || _c === void 0 ? void 0 : _c.map(function (e) { return exports.Version.fromPartial(e); })) || [];
...
exports.ClientPaths = {
    encode: function (message, writer) {
        ...
        if (writer === void 0) { writer = minimal_js_1.default.Writer.create(); }
        try {
            for (var _b = __values(message.paths), _c = _b.next(); !_c.done; _c = _b.next()) {
                var v = _c.value;
    ...
    fromJSON: function (object) {
        return { paths: Array.isArray(object === null || object === void 0 ? void 0 : object.paths) ? object.paths.map(function (e) { return String(e); }) : [] };
    },
    toJSON: function (message) {
        var obj = {};
        if (message.paths) {
...
exports.Version = {
    encode: function (message, writer) {
        ...
        try {
            for (var _b = __values(message.features), _c = _b.next(); !_c.done; _c = _b.next()) {
                var v = _c.value;
                writer.uint32(18).string(v);
            }
        }
    ...
    fromJSON: function (object) {
        return {
            ...
            features: Array.isArray(object === null || object === void 0 ? void 0 : object.features) ? object.features.map(function (e) { return String(e); }) : [],
        };
    },
    toJSON: function (message) {
        var obj = {};
