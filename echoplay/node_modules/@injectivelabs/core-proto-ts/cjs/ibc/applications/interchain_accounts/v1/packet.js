...
function typeFromJSON(object) {
    switch (object) {
        ...
        case "TYPE_EXECUTE_TX":
            return exports.Type.TYPE_EXECUTE_TX;
        case -1:
        case "UNRECOGNIZED":
        default:
            return exports.Type.UNRECOGNIZED;
    }
}
function typeToJSON(object) {
    switch (object) {
        case exports.Type.TYPE_UNSPECIFIED:
            return "TYPE_UNSPECIFIED";
        case exports.Type.TYPE_EXECUTE_TX:
            return "TYPE_EXECUTE_TX";
        case exports.Type.UNRECOGNIZED:
        default:
            return "UNRECOGNIZED";
    }
}
...
exports.CosmosTx = {
    ...
    fromJSON: function (object) {
        return { messages: Array.isArray(object === null || object === void 0 ? void 0 : object.messages) ? object.messages.map(function (e) { return any_1.Any.fromJSON(e); }) : [] };
    },
    toJSON: function (message) {
        var obj = {};
        if (message.messages) {
