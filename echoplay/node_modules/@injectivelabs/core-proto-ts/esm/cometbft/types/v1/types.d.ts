...
export declare const SignedMsgType: {
    /** SIGNED_MSG_TYPE_UNKNOWN - Unknown */
    readonly SIGNED_MSG_TYPE_UNKNOWN: 0;
    /** SIGNED_MSG_TYPE_PREVOTE - Prevote */
    readonly SIGNED_MSG_TYPE_PREVOTE: 1;
    /** SIGNED_MSG_TYPE_PRECOMMIT - Precommit */
    readonly SIGNED_MSG_TYPE_PRECOMMIT: 2;
    /** SIGNED_MSG_TYPE_PROPOSAL - Proposal */
    readonly SIGNED_MSG_TYPE_PROPOSAL: 32;
    readonly UNRECOGNIZED: -1;
};
export type SignedMsgType = typeof SignedMsgType[keyof typeof SignedMsgType];
