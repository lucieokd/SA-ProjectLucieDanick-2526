...
export declare const ProcessProposalStatus: {
    /** PROCESS_PROPOSAL_STATUS_UNKNOWN - Unknown */
    readonly PROCESS_PROPOSAL_STATUS_UNKNOWN: 0;
    /** PROCESS_PROPOSAL_STATUS_ACCEPT - Accepted */
    readonly PROCESS_PROPOSAL_STATUS_ACCEPT: 1;
    /** PROCESS_PROPOSAL_STATUS_REJECT - Rejected */
    readonly PROCESS_PROPOSAL_STATUS_REJECT: 2;
    readonly UNRECOGNIZED: -1;
};
export type ProcessProposalStatus = typeof ProcessProposalStatus[keyof typeof ProcessProposalStatus];
...
export declare const VerifyVoteExtensionStatus: {
    /** VERIFY_VOTE_EXTENSION_STATUS_UNKNOWN - Unknown */
    readonly VERIFY_VOTE_EXTENSION_STATUS_UNKNOWN: 0;
    /** VERIFY_VOTE_EXTENSION_STATUS_ACCEPT - Accepted */
    readonly VERIFY_VOTE_EXTENSION_STATUS_ACCEPT: 1;
    /**
     ...
     */
    readonly VERIFY_VOTE_EXTENSION_STATUS_REJECT: 2;
    readonly UNRECOGNIZED: -1;
};
export type VerifyVoteExtensionStatus = typeof VerifyVoteExtensionStatus[keyof typeof VerifyVoteExtensionStatus];
...
export declare const MisbehaviorType: {
    /** MISBEHAVIOR_TYPE_UNKNOWN - Unknown */
    readonly MISBEHAVIOR_TYPE_UNKNOWN: 0;
    /** MISBEHAVIOR_TYPE_DUPLICATE_VOTE - Duplicate vote */
    readonly MISBEHAVIOR_TYPE_DUPLICATE_VOTE: 1;
    /** MISBEHAVIOR_TYPE_LIGHT_CLIENT_ATTACK - Light client attack */
    readonly MISBEHAVIOR_TYPE_LIGHT_CLIENT_ATTACK: 2;
    readonly UNRECOGNIZED: -1;
};
export type MisbehaviorType = typeof MisbehaviorType[keyof typeof MisbehaviorType];
