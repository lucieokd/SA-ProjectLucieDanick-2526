...
export declare const AccessType: {
    ...
    readonly ACCESS_TYPE_UNSPECIFIED: 0;
    /** ACCESS_TYPE_NOBODY - AccessTypeNobody forbidden */
    readonly ACCESS_TYPE_NOBODY: 1;
    /** ACCESS_TYPE_EVERYBODY - AccessTypeEverybody unrestricted */
    readonly ACCESS_TYPE_EVERYBODY: 3;
    /** ACCESS_TYPE_ANY_OF_ADDRESSES - AccessTypeAnyOfAddresses allow any of the addresses */
    readonly ACCESS_TYPE_ANY_OF_ADDRESSES: 4;
...
export declare const ContractCodeHistoryOperationType: {
...
export type ContractCodeHistoryOperationType = typeof ContractCodeHistoryOperationType[keyof typeof ContractCodeHistoryOperationType];
...
export declare const EventCodeStored: {
    ...
    decode(input: _m0.Reader | Uint8Array, length?: number): EventCodeStored;
    fromJSON(object: any): EventCodeStored;
    toJSON(message: EventCodeStored): unknown;
    create(base?: DeepPartial<EventCodeStored>): EventCodeStored;
    fromPartial(object: DeepPartial<EventCodeStored>): EventCodeStored;
};
export declare const EventContractInstantiated: {
    encode(message: EventContractInstantiated, writer?: _m0.Writer): _m0.Writer;
    decode(input: _m0.Reader | Uint8Array, length?: number): EventContractInstantiated;
    fromJSON(object: any): EventContractInstantiated;
    toJSON(message: EventContractInstantiated): unknown;
    create(base?: DeepPartial<EventContractInstantiated>): EventContractInstantiated;
    fromPartial(object: DeepPartial<EventContractInstantiated>): EventContractInstantiated;
};
export declare const EventContractMigrated: {
    encode(message: EventContractMigrated, writer?: _m0.Writer): _m0.Writer;
    decode(input: _m0.Reader | Uint8Array, length?: number): EventContractMigrated;
    fromJSON(object: any): EventContractMigrated;
    toJSON(message: EventContractMigrated): unknown;
    create(base?: DeepPartial<EventContractMigrated>): EventContractMigrated;
    fromPartial(object: DeepPartial<EventContractMigrated>): EventContractMigrated;
};
export declare const EventContractAdminSet: {
    encode(message: EventContractAdminSet, writer?: _m0.Writer): _m0.Writer;
    decode(input: _m0.Reader | Uint8Array, length?: number): EventContractAdminSet;
    fromJSON(object: any): EventContractAdminSet;
    toJSON(message: EventContractAdminSet): unknown;
    create(base?: DeepPartial<EventContractAdminSet>): EventContractAdminSet;
    fromPartial(object: DeepPartial<EventContractAdminSet>): EventContractAdminSet;
};
