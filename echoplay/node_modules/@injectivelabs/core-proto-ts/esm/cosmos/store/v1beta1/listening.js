...
export const BlockMetadata = {
    encode(message, writer = _m0.Writer.create()) {
        if (message.responseCommit !== undefined) {
            CommitResponse.encode(message.responseCommit, writer.uint32(50).fork()).ldelim();
        }
        if (message.requestFinalizeBlock !== undefined) {
            FinalizeBlockRequest.encode(message.requestFinalizeBlock, writer.uint32(58).fork()).ldelim();
        }
        if (message.responseFinalizeBlock !== undefined) {
            FinalizeBlockResponse.encode(message.responseFinalizeBlock, writer.uint32(66).fork()).ldelim();
        }
        return writer;
    },
    decode(input, length) {
    ...
    toJSON(message) {
        ...
        message.responseCommit !== undefined &&
            (obj.responseCommit = message.responseCommit ? CommitResponse.toJSON(message.responseCommit) : undefined);
        message.requestFinalizeBlock !== undefined && (obj.requestFinalizeBlock = message.requestFinalizeBlock
            ? FinalizeBlockRequest.toJSON(message.requestFinalizeBlock)
            : undefined);
        message.responseFinalizeBlock !== undefined && (obj.responseFinalizeBlock = message.responseFinalizeBlock
            ? FinalizeBlockResponse.toJSON(message.responseFinalizeBlock)
            : undefined);
        return obj;
    },
    create(base) {
