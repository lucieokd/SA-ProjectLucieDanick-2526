...
import { CommitResponse, FinalizeBlockRequest, FinalizeBlockResponse } from "../../../../cometbft/abci/v1/types.js";
...
export const ListenFinalizeBlockRequest = {
    encode(message, writer = _m0.Writer.create()) {
        if (message.req !== undefined) {
            FinalizeBlockRequest.encode(message.req, writer.uint32(10).fork()).ldelim();
        }
        if (message.res !== undefined) {
            FinalizeBlockResponse.encode(message.res, writer.uint32(18).fork()).ldelim();
        }
        return writer;
    },
    decode(input, length) {
    ...
    toJSON(message) {
        const obj = {};
        message.req !== undefined && (obj.req = message.req ? FinalizeBlockRequest.toJSON(message.req) : undefined);
        message.res !== undefined && (obj.res = message.res ? FinalizeBlockResponse.toJSON(message.res) : undefined);
        return obj;
    },
    create(base) {
...
export const ListenCommitRequest = {
    encode(message, writer = _m0.Writer.create()) {
        ...
        if (message.res !== undefined) {
            CommitResponse.encode(message.res, writer.uint32(18).fork()).ldelim();
        }
    ...
    toJSON(message) {
        ...
        message.res !== undefined && (obj.res = message.res ? CommitResponse.toJSON(message.res) : undefined);
