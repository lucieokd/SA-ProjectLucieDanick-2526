...
export declare const HashOp: {
    /** NO_HASH - NO_HASH is the default if no data passed. Note this is an illegal argument some places. */
    readonly NO_HASH: 0;
    readonly SHA256: 1;
    readonly SHA512: 2;
    readonly KECCAK256: 3;
    readonly RIPEMD160: 4;
    /** BITCOIN - ripemd160(sha256(x)) */
    readonly BITCOIN: 5;
    readonly SHA512_256: 6;
    readonly BLAKE2B_512: 7;
    readonly BLAKE2S_256: 8;
    readonly BLAKE3: 9;
    readonly UNRECOGNIZED: -1;
};
export type HashOp = typeof HashOp[keyof typeof HashOp];
 ...
 */
export declare const LengthOp: {
    /** NO_PREFIX - NO_PREFIX don't include any length info */
    readonly NO_PREFIX: 0;
    /** VAR_PROTO - VAR_PROTO uses protobuf (and go-amino) varint encoding of the length */
    readonly VAR_PROTO: 1;
    /** VAR_RLP - VAR_RLP uses rlp int encoding of the length */
    readonly VAR_RLP: 2;
    /** FIXED32_BIG - FIXED32_BIG uses big-endian encoding of the length as a 32 bit integer */
    readonly FIXED32_BIG: 3;
    /** FIXED32_LITTLE - FIXED32_LITTLE uses little-endian encoding of the length as a 32 bit integer */
    readonly FIXED32_LITTLE: 4;
    /** FIXED64_BIG - FIXED64_BIG uses big-endian encoding of the length as a 64 bit integer */
    readonly FIXED64_BIG: 5;
    /** FIXED64_LITTLE - FIXED64_LITTLE uses little-endian encoding of the length as a 64 bit integer */
    readonly FIXED64_LITTLE: 6;
    /** REQUIRE_32_BYTES - REQUIRE_32_BYTES is like NONE, but will fail if the input is not exactly 32 bytes (sha256 output) */
    readonly REQUIRE_32_BYTES: 7;
    /** REQUIRE_64_BYTES - REQUIRE_64_BYTES is like NONE, but will fail if the input is not exactly 64 bytes (sha512 output) */
    readonly REQUIRE_64_BYTES: 8;
    readonly UNRECOGNIZED: -1;
};
export type LengthOp = typeof LengthOp[keyof typeof LengthOp];
