...
import { Delegation, Params, Redelegation, UnbondingDelegation, Validator } from "./staking.js";
...
export const GenesisState = {
    encode(message, writer = _m0.Writer.create()) {
        ...
        for (const v of message.allowedDelegationTransferReceivers) {
    ...
    fromJSON(object) {
        return {
            ...
            allowedDelegationTransferReceivers: Array.isArray(object?.allowedDelegationTransferReceivers)
                ? object.allowedDelegationTransferReceivers.map((e) => String(e))
                : [],
        };
    },
    toJSON(message) {
        ...
        if (message.allowedDelegationTransferReceivers) {
            obj.allowedDelegationTransferReceivers = message.allowedDelegationTransferReceivers.map((e) => e);
        }
        else {
    ...
    fromPartial(object) {
        ...
        message.allowedDelegationTransferReceivers = object.allowedDelegationTransferReceivers?.map((e) => e) || [];
        return message;
    },
};
