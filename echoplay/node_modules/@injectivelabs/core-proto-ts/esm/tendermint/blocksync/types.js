...
import { ExtendedCommit } from "../types/types.js";
...
export const BlockResponse = {
    encode(message, writer = _m0.Writer.create()) {
        ...
        if (message.extCommit !== undefined) {
            ExtendedCommit.encode(message.extCommit, writer.uint32(18).fork()).ldelim();
        }
        return writer;
    },
    decode(input, length) {
    ...
    toJSON(message) {
        ...
        message.extCommit !== undefined &&
            (obj.extCommit = message.extCommit ? ExtendedCommit.toJSON(message.extCommit) : undefined);
        return obj;
    },
    create(base) {
