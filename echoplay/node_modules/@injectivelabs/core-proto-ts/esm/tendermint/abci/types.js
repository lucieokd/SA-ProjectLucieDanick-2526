...
export const CheckTxType = { NEW: 0, RECHECK: 1, UNRECOGNIZED: -1 };
...
export const MisbehaviorType = { UNKNOWN: 0, DUPLICATE_VOTE: 1, LIGHT_CLIENT_ATTACK: 2, UNRECOGNIZED: -1 };
...
export const ResponseOfferSnapshot_Result = {
...
export const ResponseApplySnapshotChunk_Result = {
    /** UNKNOWN - Unknown result, abort all snapshot restoration */
    UNKNOWN: 0,
...
export const ResponseProcessProposal_ProposalStatus = { UNKNOWN: 0, ACCEPT: 1, REJECT: 2, UNRECOGNIZED: -1 };
...
export const ResponseVerifyVoteExtension_VerifyStatus = {
    UNKNOWN: 0,
    ACCEPT: 1,
    /**
