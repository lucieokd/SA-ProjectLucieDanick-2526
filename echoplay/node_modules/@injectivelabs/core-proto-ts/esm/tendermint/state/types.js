...
import { Event, ExecTxResult, ResponseFinalizeBlock, ValidatorUpdate } from "../abci/types.js";
...
export const ABCIResponsesInfo = {
    encode(message, writer = _m0.Writer.create()) {
        ...
        if (message.responseFinalizeBlock !== undefined) {
            ResponseFinalizeBlock.encode(message.responseFinalizeBlock, writer.uint32(26).fork()).ldelim();
        }
        return writer;
    },
    decode(input, length) {
