 ...
 */
export interface GenericExchangeAuthorization {
...
export declare const GenericExchangeAuthorization: {
    encode(message: GenericExchangeAuthorization, writer?: _m0.Writer): _m0.Writer;
    decode(input: _m0.Reader | Uint8Array, length?: number): GenericExchangeAuthorization;
    fromJSON(object: any): GenericExchangeAuthorization;
    toJSON(message: GenericExchangeAuthorization): unknown;
    create(base?: DeepPartial<GenericExchangeAuthorization>): GenericExchangeAuthorization;
    fromPartial(object: DeepPartial<GenericExchangeAuthorization>): GenericExchangeAuthorization;
};
