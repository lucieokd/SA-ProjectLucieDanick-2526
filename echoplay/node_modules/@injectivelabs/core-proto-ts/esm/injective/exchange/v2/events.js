...
import { AccountRewards, CampaignRewardPool, DepositUpdate, DerivativePosition, DerivativeTradeLog, executionTypeFromJSON, executionTypeToJSON, FeeDiscountSchedule, GrantAuthorization, Level, SubaccountPosition, TradeLog, TradingRewardCampaignInfo, } from "./exchange.js";
import { BinaryOptionsMarket, DerivativeMarket, ExpiryFuturesMarketInfo, MarketFeeMultiplier, PerpetualMarketFunding, PerpetualMarketInfo, SpotMarket, } from "./market.js";
import { DerivativeLimitOrder, DerivativeMarketOrder, DerivativeOrder, SpotLimitOrder } from "./order.js";
...
export const EventSettledMarketBalance = {
    ...
    create(base) {
        return EventSettledMarketBalance.fromPartial(base ?? {});
    },
    fromPartial(object) {
        const message = createBaseEventSettledMarketBalance();
        message.marketId = object.marketId ?? "";
...
export const EventNotSettledMarketBalance = {
    ...
    create(base) {
        return EventNotSettledMarketBalance.fromPartial(base ?? {});
    },
    fromPartial(object) {
        const message = createBaseEventNotSettledMarketBalance();
        message.marketId = object.marketId ?? "";
...
export const EventDerivativeOrdersV2Migration = {
    encode(message, writer = _m0.Writer.create()) {
        if (message.marketId !== "") {
            writer.uint32(10).string(message.marketId);
        }
        for (const v of message.buyOrderChanges) {
            DerivativeOrderV2Changes.encode(v, writer.uint32(18).fork()).ldelim();
        }
        for (const v of message.sellOrderChanges) {
            DerivativeOrderV2Changes.encode(v, writer.uint32(26).fork()).ldelim();
        }
        return writer;
    },
    decode(input, length) {
        const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = createBaseEventDerivativeOrdersV2Migration();
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
                    ...
                    break;
                case 2:
                    message.buyOrderChanges.push(DerivativeOrderV2Changes.decode(reader, reader.uint32()));
                    break;
                case 3:
                    message.sellOrderChanges.push(DerivativeOrderV2Changes.decode(reader, reader.uint32()));
                    break;
                default:
                    reader.skipType(tag & 7);
                    break;
    ...
    fromJSON(object) {
        return {
            marketId: isSet(object.marketId) ? String(object.marketId) : "",
            buyOrderChanges: Array.isArray(object?.buyOrderChanges)
                ? object.buyOrderChanges.map((e) => DerivativeOrderV2Changes.fromJSON(e))
                : [],
            sellOrderChanges: Array.isArray(object?.sellOrderChanges)
                ? object.sellOrderChanges.map((e) => DerivativeOrderV2Changes.fromJSON(e))
                : [],
        };
    },
    toJSON(message) {
        ...
        if (message.buyOrderChanges) {
            obj.buyOrderChanges = message.buyOrderChanges.map((e) => e ? DerivativeOrderV2Changes.toJSON(e) : undefined);
        }
        else {
            obj.buyOrderChanges = [];
        }
        if (message.sellOrderChanges) {
            obj.sellOrderChanges = message.sellOrderChanges.map((e) => e ? DerivativeOrderV2Changes.toJSON(e) : undefined);
        }
        else {
    ...
    create(base) {
        return EventDerivativeOrdersV2Migration.fromPartial(base ?? {});
    },
    fromPartial(object) {
        const message = createBaseEventDerivativeOrdersV2Migration();
        message.marketId = object.marketId ?? "";
        message.buyOrderChanges = object.buyOrderChanges?.map((e) => DerivativeOrderV2Changes.fromPartial(e)) || [];
        message.sellOrderChanges = object.sellOrderChanges?.map((e) => DerivativeOrderV2Changes.fromPartial(e)) || [];
        return message;
    },
};
...
export const DerivativeOrderV2Changes = {
    encode(message, writer = _m0.Writer.create()) {
        if (message.cid !== "") {
    ...
    decode(input, length) {
        const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = createBaseDerivativeOrderV2Changes();
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
    ...
    create(base) {
        return DerivativeOrderV2Changes.fromPartial(base ?? {});
    },
    fromPartial(object) {
        const message = createBaseDerivativeOrderV2Changes();
        message.cid = object.cid ?? "";
...
export const EventSpotOrdersV2Migration = {
    encode(message, writer = _m0.Writer.create()) {
        if (message.marketId !== "") {
            writer.uint32(10).string(message.marketId);
        }
        for (const v of message.buyOrderChanges) {
            SpotOrderV2Changes.encode(v, writer.uint32(18).fork()).ldelim();
        }
        for (const v of message.sellOrderChanges) {
            SpotOrderV2Changes.encode(v, writer.uint32(26).fork()).ldelim();
        }
        return writer;
    },
    decode(input, length) {
        const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = createBaseEventSpotOrdersV2Migration();
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
                    ...
                    break;
                case 2:
                    message.buyOrderChanges.push(SpotOrderV2Changes.decode(reader, reader.uint32()));
                    break;
                case 3:
                    message.sellOrderChanges.push(SpotOrderV2Changes.decode(reader, reader.uint32()));
                    break;
                default:
                    reader.skipType(tag & 7);
                    break;
    ...
    fromJSON(object) {
        return {
            marketId: isSet(object.marketId) ? String(object.marketId) : "",
            buyOrderChanges: Array.isArray(object?.buyOrderChanges)
                ? object.buyOrderChanges.map((e) => SpotOrderV2Changes.fromJSON(e))
                : [],
            sellOrderChanges: Array.isArray(object?.sellOrderChanges)
                ? object.sellOrderChanges.map((e) => SpotOrderV2Changes.fromJSON(e))
                : [],
        };
    },
    toJSON(message) {
        ...
        message.marketId !== undefined && (obj.marketId = message.marketId);
        if (message.buyOrderChanges) {
            obj.buyOrderChanges = message.buyOrderChanges.map((e) => e ? SpotOrderV2Changes.toJSON(e) : undefined);
        }
        else {
            obj.buyOrderChanges = [];
        }
        if (message.sellOrderChanges) {
            obj.sellOrderChanges = message.sellOrderChanges.map((e) => e ? SpotOrderV2Changes.toJSON(e) : undefined);
        }
        else {
            obj.sellOrderChanges = [];
        }
    ...
    create(base) {
        return EventSpotOrdersV2Migration.fromPartial(base ?? {});
    },
    fromPartial(object) {
        const message = createBaseEventSpotOrdersV2Migration();
        message.marketId = object.marketId ?? "";
        message.buyOrderChanges = object.buyOrderChanges?.map((e) => SpotOrderV2Changes.fromPartial(e)) || [];
        message.sellOrderChanges = object.sellOrderChanges?.map((e) => SpotOrderV2Changes.fromPartial(e)) || [];
        return message;
    },
};
...
export const EventTriggerConditionalMarketOrderFailed = {
    encode(message, writer = _m0.Writer.create()) {
        if (message.marketId !== "") {
            writer.uint32(10).string(message.marketId);
        }
    ...
    decode(input, length) {
        const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = createBaseEventTriggerConditionalMarketOrderFailed();
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
    ...
    create(base) {
        return EventTriggerConditionalMarketOrderFailed.fromPartial(base ?? {});
    },
    fromPartial(object) {
        const message = createBaseEventTriggerConditionalMarketOrderFailed();
        message.marketId = object.marketId ?? "";
        ...
        message.triggerErr = object.triggerErr ?? "";
        return message;
    },
};
...
export const EventTriggerConditionalLimitOrderFailed = {
    encode(message, writer = _m0.Writer.create()) {
        if (message.marketId !== "") {
            writer.uint32(10).string(message.marketId);
        }
    ...
    decode(input, length) {
        const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = createBaseEventTriggerConditionalLimitOrderFailed();
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
    ...
    create(base) {
        return EventTriggerConditionalLimitOrderFailed.fromPartial(base ?? {});
    },
    fromPartial(object) {
        const message = createBaseEventTriggerConditionalLimitOrderFailed();
        message.marketId = object.marketId ?? "";
...
export const SpotOrderV2Changes = {
    encode(message, writer = _m0.Writer.create()) {
        if (message.cid !== "") {
            writer.uint32(10).string(message.cid);
        }
    ...
    decode(input, length) {
        const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = createBaseSpotOrderV2Changes();
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
    ...
    create(base) {
        return SpotOrderV2Changes.fromPartial(base ?? {});
    },
    fromPartial(object) {
        const message = createBaseSpotOrderV2Changes();
        message.cid = object.cid ?? "";
...
export const EventDerivativePositionV2Migration = {
    encode(message, writer = _m0.Writer.create()) {
    ...
    decode(input, length) {
        const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = createBaseEventDerivativePositionV2Migration();
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
    ...
    fromJSON(object) {
        return { position: isSet(object.position) ? DerivativePosition.fromJSON(object.position) : undefined };
    },
    toJSON(message) {
        const obj = {};
    ...
    create(base) {
        return EventDerivativePositionV2Migration.fromPartial(base ?? {});
    },
    fromPartial(object) {
        const message = createBaseEventDerivativePositionV2Migration();
