...
import { CampaignRewardPool, DenomDecimals, DenomMinNotional, FeeDiscountSchedule, TradingRewardCampaignInfo } from "./exchange";
import { MarketFeeMultiplier, MarketStatus } from "./market";
export declare const protobufPackage = "injective.exchange.v2";
export declare const ExchangeType: {
    readonly EXCHANGE_UNSPECIFIED: 0;
    readonly SPOT: 1;
