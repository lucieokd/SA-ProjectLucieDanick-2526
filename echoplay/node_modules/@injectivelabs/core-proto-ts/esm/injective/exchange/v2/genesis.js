...
import { ActiveGrant, AggregateSubaccountVolumeRecord, Balance, CampaignRewardPool, DenomDecimals, DenomMinNotional, DerivativePosition, FeeDiscountSchedule, FeeDiscountTierTTL, GrantAuthorization, Params, SubaccountTradeNonce, TradeRecords, TradingRewardCampaignInfo, } from "./exchange.js";
import { BinaryOptionsMarket, DerivativeMarket, DerivativeMarketSettlementInfo, ExpiryFuturesMarketInfoState, MarketFeeMultiplier, MarketVolume, PerpetualMarketFundingState, PerpetualMarketInfo, SpotMarket, } from "./market.js";
import { ConditionalDerivativeOrderBook, DerivativeOrderBook, SpotOrderBook } from "./orderbook.js";
...
export const GenesisState = {
    encode(message, writer = _m0.Writer.create()) {
        ...
        for (const v of message.denomMinNotionals) {
            DenomMinNotional.encode(v, writer.uint32(298).fork()).ldelim();
        }
        return writer;
    },
    decode(input, length) {
