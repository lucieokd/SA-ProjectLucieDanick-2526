...
import { ActiveGrant, AggregateAccountVolumeRecord, Balance, CampaignRewardPool, DenomDecimals, DenomMinNotional, Deposit, DerivativePosition, EffectiveGrant, FeeDiscountSchedule, FeeDiscountTierInfo, FeeDiscountTierTTL, GrantAuthorization, Level, MidPriceAndTOB, Params, Position, SubaccountOrderData, TradeRecord, TradeRecords, TradingRewardCampaignInfo, } from "./exchange.js";
import { GenesisState } from "./genesis.js";
import { BinaryOptionsMarket, DerivativeMarket, ExpiryFuturesMarketInfo, MarketVolume, PerpetualMarketFunding, PerpetualMarketInfo, SpotMarket, VolumeRecord, } from "./market.js";
import { SubaccountOrderbookMetadata } from "./orderbook.js";
...
export const CancellationStrategy = {
...
export const QueryPositionsInMarketRequest = {
    encode(message, writer = _m0.Writer.create()) {
        if (message.marketId !== "") {
            writer.uint32(10).string(message.marketId);
        }
    ...
    decode(input, length) {
        const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = createBaseQueryPositionsInMarketRequest();
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
    ...
    create(base) {
        return QueryPositionsInMarketRequest.fromPartial(base ?? {});
    },
    fromPartial(object) {
        const message = createBaseQueryPositionsInMarketRequest();
        message.marketId = object.marketId ?? "";
...
export const QueryPositionsInMarketResponse = {
    encode(message, writer = _m0.Writer.create()) {
    ...
    decode(input, length) {
        const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = createBaseQueryPositionsInMarketResponse();
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
    ...
    create(base) {
        return QueryPositionsInMarketResponse.fromPartial(base ?? {});
    },
    fromPartial(object) {
        const message = createBaseQueryPositionsInMarketResponse();
...
export const QueryMarketBalanceResponse = {
    ...
    fromJSON(object) {
        return { balance: isSet(object.balance) ? MarketBalance.fromJSON(object.balance) : undefined };
    },
    toJSON(message) {
        const obj = {};
        message.balance !== undefined &&
            (obj.balance = message.balance ? MarketBalance.toJSON(message.balance) : undefined);
        return obj;
    },
    create(base) {
    ...
    fromPartial(object) {
        ...
        message.balance = (object.balance !== undefined && object.balance !== null)
            ? MarketBalance.fromPartial(object.balance)
            : undefined;
        return message;
    },
};
...
export class QueryClientImpl {
    ...
    PositionsInMarket(request, metadata) {
        return this.rpc.unary(QueryPositionsInMarketDesc, QueryPositionsInMarketRequest.fromPartial(request), metadata);
    }
...
export const QueryDesc = { serviceName: "injective.exchange.v2.Query" };
...
export const QueryPositionsInMarketDesc = {
    ...
    requestType: {
        serializeBinary() {
            return QueryPositionsInMarketRequest.encode(this).finish();
        },
    },
    responseType: {
        deserializeBinary(data) {
            const value = QueryPositionsInMarketResponse.decode(data);
            return {
                ...value,
                toObject() {
                    return value;
