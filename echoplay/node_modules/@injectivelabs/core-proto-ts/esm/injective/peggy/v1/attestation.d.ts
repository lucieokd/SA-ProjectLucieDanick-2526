...
export declare const protobufPackage = "injective.peggy.v1";
/**
 * ClaimType is the cosmos type of an event from the counterpart chain that can
 * be handled
 */
export declare const ClaimType: {
    readonly CLAIM_TYPE_UNKNOWN: 0;
    readonly CLAIM_TYPE_DEPOSIT: 1;
    readonly CLAIM_TYPE_WITHDRAW: 2;
    readonly CLAIM_TYPE_ERC20_DEPLOYED: 3;
    readonly CLAIM_TYPE_VALSET_UPDATED: 4;
