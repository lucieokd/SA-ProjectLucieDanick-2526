...
import { Deposit, Level, PositionDelta } from "../../exchange/v2/exchange.js";
import { DerivativeLimitOrder, SpotLimitOrder } from "../../exchange/v2/order.js";
export const protobufPackage = "injective.stream.v2";
export const OrderUpdateStatus = { Unspecified: 0, Booked: 1, Matched: 2, Cancelled: 3, UNRECOGNIZED: -1 };
...
export class StreamClientImpl {
    ...
    StreamV2(request, metadata) {
        return this.rpc.invoke(StreamStreamV2Desc, StreamRequest.fromPartial(request), metadata);
    }
}
export const StreamDesc = { serviceName: "injective.stream.v2.Stream" };
export const StreamStreamV2Desc = {
    methodName: "StreamV2",
    service: StreamDesc,
    requestStream: false,
    responseStream: true,
