...
export declare const FeatureSet_StringFieldValidation: {
    readonly STRING_FIELD_VALIDATION_UNKNOWN: 0;
    readonly MANDATORY: 1;
    readonly HINT: 2;
    readonly NONE: 3;
    readonly UNRECOGNIZED: -1;
};
export type FeatureSet_StringFieldValidation = typeof FeatureSet_StringFieldValidation[keyof typeof FeatureSet_StringFieldValidation];
export declare function featureSet_StringFieldValidationFromJSON(object: any): FeatureSet_StringFieldValidation;
export declare function featureSet_StringFieldValidationToJSON(object: FeatureSet_StringFieldValidation): string;
