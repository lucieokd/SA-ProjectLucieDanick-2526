...
export const FeatureSet_EnumType = { ENUM_TYPE_UNKNOWN: 0, OPEN: 1, CLOSED: 2, UNRECOGNIZED: -1 };
...
export const FeatureSet_StringFieldValidation = {
...
export const FeatureSet = {
    ...
    toJSON(message) {
        ...
        message.stringFieldValidation !== undefined &&
        ...
        message.rawFeatures !== undefined &&
            (obj.rawFeatures = message.rawFeatures ? FeatureSet.toJSON(message.rawFeatures) : undefined);
        return obj;
    },
    create(base) {
