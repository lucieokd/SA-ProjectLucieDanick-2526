...
exports.GrpcWebError = exports.GrpcWebImpl = exports.InjectiveTradingRPCStreamStrategyDesc = exports.InjectiveTradingRPCGetTradingStatsDesc = exports.InjectiveTradingRPCListTradingStrategiesDesc = exports.InjectiveTradingRPCDesc = exports.InjectiveTradingRPCClientImpl = exports.StreamStrategyResponse = exports.StreamStrategyRequest = exports.Market = exports.GetTradingStatsResponse = exports.GetTradingStatsRequest = exports.Paging = exports.StrategyFinalData = exports.ExitConfig = exports.TradingStrategy = exports.ListTradingStrategiesResponse = exports.ListTradingStrategiesRequest = exports.protobufPackage = void 0;
/* eslint-disable */
...
exports.TradingStrategy = {
    encode(message, writer = minimal_js_1.default.Writer.create()) {
        ...
        if (message.finalData !== undefined) {
            exports.StrategyFinalData.encode(message.finalData, writer.uint32(410).fork()).ldelim();
        }
        if (message.marginRatio !== "") {
            writer.uint32(418).string(message.marginRatio);
        }
        if (message.lowerTrailingBound !== "") {
            writer.uint32(426).string(message.lowerTrailingBound);
        }
        if (message.upperTrailingBound !== "") {
            writer.uint32(434).string(message.upperTrailingBound);
        }
        if (message.newUpperBound !== "") {
            writer.uint32(442).string(message.newUpperBound);
        }
        if (message.newLowerBound !== "") {
            writer.uint32(450).string(message.newLowerBound);
        }
        return writer;
    },
    decode(input, length) {
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                ...
                case 50:
                    ...
                    break;
                case 51:
                    message.finalData = exports.StrategyFinalData.decode(reader, reader.uint32());
                    break;
                case 52:
    ...
    fromJSON(object) {
        return {
            ...
            finalData: isSet(object.finalData) ? exports.StrategyFinalData.fromJSON(object.finalData) : undefined,
            marginRatio: isSet(object.marginRatio) ? String(object.marginRatio) : "",
            lowerTrailingBound: isSet(object.lowerTrailingBound) ? String(object.lowerTrailingBound) : "",
            upperTrailingBound: isSet(object.upperTrailingBound) ? String(object.upperTrailingBound) : "",
            newUpperBound: isSet(object.newUpperBound) ? String(object.newUpperBound) : "",
            newLowerBound: isSet(object.newLowerBound) ? String(object.newLowerBound) : "",
        };
    },
    toJSON(message) {
        const obj = {};
        ...
        message.finalData !== undefined &&
            (obj.finalData = message.finalData ? exports.StrategyFinalData.toJSON(message.finalData) : undefined);
        message.marginRatio !== undefined && (obj.marginRatio = message.marginRatio);
        message.lowerTrailingBound !== undefined && (obj.lowerTrailingBound = message.lowerTrailingBound);
        message.upperTrailingBound !== undefined && (obj.upperTrailingBound = message.upperTrailingBound);
        message.newUpperBound !== undefined && (obj.newUpperBound = message.newUpperBound);
        message.newLowerBound !== undefined && (obj.newLowerBound = message.newLowerBound);
        return obj;
    },
    create(base) {
    ...
    fromPartial(object) {
        ...
        message.finalData = (object.finalData !== undefined && object.finalData !== null)
            ? exports.StrategyFinalData.fromPartial(object.finalData)
            : undefined;
        message.marginRatio = (_24 = object.marginRatio) !== null && _24 !== void 0 ? _24 : "";
        message.lowerTrailingBound = (_25 = object.lowerTrailingBound) !== null && _25 !== void 0 ? _25 : "";
        message.upperTrailingBound = (_26 = object.upperTrailingBound) !== null && _26 !== void 0 ? _26 : "";
        message.newUpperBound = (_27 = object.newUpperBound) !== null && _27 !== void 0 ? _27 : "";
        message.newLowerBound = (_28 = object.newLowerBound) !== null && _28 !== void 0 ? _28 : "";
        return message;
    },
};
...
function createBaseStrategyFinalData() {
    return {
        initialBaseAmount: "",
        initialQuoteAmount: "",
        finalBaseAmount: "",
...
exports.StrategyFinalData = {
    encode(message, writer = minimal_js_1.default.Writer.create()) {
        if (message.initialBaseAmount !== "") {
            writer.uint32(10).string(message.initialBaseAmount);
        }
        if (message.initialQuoteAmount !== "") {
            writer.uint32(18).string(message.initialQuoteAmount);
        }
        if (message.finalBaseAmount !== "") {
            writer.uint32(26).string(message.finalBaseAmount);
        }
        if (message.finalQuoteAmount !== "") {
            writer.uint32(34).string(message.finalQuoteAmount);
        }
        if (message.initialBasePrice !== "") {
            writer.uint32(42).string(message.initialBasePrice);
        }
        if (message.initialQuotePrice !== "") {
            writer.uint32(50).string(message.initialQuotePrice);
        }
        if (message.finalBasePrice !== "") {
            writer.uint32(58).string(message.finalBasePrice);
        }
        if (message.finalQuotePrice !== "") {
            writer.uint32(66).string(message.finalQuotePrice);
        }
        return writer;
    },
    decode(input, length) {
        const reader = input instanceof minimal_js_1.default.Reader ? input : new minimal_js_1.default.Reader(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = createBaseStrategyFinalData();
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
    ...
    fromJSON(object) {
        return {
            initialBaseAmount: isSet(object.initialBaseAmount) ? String(object.initialBaseAmount) : "",
            initialQuoteAmount: isSet(object.initialQuoteAmount) ? String(object.initialQuoteAmount) : "",
            finalBaseAmount: isSet(object.finalBaseAmount) ? String(object.finalBaseAmount) : "",
            finalQuoteAmount: isSet(object.finalQuoteAmount) ? String(object.finalQuoteAmount) : "",
            initialBasePrice: isSet(object.initialBasePrice) ? String(object.initialBasePrice) : "",
            initialQuotePrice: isSet(object.initialQuotePrice) ? String(object.initialQuotePrice) : "",
            finalBasePrice: isSet(object.finalBasePrice) ? String(object.finalBasePrice) : "",
            finalQuotePrice: isSet(object.finalQuotePrice) ? String(object.finalQuotePrice) : "",
    ...
    toJSON(message) {
        const obj = {};
        message.initialBaseAmount !== undefined && (obj.initialBaseAmount = message.initialBaseAmount);
        message.initialQuoteAmount !== undefined && (obj.initialQuoteAmount = message.initialQuoteAmount);
        message.finalBaseAmount !== undefined && (obj.finalBaseAmount = message.finalBaseAmount);
        message.finalQuoteAmount !== undefined && (obj.finalQuoteAmount = message.finalQuoteAmount);
        message.initialBasePrice !== undefined && (obj.initialBasePrice = message.initialBasePrice);
        message.initialQuotePrice !== undefined && (obj.initialQuotePrice = message.initialQuotePrice);
        message.finalBasePrice !== undefined && (obj.finalBasePrice = message.finalBasePrice);
        message.finalQuotePrice !== undefined && (obj.finalQuotePrice = message.finalQuotePrice);
    ...
    create(base) {
        return exports.StrategyFinalData.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        var _a, _b, _c, _d, _e, _f, _g, _h;
        const message = createBaseStrategyFinalData();
        message.initialBaseAmount = (_a = object.initialBaseAmount) !== null && _a !== void 0 ? _a : "";
        message.initialQuoteAmount = (_b = object.initialQuoteAmount) !== null && _b !== void 0 ? _b : "";
        message.finalBaseAmount = (_c = object.finalBaseAmount) !== null && _c !== void 0 ? _c : "";
        message.finalQuoteAmount = (_d = object.finalQuoteAmount) !== null && _d !== void 0 ? _d : "";
        message.initialBasePrice = (_e = object.initialBasePrice) !== null && _e !== void 0 ? _e : "";
        message.initialQuotePrice = (_f = object.initialQuotePrice) !== null && _f !== void 0 ? _f : "";
        message.finalBasePrice = (_g = object.finalBasePrice) !== null && _g !== void 0 ? _g : "";
        message.finalQuotePrice = (_h = object.finalQuotePrice) !== null && _h !== void 0 ? _h : "";
        return message;
    },
};
...
function createBaseStreamStrategyRequest() {
    return { accountAddresses: [], marketId: "" };
}
exports.StreamStrategyRequest = {
    encode(message, writer = minimal_js_1.default.Writer.create()) {
    ...
    decode(input, length) {
        const reader = input instanceof minimal_js_1.default.Reader ? input : new minimal_js_1.default.Reader(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = createBaseStreamStrategyRequest();
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
    ...
    create(base) {
        return exports.StreamStrategyRequest.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        var _a, _b;
        const message = createBaseStreamStrategyRequest();
...
function createBaseStreamStrategyResponse() {
    return { tradingStrategy: undefined, timestamp: "0" };
}
exports.StreamStrategyResponse = {
    encode(message, writer = minimal_js_1.default.Writer.create()) {
        if (message.tradingStrategy !== undefined) {
            exports.TradingStrategy.encode(message.tradingStrategy, writer.uint32(10).fork()).ldelim();
        }
    ...
    decode(input, length) {
        const reader = input instanceof minimal_js_1.default.Reader ? input : new minimal_js_1.default.Reader(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = createBaseStreamStrategyResponse();
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
                    message.tradingStrategy = exports.TradingStrategy.decode(reader, reader.uint32());
                    break;
                case 2:
    ...
    fromJSON(object) {
        return {
            tradingStrategy: isSet(object.tradingStrategy) ? exports.TradingStrategy.fromJSON(object.tradingStrategy) : undefined,
            timestamp: isSet(object.timestamp) ? String(object.timestamp) : "0",
        };
    },
    toJSON(message) {
        const obj = {};
        message.tradingStrategy !== undefined &&
            (obj.tradingStrategy = message.tradingStrategy ? exports.TradingStrategy.toJSON(message.tradingStrategy) : undefined);
        message.timestamp !== undefined && (obj.timestamp = message.timestamp);
        return obj;
    },
    create(base) {
        return exports.StreamStrategyResponse.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        var _a;
        const message = createBaseStreamStrategyResponse();
        message.tradingStrategy = (object.tradingStrategy !== undefined && object.tradingStrategy !== null)
            ? exports.TradingStrategy.fromPartial(object.tradingStrategy)
            : undefined;
...
class InjectiveTradingRPCClientImpl {
    constructor(rpc) {
        ...
        this.StreamStrategy = this.StreamStrategy.bind(this);
    }
    ...
    StreamStrategy(request, metadata) {
        return this.rpc.invoke(exports.InjectiveTradingRPCStreamStrategyDesc, exports.StreamStrategyRequest.fromPartial(request), metadata);
    }
}
...
exports.InjectiveTradingRPCStreamStrategyDesc = {
    methodName: "StreamStrategy",
    service: exports.InjectiveTradingRPCDesc,
    requestStream: false,
    responseStream: true,
    requestType: {
        serializeBinary() {
            return exports.StreamStrategyRequest.encode(this).finish();
        },
    },
    responseType: {
        deserializeBinary(data) {
            const value = exports.StreamStrategyResponse.decode(data);
            return Object.assign(Object.assign({}, value), { toObject() {
                    return value;
                } });
        },
