...
export declare const MarketSnapshotRequest: {
    encode(message: MarketSnapshotRequest, writer?: _m0.Writer): _m0.Writer;
    decode(input: _m0.Reader | Uint8Array, length?: number): MarketSnapshotRequest;
    fromJSON(object: any): MarketSnapshotRequest;
    toJSON(message: MarketSnapshotRequest): unknown;
    create(base?: DeepPartial<MarketSnapshotRequest>): MarketSnapshotRequest;
    fromPartial(object: DeepPartial<MarketSnapshotRequest>): MarketSnapshotRequest;
};
export declare const MarketSnapshotResponse: {
    ...
    create(base?: DeepPartial<MarketSnapshotResponse>): MarketSnapshotResponse;
    fromPartial(object: DeepPartial<MarketSnapshotResponse>): MarketSnapshotResponse;
};
export declare const MarketSnapshotHistoryResponse: {
    encode(message: MarketSnapshotHistoryResponse, writer?: _m0.Writer): _m0.Writer;
    decode(input: _m0.Reader | Uint8Array, length?: number): MarketSnapshotHistoryResponse;
    fromJSON(object: any): MarketSnapshotHistoryResponse;
    toJSON(message: MarketSnapshotHistoryResponse): unknown;
    create(base?: DeepPartial<MarketSnapshotHistoryResponse>): MarketSnapshotHistoryResponse;
    fromPartial(object: DeepPartial<MarketSnapshotHistoryResponse>): MarketSnapshotHistoryResponse;
};
...
export interface InjectiveChartRPC {
    ...
    MarketSnapshot(request: DeepPartial<MarketSnapshotRequest>, metadata?: grpc.Metadata): Promise<MarketSnapshotResponse>;
}
...
export declare const InjectiveChartRPCMarketSnapshotDesc: UnaryMethodDefinitionish;
