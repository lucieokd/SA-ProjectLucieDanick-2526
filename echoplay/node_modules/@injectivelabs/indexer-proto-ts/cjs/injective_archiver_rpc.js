...
exports.GrpcWebError = exports.GrpcWebImpl = exports.InjectiveArchiverRPCStreamSpotAverageEntriesDesc = exports.InjectiveArchiverRPCHistoricalTradesDesc = exports.InjectiveArchiverRPCDenomHoldersDesc = exports.InjectiveArchiverRPCVolLeaderboardFixedResolutionDesc = exports.InjectiveArchiverRPCPnlLeaderboardFixedResolutionDesc = exports.InjectiveArchiverRPCVolLeaderboardDesc = exports.InjectiveArchiverRPCPnlLeaderboardDesc = exports.InjectiveArchiverRPCVolumesDesc = exports.InjectiveArchiverRPCRpnlDesc = exports.InjectiveArchiverRPCAccountStatsDesc = exports.InjectiveArchiverRPCBalanceDesc = exports.InjectiveArchiverRPCDesc = exports.InjectiveArchiverRPCClientImpl = exports.SpotAverageEntry = exports.StreamSpotAverageEntriesResponse = exports.StreamSpotAverageEntriesRequest = exports.PriceLevel = exports.HistoricalTrade = exports.HistoricalTradesResponse = exports.HistoricalTradesRequest = exports.Holder = exports.DenomHoldersResponse = exports.DenomHoldersRequest = exports.VolLeaderboardFixedResolutionResponse = exports.VolLeaderboardFixedResolutionRequest = exports.PnlLeaderboardFixedResolutionResponse = exports.PnlLeaderboardFixedResolutionRequest = exports.VolLeaderboardResponse = exports.VolLeaderboardRequest = exports.LeaderboardRow = exports.PnlLeaderboardResponse = exports.PnlLeaderboardRequest = exports.HistoricalVolumes = exports.VolumesResponse = exports.VolumesRequest = exports.HistoricalDetailedPNL = exports.HistoricalRPNL = exports.RpnlResponse = exports.RpnlRequest = exports.AccountStatsResponse = exports.AccountStatsRequest = exports.HistoricalBalance = exports.BalanceResponse = exports.BalanceRequest = exports.protobufPackage = void 0;
/* eslint-disable */
...
function createBaseAccountStatsRequest() {
    return { account: "" };
}
exports.AccountStatsRequest = {
    encode(message, writer = minimal_js_1.default.Writer.create()) {
        if (message.account !== "") {
            writer.uint32(10).string(message.account);
        }
    ...
    decode(input, length) {
        const reader = input instanceof minimal_js_1.default.Reader ? input : new minimal_js_1.default.Reader(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = createBaseAccountStatsRequest();
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
    ...
    create(base) {
        return exports.AccountStatsRequest.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        var _a;
        const message = createBaseAccountStatsRequest();
...
function createBaseAccountStatsResponse() {
    return { account: "", pnl: 0, volume: 0 };
}
exports.AccountStatsResponse = {
    encode(message, writer = minimal_js_1.default.Writer.create()) {
        if (message.account !== "") {
            writer.uint32(10).string(message.account);
        }
    ...
    decode(input, length) {
        const reader = input instanceof minimal_js_1.default.Reader ? input : new minimal_js_1.default.Reader(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = createBaseAccountStatsResponse();
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
    ...
    create(base) {
        return exports.AccountStatsResponse.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        var _a, _b, _c;
        const message = createBaseAccountStatsResponse();
...
exports.HistoricalRPNL = {
    encode(message, writer = minimal_js_1.default.Writer.create()) {
        ...
        writer.ldelim();
        for (const v of message.dv) {
            exports.HistoricalDetailedPNL.encode(v, writer.uint32(26).fork()).ldelim();
        }
        return writer;
    },
    decode(input, length) {
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                ...
                case 2:
                    ...
                    break;
                case 3:
                    message.dv.push(exports.HistoricalDetailedPNL.decode(reader, reader.uint32()));
                    break;
                default:
                    reader.skipType(tag & 7);
                    break;
    ...
    fromJSON(object) {
        return {
            t: Array.isArray(object === null || object === void 0 ? void 0 : object.t) ? object.t.map((e) => Number(e)) : [],
            v: Array.isArray(object === null || object === void 0 ? void 0 : object.v) ? object.v.map((e) => Number(e)) : [],
            dv: Array.isArray(object === null || object === void 0 ? void 0 : object.dv) ? object.dv.map((e) => exports.HistoricalDetailedPNL.fromJSON(e)) : [],
        };
    },
    toJSON(message) {
        const obj = {};
        ...
        if (message.dv) {
            obj.dv = message.dv.map((e) => e ? exports.HistoricalDetailedPNL.toJSON(e) : undefined);
        }
        else {
            obj.dv = [];
        }
    ...
    fromPartial(object) {
        ...
        message.t = ((_a = object.t) === null || _a === void 0 ? void 0 : _a.map((e) => e)) || [];
        message.v = ((_b = object.v) === null || _b === void 0 ? void 0 : _b.map((e) => e)) || [];
        message.dv = ((_c = object.dv) === null || _c === void 0 ? void 0 : _c.map((e) => exports.HistoricalDetailedPNL.fromPartial(e))) || [];
        return message;
    },
};
function createBaseHistoricalDetailedPNL() {
    return { rpnl: 0, upnl: 0 };
}
exports.HistoricalDetailedPNL = {
    encode(message, writer = minimal_js_1.default.Writer.create()) {
        if (message.rpnl !== 0) {
            writer.uint32(9).double(message.rpnl);
        }
        if (message.upnl !== 0) {
            writer.uint32(17).double(message.upnl);
        }
        return writer;
    },
    decode(input, length) {
        const reader = input instanceof minimal_js_1.default.Reader ? input : new minimal_js_1.default.Reader(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = createBaseHistoricalDetailedPNL();
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
    ...
    fromJSON(object) {
        return { rpnl: isSet(object.rpnl) ? Number(object.rpnl) : 0, upnl: isSet(object.upnl) ? Number(object.upnl) : 0 };
    },
    toJSON(message) {
        const obj = {};
        message.rpnl !== undefined && (obj.rpnl = message.rpnl);
        message.upnl !== undefined && (obj.upnl = message.upnl);
        return obj;
    },
    create(base) {
        return exports.HistoricalDetailedPNL.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        var _a, _b;
        const message = createBaseHistoricalDetailedPNL();
        message.rpnl = (_a = object.rpnl) !== null && _a !== void 0 ? _a : 0;
        message.upnl = (_b = object.upnl) !== null && _b !== void 0 ? _b : 0;
        return message;
    },
};
...
function createBaseStreamSpotAverageEntriesRequest() {
    return { account: "" };
}
exports.StreamSpotAverageEntriesRequest = {
    encode(message, writer = minimal_js_1.default.Writer.create()) {
        if (message.account !== "") {
            writer.uint32(10).string(message.account);
        }
    ...
    decode(input, length) {
        const reader = input instanceof minimal_js_1.default.Reader ? input : new minimal_js_1.default.Reader(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = createBaseStreamSpotAverageEntriesRequest();
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
    ...
    create(base) {
        return exports.StreamSpotAverageEntriesRequest.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        var _a;
        const message = createBaseStreamSpotAverageEntriesRequest();
...
function createBaseStreamSpotAverageEntriesResponse() {
    return { averageEntry: undefined, timestamp: "0" };
}
exports.StreamSpotAverageEntriesResponse = {
    encode(message, writer = minimal_js_1.default.Writer.create()) {
        if (message.averageEntry !== undefined) {
            exports.SpotAverageEntry.encode(message.averageEntry, writer.uint32(10).fork()).ldelim();
        }
        if (message.timestamp !== "0") {
    ...
    decode(input, length) {
        const reader = input instanceof minimal_js_1.default.Reader ? input : new minimal_js_1.default.Reader(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = createBaseStreamSpotAverageEntriesResponse();
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
                    message.averageEntry = exports.SpotAverageEntry.decode(reader, reader.uint32());
                    break;
                case 2:
                    message.timestamp = longToString(reader.sint64());
                    break;
    ...
    fromJSON(object) {
        return {
            averageEntry: isSet(object.averageEntry) ? exports.SpotAverageEntry.fromJSON(object.averageEntry) : undefined,
            timestamp: isSet(object.timestamp) ? String(object.timestamp) : "0",
        };
    },
    toJSON(message) {
        const obj = {};
        message.averageEntry !== undefined &&
            (obj.averageEntry = message.averageEntry ? exports.SpotAverageEntry.toJSON(message.averageEntry) : undefined);
        message.timestamp !== undefined && (obj.timestamp = message.timestamp);
        return obj;
    },
    create(base) {
        return exports.StreamSpotAverageEntriesResponse.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        var _a;
        const message = createBaseStreamSpotAverageEntriesResponse();
        message.averageEntry = (object.averageEntry !== undefined && object.averageEntry !== null)
            ? exports.SpotAverageEntry.fromPartial(object.averageEntry)
            : undefined;
        message.timestamp = (_a = object.timestamp) !== null && _a !== void 0 ? _a : "0";
        return message;
    },
};
function createBaseSpotAverageEntry() {
    return { marketId: "", averageEntryPrice: "", quantity: "", usdValue: "" };
}
exports.SpotAverageEntry = {
    encode(message, writer = minimal_js_1.default.Writer.create()) {
        if (message.marketId !== "") {
            writer.uint32(10).string(message.marketId);
        }
        if (message.averageEntryPrice !== "") {
            writer.uint32(18).string(message.averageEntryPrice);
        }
        if (message.quantity !== "") {
    ...
    decode(input, length) {
        const reader = input instanceof minimal_js_1.default.Reader ? input : new minimal_js_1.default.Reader(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = createBaseSpotAverageEntry();
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
    ...
    fromJSON(object) {
        return {
            marketId: isSet(object.marketId) ? String(object.marketId) : "",
            averageEntryPrice: isSet(object.averageEntryPrice) ? String(object.averageEntryPrice) : "",
            quantity: isSet(object.quantity) ? String(object.quantity) : "",
            usdValue: isSet(object.usdValue) ? String(object.usdValue) : "",
        };
    },
    toJSON(message) {
        const obj = {};
        message.marketId !== undefined && (obj.marketId = message.marketId);
        message.averageEntryPrice !== undefined && (obj.averageEntryPrice = message.averageEntryPrice);
        message.quantity !== undefined && (obj.quantity = message.quantity);
        message.usdValue !== undefined && (obj.usdValue = message.usdValue);
        return obj;
    },
    create(base) {
        return exports.SpotAverageEntry.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        var _a, _b, _c, _d;
        const message = createBaseSpotAverageEntry();
        message.marketId = (_a = object.marketId) !== null && _a !== void 0 ? _a : "";
        message.averageEntryPrice = (_b = object.averageEntryPrice) !== null && _b !== void 0 ? _b : "";
        message.quantity = (_c = object.quantity) !== null && _c !== void 0 ? _c : "";
        message.usdValue = (_d = object.usdValue) !== null && _d !== void 0 ? _d : "";
        return message;
    },
};
class InjectiveArchiverRPCClientImpl {
    constructor(rpc) {
        ...
        this.AccountStats = this.AccountStats.bind(this);
        ...
        this.StreamSpotAverageEntries = this.StreamSpotAverageEntries.bind(this);
    }
    ...
    AccountStats(request, metadata) {
        return this.rpc.unary(exports.InjectiveArchiverRPCAccountStatsDesc, exports.AccountStatsRequest.fromPartial(request), metadata);
    }
    ...
    StreamSpotAverageEntries(request, metadata) {
        return this.rpc.invoke(exports.InjectiveArchiverRPCStreamSpotAverageEntriesDesc, exports.StreamSpotAverageEntriesRequest.fromPartial(request), metadata);
    }
}
...
exports.InjectiveArchiverRPCAccountStatsDesc = {
    ...
    requestType: {
        serializeBinary() {
            return exports.AccountStatsRequest.encode(this).finish();
        },
    },
    responseType: {
        deserializeBinary(data) {
            const value = exports.AccountStatsResponse.decode(data);
            return Object.assign(Object.assign({}, value), { toObject() {
                    return value;
                } });
        },
...
exports.InjectiveArchiverRPCStreamSpotAverageEntriesDesc = {
    methodName: "StreamSpotAverageEntries",
    service: exports.InjectiveArchiverRPCDesc,
    requestStream: false,
    responseStream: true,
    requestType: {
        serializeBinary() {
            return exports.StreamSpotAverageEntriesRequest.encode(this).finish();
        },
    },
    responseType: {
        deserializeBinary(data) {
            const value = exports.StreamSpotAverageEntriesResponse.decode(data);
            return Object.assign(Object.assign({}, value), { toObject() {
                    return value;
                } });
        },
