...
export interface StreamLatestHeightRequest {
}
export interface StreamLatestHeightResponse {
    height: string;
    time: string;
}
...
export interface GetBlockEventsRPCResponse {
    ...
    block: BasicBlockInfo | undefined;
}
...
export declare const StreamLatestHeightRequest: {
    encode(_: StreamLatestHeightRequest, writer?: _m0.Writer): _m0.Writer;
    decode(input: _m0.Reader | Uint8Array, length?: number): StreamLatestHeightRequest;
    fromJSON(_: any): StreamLatestHeightRequest;
    toJSON(_: StreamLatestHeightRequest): unknown;
    create(base?: DeepPartial<StreamLatestHeightRequest>): StreamLatestHeightRequest;
    fromPartial(_: DeepPartial<StreamLatestHeightRequest>): StreamLatestHeightRequest;
};
export declare const StreamLatestHeightResponse: {
    encode(message: StreamLatestHeightResponse, writer?: _m0.Writer): _m0.Writer;
    decode(input: _m0.Reader | Uint8Array, length?: number): StreamLatestHeightResponse;
    fromJSON(object: any): StreamLatestHeightResponse;
    toJSON(message: StreamLatestHeightResponse): unknown;
    create(base?: DeepPartial<StreamLatestHeightResponse>): StreamLatestHeightResponse;
    fromPartial(object: DeepPartial<StreamLatestHeightResponse>): StreamLatestHeightResponse;
};
...
export declare const BasicBlockInfo: {
    encode(message: BasicBlockInfo, writer?: _m0.Writer): _m0.Writer;
    decode(input: _m0.Reader | Uint8Array, length?: number): BasicBlockInfo;
    fromJSON(object: any): BasicBlockInfo;
    toJSON(message: BasicBlockInfo): unknown;
    create(base?: DeepPartial<BasicBlockInfo>): BasicBlockInfo;
    fromPartial(object: DeepPartial<BasicBlockInfo>): BasicBlockInfo;
};
...
export interface EventProviderAPI {
    ...
    StreamLatestHeight(request: DeepPartial<StreamLatestHeightRequest>, metadata?: grpc.Metadata): Observable<StreamLatestHeightResponse>;
...
export declare const EventProviderAPIStreamLatestHeightDesc: UnaryMethodDefinitionish;
