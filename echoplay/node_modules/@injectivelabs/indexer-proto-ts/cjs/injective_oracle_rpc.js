...
exports.GrpcWebError = exports.GrpcWebImpl = exports.InjectiveOracleRPCStreamPricesByMarketsDesc = exports.InjectiveOracleRPCStreamPricesDesc = exports.InjectiveOracleRPCPriceV2Desc = exports.InjectiveOracleRPCPriceDesc = exports.InjectiveOracleRPCOracleListDesc = exports.InjectiveOracleRPCDesc = exports.InjectiveOracleRPCClientImpl = exports.StreamPricesByMarketsResponse = exports.StreamPricesByMarketsRequest = exports.StreamPricesResponse = exports.StreamPricesRequest = exports.PriceV2Result = exports.PriceV2Response = exports.PricePayloadV2 = exports.PriceV2Request = exports.PriceResponse = exports.PriceRequest = exports.Oracle = exports.OracleListResponse = exports.OracleListRequest = exports.protobufPackage = void 0;
/* eslint-disable */
...
function createBasePriceV2Request() {
    return { filters: [] };
}
exports.PriceV2Request = {
    encode(message, writer = minimal_js_1.default.Writer.create()) {
        for (const v of message.filters) {
            exports.PricePayloadV2.encode(v, writer.uint32(10).fork()).ldelim();
        }
        return writer;
    },
    decode(input, length) {
        const reader = input instanceof minimal_js_1.default.Reader ? input : new minimal_js_1.default.Reader(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = createBasePriceV2Request();
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
                    message.filters.push(exports.PricePayloadV2.decode(reader, reader.uint32()));
                    break;
                default:
                    reader.skipType(tag & 7);
                    break;
    ...
    fromJSON(object) {
        return {
            filters: Array.isArray(object === null || object === void 0 ? void 0 : object.filters) ? object.filters.map((e) => exports.PricePayloadV2.fromJSON(e)) : [],
        };
    },
    toJSON(message) {
        const obj = {};
        if (message.filters) {
            obj.filters = message.filters.map((e) => e ? exports.PricePayloadV2.toJSON(e) : undefined);
        }
        else {
            obj.filters = [];
        }
    ...
    create(base) {
        return exports.PriceV2Request.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        var _a;
        const message = createBasePriceV2Request();
        message.filters = ((_a = object.filters) === null || _a === void 0 ? void 0 : _a.map((e) => exports.PricePayloadV2.fromPartial(e))) || [];
        return message;
    },
};
function createBasePricePayloadV2() {
    return { baseSymbol: "", quoteSymbol: "", oracleType: "", oracleScaleFactor: 0 };
}
exports.PricePayloadV2 = {
    encode(message, writer = minimal_js_1.default.Writer.create()) {
        if (message.baseSymbol !== "") {
            writer.uint32(10).string(message.baseSymbol);
        }
    ...
    decode(input, length) {
        const reader = input instanceof minimal_js_1.default.Reader ? input : new minimal_js_1.default.Reader(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = createBasePricePayloadV2();
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
    ...
    create(base) {
        return exports.PricePayloadV2.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        var _a, _b, _c, _d;
        const message = createBasePricePayloadV2();
...
function createBasePriceV2Response() {
    return { prices: [] };
}
exports.PriceV2Response = {
    encode(message, writer = minimal_js_1.default.Writer.create()) {
        for (const v of message.prices) {
            exports.PriceV2Result.encode(v, writer.uint32(10).fork()).ldelim();
        }
        return writer;
    },
    decode(input, length) {
        const reader = input instanceof minimal_js_1.default.Reader ? input : new minimal_js_1.default.Reader(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = createBasePriceV2Response();
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
                    message.prices.push(exports.PriceV2Result.decode(reader, reader.uint32()));
                    break;
                default:
                    reader.skipType(tag & 7);
                    break;
    ...
    fromJSON(object) {
        return { prices: Array.isArray(object === null || object === void 0 ? void 0 : object.prices) ? object.prices.map((e) => exports.PriceV2Result.fromJSON(e)) : [] };
    },
    toJSON(message) {
        const obj = {};
        if (message.prices) {
            obj.prices = message.prices.map((e) => e ? exports.PriceV2Result.toJSON(e) : undefined);
        }
        else {
            obj.prices = [];
        }
    ...
    create(base) {
        return exports.PriceV2Response.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        var _a;
        const message = createBasePriceV2Response();
        message.prices = ((_a = object.prices) === null || _a === void 0 ? void 0 : _a.map((e) => exports.PriceV2Result.fromPartial(e))) || [];
        return message;
    },
};
function createBasePriceV2Result() {
    return { baseSymbol: "", quoteSymbol: "", oracleType: "", oracleScaleFactor: 0, price: "", marketId: "" };
}
exports.PriceV2Result = {
    encode(message, writer = minimal_js_1.default.Writer.create()) {
        if (message.baseSymbol !== "") {
            writer.uint32(10).string(message.baseSymbol);
        }
    ...
    decode(input, length) {
        const reader = input instanceof minimal_js_1.default.Reader ? input : new minimal_js_1.default.Reader(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = createBasePriceV2Result();
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
    ...
    create(base) {
        return exports.PriceV2Result.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
...
class InjectiveOracleRPCClientImpl {
    constructor(rpc) {
        ...
        this.PriceV2 = this.PriceV2.bind(this);
    ...
    PriceV2(request, metadata) {
        return this.rpc.unary(exports.InjectiveOracleRPCPriceV2Desc, exports.PriceV2Request.fromPartial(request), metadata);
    }
...
exports.InjectiveOracleRPCPriceV2Desc = {
    methodName: "PriceV2",
    service: exports.InjectiveOracleRPCDesc,
    requestStream: false,
    responseStream: false,
    requestType: {
        serializeBinary() {
            return exports.PriceV2Request.encode(this).finish();
        },
    },
    responseType: {
        deserializeBinary(data) {
            const value = exports.PriceV2Response.decode(data);
            return Object.assign(Object.assign({}, value), { toObject() {
                    return value;
                } });
        },
