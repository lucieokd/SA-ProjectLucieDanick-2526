...
exports.GrpcWebError = exports.GrpcWebImpl = exports.InjectiveChartRPCMarketSnapshotDesc = exports.InjectiveChartRPCAllDerivativeMarketSummaryDesc = exports.InjectiveChartRPCDerivativeMarketSummaryDesc = exports.InjectiveChartRPCAllSpotMarketSummaryDesc = exports.InjectiveChartRPCSpotMarketSummaryDesc = exports.InjectiveChartRPCDerivativeMarketHistoryDesc = exports.InjectiveChartRPCSpotMarketHistoryDesc = exports.InjectiveChartRPCDesc = exports.InjectiveChartRPCClientImpl = exports.MarketSnapshotHistoryResponse = exports.MarketSnapshotResponse = exports.MarketSnapshotRequest = exports.AllDerivativeMarketSummaryResponse = exports.AllDerivativeMarketSummaryRequest = exports.DerivativeMarketSummaryResponse = exports.DerivativeMarketSummaryRequest = exports.MarketSummaryResp = exports.AllSpotMarketSummaryResponse = exports.AllSpotMarketSummaryRequest = exports.SpotMarketSummaryResponse = exports.SpotMarketSummaryRequest = exports.DerivativeMarketHistoryResponse = exports.DerivativeMarketHistoryRequest = exports.SpotMarketHistoryResponse = exports.SpotMarketHistoryRequest = exports.protobufPackage = void 0;
/* eslint-disable */
...
function createBaseMarketSnapshotRequest() {
    return { marketIDs: [], resolution: "", countback: 0 };
}
exports.MarketSnapshotRequest = {
    encode(message, writer = minimal_js_1.default.Writer.create()) {
        ...
        if (message.countback !== 0) {
            writer.uint32(24).sint32(message.countback);
        }
        return writer;
    },
    decode(input, length) {
        const reader = input instanceof minimal_js_1.default.Reader ? input : new minimal_js_1.default.Reader(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = createBaseMarketSnapshotRequest();
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
    ...
    create(base) {
        return exports.MarketSnapshotRequest.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        var _a, _b, _c;
        const message = createBaseMarketSnapshotRequest();
        ...
        message.resolution = (_b = object.resolution) !== null && _b !== void 0 ? _b : "";
        message.countback = (_c = object.countback) !== null && _c !== void 0 ? _c : 0;
        return message;
    },
};
function createBaseMarketSnapshotResponse() {
    return { field: [] };
}
exports.MarketSnapshotResponse = {
    encode(message, writer = minimal_js_1.default.Writer.create()) {
        for (const v of message.field) {
            exports.MarketSnapshotHistoryResponse.encode(v, writer.uint32(10).fork()).ldelim();
        }
        return writer;
    },
    decode(input, length) {
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                case 1:
                    message.field.push(exports.MarketSnapshotHistoryResponse.decode(reader, reader.uint32()));
                    break;
                default:
                    reader.skipType(tag & 7);
                    break;
    ...
    fromJSON(object) {
        return {
            field: Array.isArray(object === null || object === void 0 ? void 0 : object.field)
                ? object.field.map((e) => exports.MarketSnapshotHistoryResponse.fromJSON(e))
                : [],
        };
    },
    toJSON(message) {
        const obj = {};
        if (message.field) {
            obj.field = message.field.map((e) => e ? exports.MarketSnapshotHistoryResponse.toJSON(e) : undefined);
        }
        else {
            obj.field = [];
        }
    ...
    create(base) {
        return exports.MarketSnapshotResponse.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        var _a;
        const message = createBaseMarketSnapshotResponse();
        message.field = ((_a = object.field) === null || _a === void 0 ? void 0 : _a.map((e) => exports.MarketSnapshotHistoryResponse.fromPartial(e))) || [];
        return message;
    },
};
function createBaseMarketSnapshotHistoryResponse() {
    return { marketId: "", resolution: "", t: [], o: [], h: [], l: [], c: [], v: [] };
}
exports.MarketSnapshotHistoryResponse = {
    encode(message, writer = minimal_js_1.default.Writer.create()) {
        if (message.marketId !== "") {
            writer.uint32(10).string(message.marketId);
        }
    ...
    decode(input, length) {
        const reader = input instanceof minimal_js_1.default.Reader ? input : new minimal_js_1.default.Reader(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = createBaseMarketSnapshotHistoryResponse();
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
    ...
    create(base) {
        return exports.MarketSnapshotHistoryResponse.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        ...
        message.marketId = (_a = object.marketId) !== null && _a !== void 0 ? _a : "";
        message.resolution = (_b = object.resolution) !== null && _b !== void 0 ? _b : "";
        message.t = ((_c = object.t) === null || _c === void 0 ? void 0 : _c.map((e) => e)) || [];
        message.o = ((_d = object.o) === null || _d === void 0 ? void 0 : _d.map((e) => e)) || [];
        message.h = ((_e = object.h) === null || _e === void 0 ? void 0 : _e.map((e) => e)) || [];
        message.l = ((_f = object.l) === null || _f === void 0 ? void 0 : _f.map((e) => e)) || [];
        message.c = ((_g = object.c) === null || _g === void 0 ? void 0 : _g.map((e) => e)) || [];
        message.v = ((_h = object.v) === null || _h === void 0 ? void 0 : _h.map((e) => e)) || [];
        return message;
    },
};
class InjectiveChartRPCClientImpl {
    constructor(rpc) {
        ...
        this.MarketSnapshot = this.MarketSnapshot.bind(this);
    }
    ...
    MarketSnapshot(request, metadata) {
        return this.rpc.unary(exports.InjectiveChartRPCMarketSnapshotDesc, exports.MarketSnapshotRequest.fromPartial(request), metadata);
    }
}
...
exports.InjectiveChartRPCMarketSnapshotDesc = {
    ...
    requestType: {
        serializeBinary() {
            return exports.MarketSnapshotRequest.encode(this).finish();
        },
    },
    responseType: {
        deserializeBinary(data) {
            const value = exports.MarketSnapshotResponse.decode(data);
            return Object.assign(Object.assign({}, value), { toObject() {
                    return value;
                } });
        },
