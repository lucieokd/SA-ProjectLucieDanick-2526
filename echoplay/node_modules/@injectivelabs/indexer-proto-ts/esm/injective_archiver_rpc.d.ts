...
export declare const AccountStatsRequest: {
    encode(message: AccountStatsRequest, writer?: _m0.Writer): _m0.Writer;
    decode(input: _m0.Reader | Uint8Array, length?: number): AccountStatsRequest;
    fromJSON(object: any): AccountStatsRequest;
    toJSON(message: AccountStatsRequest): unknown;
    create(base?: DeepPartial<AccountStatsRequest>): AccountStatsRequest;
    fromPartial(object: DeepPartial<AccountStatsRequest>): AccountStatsRequest;
};
export declare const AccountStatsResponse: {
    encode(message: AccountStatsResponse, writer?: _m0.Writer): _m0.Writer;
    decode(input: _m0.Reader | Uint8Array, length?: number): AccountStatsResponse;
    fromJSON(object: any): AccountStatsResponse;
    toJSON(message: AccountStatsResponse): unknown;
    create(base?: DeepPartial<AccountStatsResponse>): AccountStatsResponse;
    fromPartial(object: DeepPartial<AccountStatsResponse>): AccountStatsResponse;
};
...
export declare const HistoricalDetailedPNL: {
    encode(message: HistoricalDetailedPNL, writer?: _m0.Writer): _m0.Writer;
    decode(input: _m0.Reader | Uint8Array, length?: number): HistoricalDetailedPNL;
    fromJSON(object: any): HistoricalDetailedPNL;
    toJSON(message: HistoricalDetailedPNL): unknown;
    create(base?: DeepPartial<HistoricalDetailedPNL>): HistoricalDetailedPNL;
    fromPartial(object: DeepPartial<HistoricalDetailedPNL>): HistoricalDetailedPNL;
};
...
export declare const StreamSpotAverageEntriesRequest: {
    encode(message: StreamSpotAverageEntriesRequest, writer?: _m0.Writer): _m0.Writer;
    decode(input: _m0.Reader | Uint8Array, length?: number): StreamSpotAverageEntriesRequest;
    fromJSON(object: any): StreamSpotAverageEntriesRequest;
    toJSON(message: StreamSpotAverageEntriesRequest): unknown;
    create(base?: DeepPartial<StreamSpotAverageEntriesRequest>): StreamSpotAverageEntriesRequest;
    fromPartial(object: DeepPartial<StreamSpotAverageEntriesRequest>): StreamSpotAverageEntriesRequest;
};
export declare const StreamSpotAverageEntriesResponse: {
    encode(message: StreamSpotAverageEntriesResponse, writer?: _m0.Writer): _m0.Writer;
    decode(input: _m0.Reader | Uint8Array, length?: number): StreamSpotAverageEntriesResponse;
    fromJSON(object: any): StreamSpotAverageEntriesResponse;
    toJSON(message: StreamSpotAverageEntriesResponse): unknown;
    create(base?: DeepPartial<StreamSpotAverageEntriesResponse>): StreamSpotAverageEntriesResponse;
    fromPartial(object: DeepPartial<StreamSpotAverageEntriesResponse>): StreamSpotAverageEntriesResponse;
};
export declare const SpotAverageEntry: {
    encode(message: SpotAverageEntry, writer?: _m0.Writer): _m0.Writer;
    decode(input: _m0.Reader | Uint8Array, length?: number): SpotAverageEntry;
    fromJSON(object: any): SpotAverageEntry;
    toJSON(message: SpotAverageEntry): unknown;
    create(base?: DeepPartial<SpotAverageEntry>): SpotAverageEntry;
    fromPartial(object: DeepPartial<SpotAverageEntry>): SpotAverageEntry;
};
...
export interface InjectiveArchiverRPC {
    ...
    AccountStats(request: DeepPartial<AccountStatsRequest>, metadata?: grpc.Metadata): Promise<AccountStatsResponse>;
    ...
    StreamSpotAverageEntries(request: DeepPartial<StreamSpotAverageEntriesRequest>, metadata?: grpc.Metadata): Observable<StreamSpotAverageEntriesResponse>;
}
...
export declare const InjectiveArchiverRPCAccountStatsDesc: UnaryMethodDefinitionish;
...
export declare const InjectiveArchiverRPCStreamSpotAverageEntriesDesc: UnaryMethodDefinitionish;
