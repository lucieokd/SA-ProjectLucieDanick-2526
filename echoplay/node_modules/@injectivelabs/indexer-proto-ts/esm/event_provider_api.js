...
export const StreamLatestHeightRequest = {
    encode(_, writer = _m0.Writer.create()) {
        return writer;
    },
    decode(input, length) {
    ...
    create(base) {
        return StreamLatestHeightRequest.fromPartial(base ?? {});
    },
    fromPartial(_) {
        const message = createBaseStreamLatestHeightRequest();
        return message;
...
export const StreamLatestHeightResponse = {
    encode(message, writer = _m0.Writer.create()) {
        if (message.height !== "0") {
            writer.uint32(8).uint64(message.height);
        }
    ...
    create(base) {
        return StreamLatestHeightResponse.fromPartial(base ?? {});
    },
    fromPartial(object) {
        const message = createBaseStreamLatestHeightResponse();
        message.height = object.height ?? "0";
...
export const GetBlockEventsRPCResponse = {
    encode(message, writer = _m0.Writer.create()) {
        ...
        if (message.block !== undefined) {
            BasicBlockInfo.encode(message.block, writer.uint32(42).fork()).ldelim();
        }
        return writer;
    },
    decode(input, length) {
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                ...
                case 4:
                    ...
                    break;
                case 5:
                    message.block = BasicBlockInfo.decode(reader, reader.uint32());
                    break;
                default:
                    reader.skipType(tag & 7);
                    break;
    ...
    fromJSON(object) {
        return {
            ...
            block: isSet(object.block) ? BasicBlockInfo.fromJSON(object.block) : undefined,
        };
    },
    toJSON(message) {
        const obj = {};
        ...
        message.block !== undefined && (obj.block = message.block ? BasicBlockInfo.toJSON(message.block) : undefined);
        return obj;
    },
    create(base) {
    ...
    fromPartial(object) {
        ...
        message.block = (object.block !== undefined && object.block !== null)
            ? BasicBlockInfo.fromPartial(object.block)
            : undefined;
        return message;
    },
};
...
export const BasicBlockInfo = {
    ...
    create(base) {
        return BasicBlockInfo.fromPartial(base ?? {});
    },
    fromPartial(object) {
        const message = createBaseBasicBlockInfo();
        message.height = object.height ?? "0";
...
export class EventProviderAPIClientImpl {
    ...
    StreamLatestHeight(request, metadata) {
        return this.rpc.invoke(EventProviderAPIStreamLatestHeightDesc, StreamLatestHeightRequest.fromPartial(request), metadata);
    }
...
export const EventProviderAPIStreamLatestHeightDesc = {
    ...
    requestType: {
        serializeBinary() {
            return StreamLatestHeightRequest.encode(this).finish();
        },
    },
    responseType: {
        deserializeBinary(data) {
            const value = StreamLatestHeightResponse.decode(data);
            return {
                ...value,
                toObject() {
                    return value;
