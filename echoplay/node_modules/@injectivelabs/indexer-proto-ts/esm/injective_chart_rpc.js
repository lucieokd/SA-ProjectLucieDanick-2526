...
export const MarketSnapshotRequest = {
    encode(message, writer = _m0.Writer.create()) {
    ...
    create(base) {
        return MarketSnapshotRequest.fromPartial(base ?? {});
    },
    fromPartial(object) {
        const message = createBaseMarketSnapshotRequest();
...
export const MarketSnapshotResponse = {
    encode(message, writer = _m0.Writer.create()) {
        for (const v of message.field) {
            MarketSnapshotHistoryResponse.encode(v, writer.uint32(10).fork()).ldelim();
        }
        return writer;
    },
    decode(input, length) {
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                case 1:
                    message.field.push(MarketSnapshotHistoryResponse.decode(reader, reader.uint32()));
                    break;
                default:
                    reader.skipType(tag & 7);
                    break;
    ...
    fromJSON(object) {
        return {
            field: Array.isArray(object?.field)
                ? object.field.map((e) => MarketSnapshotHistoryResponse.fromJSON(e))
                : [],
        };
    },
    toJSON(message) {
        const obj = {};
        if (message.field) {
            obj.field = message.field.map((e) => e ? MarketSnapshotHistoryResponse.toJSON(e) : undefined);
        }
        else {
            obj.field = [];
        }
    ...
    create(base) {
        return MarketSnapshotResponse.fromPartial(base ?? {});
    },
    fromPartial(object) {
        const message = createBaseMarketSnapshotResponse();
        message.field = object.field?.map((e) => MarketSnapshotHistoryResponse.fromPartial(e)) || [];
        return message;
    },
};
...
export const MarketSnapshotHistoryResponse = {
    encode(message, writer = _m0.Writer.create()) {
        if (message.marketId !== "") {
            writer.uint32(10).string(message.marketId);
        }
    ...
    create(base) {
        return MarketSnapshotHistoryResponse.fromPartial(base ?? {});
    },
    fromPartial(object) {
        const message = createBaseMarketSnapshotHistoryResponse();
        message.marketId = object.marketId ?? "";
...
export class InjectiveChartRPCClientImpl {
    ...
    MarketSnapshot(request, metadata) {
        return this.rpc.unary(InjectiveChartRPCMarketSnapshotDesc, MarketSnapshotRequest.fromPartial(request), metadata);
    }
}
...
export const InjectiveChartRPCMarketSnapshotDesc = {
    ...
    requestType: {
        serializeBinary() {
            return MarketSnapshotRequest.encode(this).finish();
        },
    },
    responseType: {
        deserializeBinary(data) {
            const value = MarketSnapshotResponse.decode(data);
            return {
                ...value,
                toObject() {
                    return value;
