...
export const PerpetualMarketFunding = {
    ...
    fromPartial(object) {
        ...
        message.lastFundingRate = object.lastFundingRate ?? "";
        return message;
    },
};
...
export const OpenInterestRequest = {
    encode(message, writer = _m0.Writer.create()) {
        for (const v of message.marketIDs) {
            writer.uint32(10).string(v);
        }
    ...
    create(base) {
        return OpenInterestRequest.fromPartial(base ?? {});
    },
    fromPartial(object) {
        const message = createBaseOpenInterestRequest();
        message.marketIDs = object.marketIDs?.map((e) => e) || [];
...
export const OpenInterestResponse = {
    encode(message, writer = _m0.Writer.create()) {
        for (const v of message.openInterests) {
            MarketOpenInterest.encode(v, writer.uint32(10).fork()).ldelim();
        }
        return writer;
    },
    decode(input, length) {
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                case 1:
                    message.openInterests.push(MarketOpenInterest.decode(reader, reader.uint32()));
                    break;
                default:
                    reader.skipType(tag & 7);
                    break;
    ...
    fromJSON(object) {
        return {
            openInterests: Array.isArray(object?.openInterests)
                ? object.openInterests.map((e) => MarketOpenInterest.fromJSON(e))
                : [],
        };
    },
    toJSON(message) {
        ...
        if (message.openInterests) {
            obj.openInterests = message.openInterests.map((e) => e ? MarketOpenInterest.toJSON(e) : undefined);
        }
        else {
            obj.openInterests = [];
        }
    ...
    create(base) {
        return OpenInterestResponse.fromPartial(base ?? {});
    },
    fromPartial(object) {
        const message = createBaseOpenInterestResponse();
        message.openInterests = object.openInterests?.map((e) => MarketOpenInterest.fromPartial(e)) || [];
        return message;
    },
};
...
export const MarketOpenInterest = {
    encode(message, writer = _m0.Writer.create()) {
        if (message.marketId !== "") {
            writer.uint32(10).string(message.marketId);
        }
    ...
    create(base) {
        return MarketOpenInterest.fromPartial(base ?? {});
    },
    fromPartial(object) {
        const message = createBaseMarketOpenInterest();
        message.marketId = object.marketId ?? "";
...
export class InjectiveDerivativeExchangeRPCClientImpl {
    ...
    OpenInterest(request, metadata) {
        return this.rpc.unary(InjectiveDerivativeExchangeRPCOpenInterestDesc, OpenInterestRequest.fromPartial(request), metadata);
    }
}
...
export const InjectiveDerivativeExchangeRPCOpenInterestDesc = {
    ...
    requestType: {
        serializeBinary() {
            return OpenInterestRequest.encode(this).finish();
        },
    },
    responseType: {
        deserializeBinary(data) {
            const value = OpenInterestResponse.decode(data);
            return {
                ...value,
                toObject() {
                    return value;
