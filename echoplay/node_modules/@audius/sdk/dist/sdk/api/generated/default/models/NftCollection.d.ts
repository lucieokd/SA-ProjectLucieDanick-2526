 ...
 * @export
 */
export declare const NftCollectionChainEnum: {
    readonly Eth: "eth";
    readonly Sol: "sol";
};
 ...
 * @export
 */
export declare const NftCollectionStandardEnum: {
 ...
 */
export declare function instanceOfNftCollection(value: object): value is NftCollection;
