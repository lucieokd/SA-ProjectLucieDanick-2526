...
export type RPCPayloadRequest = ChatBlastRPC | ChatCreateRPC | ChatDeleteRPC | ChatInviteRPC | ChatMessageRPC | ChatReactRPC | ChatReadRPC | ChatBlockRPC | ChatUnblockRPC | ChatPermitRPC | ValidateCanChatRPC;
...
export type ChatMessageNullableReaction = ChatMessageReaction | {
    user_id: string;
    created_at: string;
    reaction: null;
};
...
export declare enum ChatBlastAudience {
