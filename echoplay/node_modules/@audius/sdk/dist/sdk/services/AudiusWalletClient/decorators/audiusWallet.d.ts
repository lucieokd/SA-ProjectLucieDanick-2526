...
import { GetSharedSecretParameters } from '../actions/getSharedSecret';
import { type SignParameters } from '../actions/sign';
import type { AudiusAccount } from '../types';
export type AudiusWalletActions<TChain extends Chain | undefined = Chain | undefined, TAccount extends AudiusAccount | undefined = AudiusAccount | undefined> = {
    /**
     ...
     */
    getSharedSecret: (args: GetSharedSecretParameters<TAccount>) => Promise<Uint8Array>;
};
export declare function audiusWalletActions<TTransport extends Transport, TChain extends Chain | undefined, TAccount extends AudiusAccount>(client: Client<TTransport, TChain, TAccount>): AudiusWalletActions<TChain, TAccount>;
