 ...
 */
export type AudiusWalletClient<TTransport extends Transport = Transport, TChain extends Chain | undefined = Chain | undefined, TAccount extends AudiusAccount = AudiusAccount, TRpcSchema extends RpcSchema | undefined = undefined> = Prettify<Client<TTransport, TChain, TAccount, TRpcSchema, AudiusWalletActions<TChain, TAccount>>>;
