...
exports.BONK = exports.USDC = exports.SOL = exports.wAUDIO = exports.AUDIO = void 0;
const FixedDecimal_js_1 = require("./FixedDecimal.js");
/**
 * Creates a {@link FixedDecimal} constructor for a currency.
 * @param decimalPlaces the number of decimal places for the currency
 */
const createTokenConstructor = (decimalPlaces, defaultFormatOptions) => (value) => new FixedDecimal_js_1.FixedDecimal(value, decimalPlaces, defaultFormatOptions);
/**
 ...
 */
exports.AUDIO = createTokenConstructor(18);
/**
 ...
 */
exports.wAUDIO = createTokenConstructor(8);
/**
 ...
 */
exports.SOL = createTokenConstructor(9);
/**
 ...
 */
exports.BONK = createTokenConstructor(5);
