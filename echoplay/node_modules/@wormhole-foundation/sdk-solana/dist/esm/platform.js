...
export class SolanaPlatform extends PlatformContext {
    ...
    static async getBalances(chain, rpc, walletAddress, tokens) {
        ...
        const splParsedTokenAccounts = (await Promise.all([TOKEN_PROGRAM_ID, TOKEN_2022_PROGRAM_ID]
            .map(pid => new PublicKey(pid))
            .map(programId => rpc.getParsedTokenAccountsByOwner(new PublicKey(walletAddress), { programId })))).reduce((acc, val) => {
