...
export declare const transferWithPayloadLayout: <const P extends CustomizableBytes = undefined>(customPayload?: P) => readonly [{
...
export declare const tokenBridgeNamedPayloads: readonly [readonly ["AttestMeta", readonly [{
    readonly name: "payloadId";
    readonly binary: "uint";
    readonly size: 1;
    readonly custom: 2;
    ...
    readonly size: 32;
    readonly name: "fee";
}]], readonly ["TransferWithPayload", readonly [{
    readonly name: "payloadId";
    readonly binary: "uint";
    readonly size: 1;
    readonly custom: 3;
...
declare module "../../registry.js" {
    namespace WormholeRegistry {
        interface PayloadLiteralToLayoutMapping extends RegisterPayloadTypes<"TokenBridge", typeof tokenBridgeNamedPayloads> {
        }
    }
}
//# sourceMappingURL=tokenBridgeLayout.d.ts.map